...
/**
 * 
 * Module: PostHttpServer.java Description: 模拟的一个Http服务,处理客户端的post请求 Company:
 * Author: pantp Date: May 5, 2012
 */
public class TestHttpServer extends HttpServlet {
	...
	/*
	 * 代码逻辑分以下三部分: 1.获得请求报文 2.根据请求报文的信息去做业务逻辑，然后封装返回报文 3.输出相应报文
	 */
	protected void doPost(HttpServletRequest request,
		...
		List resultList = (List) JSONArray.toList(JSONArray.fromObject(inJson),Map.class);
