...
public class Configure {
	public final static String USER_DIR_PATH = System.getProperty("user.dir")
			+ File.separator;
	...
	private static Properties loadProperty(String filename) {
		try {
			...
			filePro.load(new Configure().getClass().getClassLoader()
	...
	public static Connection getConnection() throws ClassNotFoundException,SQLException {
		...
		String url = Configure.getProperty("jdbc.url");
		Class.forName(Configure.getProperty("jdbc.forname"));
		conn = DriverManager.getConnection(url,
				Configure.getProperty("jdbc.username"),
				Configure.getProperty("jdbc.password"));
		return conn;
	}
}