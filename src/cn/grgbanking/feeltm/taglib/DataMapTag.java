...
public class DataMapTag extends TagSupport {
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			for (int i = 0; i < str.length; i++) {
				...
				if (bean != null)
					propertyText = (Object) PropertyUtils.getProperty(bean,
							str[i]);
				else
					propertyText = property;
				if (propertyText != null && !propertyText.equals("null")) {
					key.append(propertyText);
				}
			}
