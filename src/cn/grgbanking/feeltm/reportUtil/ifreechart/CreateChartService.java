package cn.grgbanking.feeltm.reportUtil.ifreechart;
...
public class CreateChartService {
	private static final String CHART_PATH = "report";

	public static void main(String[] args) {
		// TODO Auto-generated method stub
		CreateChartService pm = new CreateChartService();
		// 生成饼状图
		pm.makePieChart();
		// 生成单组柱状图
		pm.makeBarChart();
	...
	public String createValidityComparePimChar(PieDataset dataset,
		...
		String upLoadPicDir = Configure.getProperty("upLoadBankPicDir");
		String upLoadDir = Configure.ROOT_PATH + upLoadPicDir;
		...
		try {
			// 文件夹不存在则创建
			isChartPathExist(upLoadDir);
			String chartName = upLoadDir + "/" + charName;
			fos_jpg = new FileOutputStream(chartName);
			// 高宽的设置影响椭圆饼图的形状
