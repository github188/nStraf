...
public class TranAbnoinfo implements Serializable {
	...
	public TranAbnoinfo(String id, String tranId, String transCode,
			String transOrgid, String termid, String transDate,
			String transTime, String accountNo, String journalNo,
			Integer transAmt, String transResult, Integer transNotenum,
			Integer blackNotenum, Integer repeatNotenum,
			Integer callbackNotenum, String reserve1, String reserve2,
			String reserve3, String regulation, String note, String createDate,
			Date anyDate) {
		this.id = id;
		this.tranId = tranId;
