...
months = new Array(<s:text name="calendar.months"/>);
...
function load(){
toggleDatePicker('daysOfMonth',3);
}
</SCRIPT>
<div id='daysOfMonth' style="POSITION: absolute; left: 0px; top: 0px; width: 300px; height: 60px">
</BODY>
</HTML>