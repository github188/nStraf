...
<script type="text/javascript">		
	...
	function setHTML(entry,entryInfo){
		...
		html += '<td align="center"><input type="button" id="setModuleBut" name="setModuleBut" value="设置评估模板" onclick="setModule(\''+entryInfo["id"]+'\');"></td>';
		html += '</tr>';
		<%k++;%>;    
	...
	function modify(){
		...
		if (j==0)
		 	...
		 	alert('<s:text name="operator.updateone" />')
		  	...
		  	OpenModal('/pages/moduleSet/trainModuleSetInfo!edit.action?moduleId=8a81dee14acd77ca014acdbf1859003f','1000,650,tmlInfo.addTmlTitle,tmlInfo');
			refreshList();
		}
	}
	...
	function add(){
		...
		if(j==0){
			...
			OpenModal('/pages/moduleSet/trainModuleSetInfo!add.action?courseId='+itemId+"&moduleId=8a81dee14acd77ca014acda6369d0033",'1000,650,tmlInfo.addTmlTitle,tmlInfo');
			refreshList();
		}
	}
	...
	function setModule(itemId){
		OpenModal('/pages/moduleSet/trainModuleSetInfo!addModule.action?courseId='+itemId+"&moduleId=8a81dee14acd77ca014acda6369d0033",'1000,650,tmlInfo.addTmlTitle,tmlInfo');
	}
</script>
		...
		<table width="100%" border="0" cellpadding="1" cellspacing="1"
			...
			<tbody name="formlist" id="formlist" align="center">
				<s:iterator value="list" id="tranInfo" status="row">
					...
					<td align="center"><input type="button" id="setModuleBut" name="setModuleBut" value="设置评估模板" onclick="setModule('<s:property value='id'/>');"></td>
					</tr>
				</s:iterator>
			</tbody>
		</table>
