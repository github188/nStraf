...
<body id="bodyid"  leftmargin="0" topmargin="10" >
	<form name="reportInfoForm" action="<%=request.getContextPath() %>/pages/prjdb/prjdbinfo!save.action"   method="post">
            ...
            <tr>
                ...
                <option value="dongbao">东保押运综合业务系统</option>
                       ...
                       <tr>
                          ...
                          <td bgcolor="#FFFFFF"><input name="prjdb.dbIp" type="text" id="dbIp" size="30" maxlength="15" value='' onChange="numVali(this)" onBlur="numVali(this)">&nbsp;</td> 
                      </tr> 
                      <tr>
                          <td align="center" bgcolor="#999999"><div align="center">数据库名称：<font color="#FF0000">*</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div></td>  
                          <td bgcolor="#FFFFFF"><input name="prjdb.dbName" type="text" id="dbName" size="30" maxlength="30" value='' onChange="numVali(this)" onBlur="numVali(this)">&nbsp;</td> 
                       </tr>
                       <tr>
                          <td align="center" bgcolor="#999999"><div align="center">数据库用户名：<font color="#FF0000">*</font>&nbsp;&nbsp;</div></td>  
                          <td bgcolor="#FFFFFF"><input name="prjdb.dbUsername" type="text" id="dbUsername" size="30" maxlength="9" value='' onChange="numVali(this)" onBlur="numVali(this)">&nbsp;</td> 
                      </tr> 
                      <tr>
                          <td align="center" bgcolor="#999999"><div align="center">数据库用户密码：&nbsp;</div></td>  
                          <td bgcolor="#FFFFFF"><input name="prjdb.dbPassword" type="password" id="dbPassword" size="30" maxlength="15" value='' >&nbsp;</td> 
                      </tr> 
                    </table>
                </fieldset>
                </td> 
