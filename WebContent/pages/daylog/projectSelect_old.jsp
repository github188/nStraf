...
<script type="text/javascript">
	...
	function save() {
		...
		if(prjname=="" || prjname=="null" || prjname==null){
			alert("请选择项目");
			return;
		}
		if(startDate==""){
		...
		var role=$("#role").val();
		//判断开始日期是否大于结束日期
		var strUrl="/pages/daylog/logInfo!moreWorkEnterPage.action?prjname="+prjname+"&startDate="+startDate+"&endDate="+endDate+"&role="+role;
		...
		<table width="95%" typeGroup="checkTable" align="center" cellPadding="1" cellSpacing="1" >
			<tr>
				<td width="33%" style="size:25px;text-align: left;background-color:#E3E3E3">
					 <select name="prjname" id="prjname" style="width: 50%">
			...
			<tr>
				<td style="size:25px;text-align: left;background-color:#E3E3E3">
					 <input name="startDate" type="text" id="startDate"  
                				class="MyInput" style="width:50%;" size="25" value="<%=(String)request.getAttribute("previousWorkDate")%>"/>
                	至
