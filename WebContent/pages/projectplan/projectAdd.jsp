...
<html> 
	...
	<script type="text/javascript">
		...
		function selectDate(spanEle){
			var ele=$(spanEle).find("input");
	...
	<script type="text/javascript">
		...
		function save(){
			...
			//统计到项目基础信息中
			statisticPlanInfo();
			ajaxRequest("/nStraf/pages/projectplan/projectplanInfo!save.action");
		...
		function formatAndListening(){
			...
			$("td").find("input[idGroup='taskName']").each(function(){
				...
				//监听四个日期输入框
				tdEle.next().find("input").datepicker({ dateFormat: 'yy-mm-dd' });
				tdEle.next().next().find("input").datepicker({ dateFormat: 'yy-mm-dd' });
				tdEle.next().next().next().find("input").datepicker({ dateFormat: 'yy-mm-dd' });
				tdEle.next().next().next().next().find("input").datepicker({ dateFormat: 'yy-mm-dd' });
		 ...
		 function generateNewGridTreeRow(reBuild,taskNameValue,idValue,levelGroup,showOrder,planStartDateValue,
			 ...
			 if(reBuild!=true){
				 dataList=new Array(
							...
							"<span styleGroup='left'><input type='text' levelGroup='"+levelGroup+"' name='submitFactWorkDate' idGroup='factWorkDate' onBlur='checkFactWorkDate(this)' size='7' value='' /></span>",
							"<span styleGroup='left'><input type='text' levelGroup='"+levelGroup+"' name='submitPlanWorkTime' idGroup='planWorkTime' onBlur='checkPlanWorkTime(this)' size='7' value='' /></span>",
							"<span styleGroup='left'><input type='text' levelGroup='"+levelGroup+"' name='submitFactWorkTime' idGroup='factWorkTime' onBlur='checkFactWorkTime(this)' size='7' value='' /></span>",
				 ...
				 dataList=new Array(
							...
							"<span styleGroup='left'><input type='text' levelGroup='"+levelGroup+"' name='submitPlanWorkDate' idGroup='planWorkDate' size='7' onBlur='checkPlanWorkDate(this)'  value='"+planWorkDateValue+"' /></span>",
							"<span styleGroup='left'><input type='text' levelGroup='"+levelGroup+"' name='submitFactWorkDate' idGroup='factWorkDate' size='7' onBlur='checkFactWorkDate(this)' value='"+factWorkDateValue+"' /></span>",
							"<span styleGroup='left'><input type='text' levelGroup='"+levelGroup+"' name='submitPlanWorkTime' idGroup='planWorkTime' size='7' onBlur='checkPlanWorkTime(this)' value='"+planWorkTimeValue+"' /></span>",
							"<span styleGroup='left'><input type='text' levelGroup='"+levelGroup+"' name='submitFactWorkTime' idGroup='factWorkTime' size='7' onBlur='checkFactWorkTime(this)' value='"+factWorkTimeValue+"' /></span>",
							"<span styleGroup='left'><input type='text' levelGroup='"+levelGroup+"' name='submitPremise' idGroup='premise' size='7' maxlength='15' value='"+premiseValue+"' /></span>",
							"<span styleGroup='left'><input type='text' levelGroup='"+levelGroup+"' name='submitDutyMan' idGroup='dutyMan' size='13' maxlength='15' value='"+dutyManValue+"' /></span>",
							"<span styleGroup='left'><input type='text' levelGroup='"+levelGroup+"' name='submitFare' idGroup='fare' size='7' maxlength='15' value='"+fareValue+"' /></span>");
			 }
			 //alert(dataList[0]);
			 return dataList;
		 }
		...
		<table width="100%"class="input_table">
	        ...
	        <tr>
				...
				<td colspan="9" bgcolor="#FFFFFF" >
					<div align="left">
						<textarea name='plan.projectDesc' style="text-align:left;" onkeyup="checkPrjDesc(this)" id="basicProjectDesc"  type="text"  rows="3" cols="135" maxlength="20"><s:property value='plan.projectDesc'/></textarea>
					</div>
				</td>
			</tr>
        </table>
