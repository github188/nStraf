...
<body class="body" onLoad="goto(document.getElementById( 'task' ),'<%=request.getContextPath() %>/pages/SysUser/SysUserinfo!show.action','actmainFrame')">
	  ...
	  <tr>
	    <td valign="top" height="23" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
	      <tr>
            ...
            <div class="tabNav">
	          <ul id="ulTab">
	          	 <li> <a href="javascript:void(0);" id="task" onClick="goto(this,'<%=request.getContextPath() %>/pages/SysUser/SysUserinfo!show.action','actmainFrame')"><span class="TabbedPanelsTab">基本信息</span></a></li>
	             <li  id="tab1"> <a href="javascript:void(0);" id="order" onClick="goto(this,'<%=request.getContextPath() %>/pages/SysUser/SysUserinfo!showworkinginformation.action','actmainFrame')"><span class="TabbedPanelsTab">在职信息</span></a></li>
	             <li  id="tab2"> <a href="javascript:void(0);" id="order" onClick="goto(this,'<%=request.getContextPath() %>/pages/SysUser/SysUserinfo!showotherinformation.action','actmainFrame')"><span class="TabbedPanelsTab">其它信息</span></a></li>
