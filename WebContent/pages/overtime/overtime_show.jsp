			...
			<tr>
				<td>
						...
						<table width="90%" class="input_table">
							<tr>
                    			<td class="input_tablehead">加班详情：</td>
                   			 </tr>
							<tr>
							...
							<tr>
								<td class="input_label2" width="20%"><font
									color="#000000">调休时长：</font></td>
								<td bgcolor="#FFFFFF" colspan="4">
									 <div style="float:left;"><input name="overtime.sumtime" type="text" id="sumtime" style="width:30%;border:0px;" value='<s:property value="overtime.sumtime"/>' readonly="readonly"/><span style="margin-bottom:5px;">小时</span>
							...
							<tr>
								...
								<td colspan="4" bgcolor="#ffffff">
									<input type="text"  value="<s:property value='overtime.prjname'/>" readonly style="width:100%;">
								</td>
							</tr>
							<tr>
								<td height="44" class="input_label2">加班原因：</font></td>
								<td bgcolor="#FFFFFF" colspan="4"><textarea class="text_area"
										name="overtime.reason" type="text" id="note" rows="3"
										cols="50" readonly style="word-break:break-all;word-wrap:break-word;width:100%;"><s:property
											value="#request.overtime.reason" /></textarea></td>
							</tr>
							<tr>
								<td width="20%" class="input_label2"><font
									color="#000000">状态：</font></td>
								<td colspan="4" bgcolor="#FFFFFF">
									<input type="text" name="overtime.status" style="border:0;"
							...
							<tr>
				                ...
				                <td colspan="4" bgcolor="#FFFFFF">
								   	<select name="overtime.auditing_man" disabled
							...
							<tr>
								...
								<td colspan="5" bgcolor="#ffffff"><textarea class="text_area"
										name="overtime.auditlog" cols="50" rows="50"
