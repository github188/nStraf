...
<form action="/pages/watch/tranEspeciinfo!show.action"   method="post"    >
<table width="90%" align="center" cellPadding="0" cellSpacing="0" class="popnewdialog1">
<tr>
<td>
<fieldset class="jui_fieldset" width="100%">
<legend> add TranEspeciinfo </legend>
  <s:iterator value="tranEspeciinfo" id="tranEspeciinfo"> 
...
<td>c_reserve3</td> 
 ...
 </tr><tr><td>c_especiseq</td> 
  <td><input name="especiseq" type="text" id="especiseq"  size="30" maxlength="20" value='<s:property value="especiseq"/>' >  </td> 
<td>c_cometype</td> 
  <td><input name="cometype" type="text" id="cometype"  size="30" maxlength="20" value='<s:property value="cometype"/>' >  </td> 
 </tr><tr><td>c_result</td> 
  <td><input name="result" type="text" id="result"  size="30" maxlength="20" value='<s:property value="result"/>' >  </td> 
<td>c_sequence</td> 
