...
<html>
	<head>
		<title>TranCallbackAbnoinfo query</title>
	</head>
...
var actionUrl = "<%=request.getContextPath()%>/pages/watch/tranCallbackAbnoinfo!refresh.action?from=refresh"
...
html += '<td nowrap width="12%"><div align="center">' + entryInfo["abnoCallbackType"] +'</div></td>';
html += '<td nowrap width="40%"><div align="center">' + entryInfo["note"] +'</div></td>';
...
function show(id) {
	...
	<body id="bodyid" leftmargin="0" topmargin="0">
		<s:form name="tranCallbackAbnoinfoForm" namespace="/pages/watch"
			action="tranCallbackAbnoinfo!list.action" method="post">
								...
								<td width="83%" align="right">
									<div id="pagetag">
										<tm:pagetag pageName="currPage"
											formName="tranCallbackAbnoinfoForm" />
									</div>
								</td>
							</tr>
						</table>
			...
			<table width="100%" border="0" cellpadding="1" cellspacing="1"
				...
				<tr>
					...
					<td nowrap width="12%" class="oracolumncenterheader">
						<div align="center">
							<s:text name="watch.abnoCallbackType"/>
						</div>
					</td>
					<td nowrap width="40%" class="oracolumncenterheader">
						<div align="center">
				...
				<tbody name="formlist" id="formlist">
					<s:iterator value="tranCallbackAbnoinfoList"
						id="tranCallbackAbnoinfo">
						<tr id="tr" class="trClass<%=index % 2%>" oriClass=""
							...
							<td nowrap width="12%">
								<div align="center">
									<tm:dataDir beanName="tranCallbackAbnoinfo" property="abnoCallbackType" path="transMgr.abnoCallbackType" scope="request"/>
								</div>
							</td>
							<td nowrap width ="40%" >
								<div align="center">
