...
<html> 
 <head></head>
    ...
    var begin=document.getElementById(beginDate).value.trim();
...
function validateInputStart(){
	var re=/^((((1[6-9]|[2-9]\d)\d{2})-(0?[13578]|1[02]))|(((1[6-9]|[2-9]\d)\d{2})-(0?[13456789]|1[012]))|(((1[6-9]|[2-9]\d)\d{2})-0?2)|(((1[6-9]|[2-9]\d)(0[48]|[2468][048]|[13579][26])|((16|[2468][048]|[3579][26])00))-0?2))$/g;    
  	var thisDate = document.getElementById("start").value.trim();
		...
		function tihs()
		{
			var url="monthinfo!close.action";
...
<body id="bodyid"  leftmargin="0" topmargin="10" onUnload="tihs()">
	<form name="reportInfoForm" action="<%=request.getContextPath() %>/pages/month/monthinfo!update.action" method="post">
		<table width="100%" align="center" cellPadding="0" cellSpacing="0">
            <tr>
                ...
                <fieldset class="jui_fieldset" width="100%" style="margin-left:10px">
                    ...
                    <tr>
                    	<input type="hidden" id="riid" name="monthReport.id" value='<s:property value="monthReport.id"/>'/>
                        <td bgcolor="#FFFFFF" align="left"><div>组别：<input name="monthReport.groupName" type="text" id="groupName" maxlength="100" size="22" value='<s:property value="monthReport.groupName"/>' readonly style="background-color:#FFFFFF; border-right-style:none; border-bottom-style:none; border-left-style:none; border-top-style:none; color:#336699; padding-top:2"></div></td>  
                    </tr>
                </table>
                    ...
                    <br/>
                        <tr>
                            ...
                            <td width="45%" bgcolor="#FFFFFF"><div align="left"><input name="startDate" type="text" id="start" size="22" readonly value='<s:date name="monthReport.startDate" format="yyyy-MM"/>' style="background-color:#FFFFFF; border-right-style:none; border-bottom-style:none; border-left-style:none; border-top-style:none; color:#000000" ></div></td> 
                      ...
                      <tr>
                        ...
                        <td bgcolor="#FFFFFF" colspan="5" nowrap><textarea name="monthReport.taskDesc" type="text" id="taskInfo" rows="15" cols="80" ><s:property value="monthReport.taskDesc"/></textarea></td>
                      </tr>
                      <tr>
                      	<td align="center" bgcolor="#A5A5A5"><font color="#000000">经验/建议/问题：&nbsp;&nbsp;</font></td>
                        <td bgcolor="#FFFFFF" colspan="5" nowrap><textarea name="monthReport.note" type="text" id="note" rows="8" cols="80" ><s:property value="monthReport.note"/></textarea></td>
                      </tr>
                      <input type="hidden" name="monthReport.responsor" value='<s:property value="monthReport.responsor"/>'/>
                    </table>
                    <script type="text/javascript">
						document.getElementById("finishInfo").value = <s:property value="monthReport.finishInfo"/>;
					</script>
                </fieldset>
                </td> 
            </tr> 
