...
function ShowTitleModal(theURL,features){
  ...
  strReturn='/feeltm/pages/geog/areaMgr.do?action=query&amp;parentid='+document.forms[0].parentid.value 
    //alert('/feeltm/pages/geog/areaMgr.do?action=query&amp;parentid='+document.forms[0].parentid.value )

 window.location.href=strReturn
 }
function closeModal(){
  var theUrl='/feeltm/pages/geog/areaMgr.do?action=query&amp;parentid='+document.forms[0].parentid.value  ;
