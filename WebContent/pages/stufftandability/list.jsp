...
<script type="text/javascript"> 
		   ...
		   function document.onkeydown()
		    {	
	 		...
	 		function query(){			
				...
				Num2 = 0;
				pageNumTmp = pageNum;
			var actionUrl = "<%=request.getContextPath()%>/pages/stufftandability/stufftandabilityinfo!refresh.action?from=refresh&pageNum="+pageNum;
		...
		function del() {
			...
			if(confirm('<s:text name="确认删除该记录吗？" />')) {
				//alert("dddddd");
			 	var strUrl="/pages/stufftandability/stufftandabilityinfo!delete.action?ids="+idList;
		...
		function modify(){
			...
			if (j==0)
			 	...
			 	alert('<s:text name="operator.updateone" />')
			  	...
			  	var strUrl="/pages/stufftandability/stufftandabilityinfo!edit.action?ids="+itemId;
	...
	function add(){
    	...
    	var resultvalue = OpenModal('/pages/stufftandability/stufftandabilityinfo!add.action','1100,300,tmlInfo.addTmlTitle,tmlInfo');
		  if(resultvalue!=null)
	  		 query();
	}
	function up(){
 ...
 <body id="bodyid" leftmargin="0" topmargin="0"><br>
 	<s:form name="reportInfoForm"  namespace="/pages/stufftandability" action="stufftandabilityinfo!list.action" method="post" >
