...
-->
	...
	String.prototype.trim = function()
	{
		...
		function numClear(itemName){
			...
			document.getElementById("stufftandability.subtotal_z").value = 0;
			document.getElementById("stufftandability.subtotal_s").value = 0;
			ret1 = (parseFloat(document.getElementById("stufftandability.subtotal_z_1").value)*30/10 + parseFloat(document.getElementById("stufftandability.subtotal_z_2").value)*30/10+ parseFloat(document.getElementById("stufftandability.subtotal_z_3").value)*20/10 + parseFloat(document.getElementById("stufftandability.subtotal_z_4").value)*20/10 + parseFloat(document.getElementById("stufftandability.subtotal_z_5").value) + parseFloat(document.getElementById("stufftandability.subtotal_z_6").value)*30/10 + parseFloat(document.getElementById("stufftandability.subtotal_z_7").value)*20/10 + parseFloat(document.getElementById("stufftandability.subtotal_z_8").value)*20/10 + parseFloat(document.getElementById("stufftandability.subtotal_z_9").value)*20/10 + parseFloat(document.getElementById("stufftandability.subtotal_z_10").value)*20/10)*10/10;
			ret2 = (parseFloat(document.getElementById("stufftandability.subtotal_z_11").value) + parseFloat(document.getElementById("stufftandability.subtotal_z_12").value)+ parseFloat(document.getElementById("stufftandability.subtotal_z_13").value) + parseFloat(document.getElementById("stufftandability.subtotal_z_14").value))*10/10;
			document.getElementById("stufftandability.subtotal_z").value = (ret1+ ret2).toFixed(1);	
			document.getElementById("stufftandability.subtotal_z").value =document.getElementById("stufftandability.subtotal_z").value.replace(/(\.\d)\d+/ig,"$1");
			...
			ret = (parseFloat(document.getElementById("stufftandability.subtotal_d_1").value)*6/10+parseFloat(document.getElementById("stufftandability.subtotal_m_1").value)*4/10)*30/10;
            ...
            itemName.value = itemName.value.replace(/(\.\d)\d+/ig,"$1");
			ret = (parseFloat(document.getElementById("stufftandability.subtotal_d_2").value)*6/10+parseFloat(document.getElementById("stufftandability.subtotal_m_2").value)*4/10)*30/10;
            ...
            itemName.value = itemName.value.replace(/(\.\d)\d+/ig,"$1");
			ret = (parseFloat(document.getElementById("stufftandability.subtotal_d_3").value)*6/10+parseFloat(document.getElementById("stufftandability.subtotal_m_3").value)*4/10)*20/10;
            ...
            itemName.value = itemName.value.replace(/(\.\d)\d+/ig,"$1");
			ret = (parseFloat(document.getElementById("stufftandability.subtotal_d_4").value)*6/10+parseFloat(document.getElementById("stufftandability.subtotal_m_4").value)*4/10)*20/10;
            ...
            itemName.value = itemName.value.replace(/(\.\d)\d+/ig,"$1");
			ret = (parseFloat(document.getElementById("stufftandability.subtotal_d_5").value)*6/10+parseFloat(document.getElementById("stufftandability.subtotal_m_5").value)*4/10)*10/10;
            ...
            itemName.value = itemName.value.replace(/(\.\d)\d+/ig,"$1");
			ret = (parseFloat(document.getElementById("stufftandability.subtotal_d_6").value)*6/10+parseFloat(document.getElementById("stufftandability.subtotal_m_6").value)*4/10)*30/10;
            ...
            itemName.value = itemName.value.replace(/(\.\d)\d+/ig,"$1");
			ret = (parseFloat(document.getElementById("stufftandability.subtotal_d_7").value)*6/10+parseFloat(document.getElementById("stufftandability.subtotal_m_7").value)*4/10)*20/10;
            ...
            itemName.value = itemName.value.replace(/(\.\d)\d+/ig,"$1");
			ret = (parseFloat(document.getElementById("stufftandability.subtotal_d_8").value)*6/10+parseFloat(document.getElementById("stufftandability.subtotal_m_8").value)*4/10)*20/10;
		...
		function numVali_9(itemName) {
            ...
            itemName.value = itemName.value.replace(/(\.\d)\d+/ig,"$1");
			ret = (parseFloat(document.getElementById("stufftandability.subtotal_d_9").value)*6/10+parseFloat(document.getElementById("stufftandability.subtotal_m_9").value)*4/10)*20/10;
		...
		function numVali_10(itemName) {
            ...
            itemName.value = itemName.value.replace(/(\.\d)\d+/ig,"$1");
			ret = (parseFloat(document.getElementById("stufftandability.subtotal_d_10").value)*6/10+parseFloat(document.getElementById("stufftandability.subtotal_m_10").value)*4/10)*20/10;
		...
		function numVali_11(itemName) {
            ...
            itemName.value = itemName.value.replace(/(\.\d)\d+/ig,"$1");
			ret = (parseFloat(document.getElementById("stufftandability.subtotal_d_11").value)*6/10+parseFloat(document.getElementById("stufftandability.subtotal_m_11").value)*4/10)*10/10;
		...
		function numVali_12(itemName) {
            ...
            itemName.value = itemName.value.replace(/(\.\d)\d+/ig,"$1");
			ret = (parseFloat(document.getElementById("stufftandability.subtotal_d_12").value)*6/10+parseFloat(document.getElementById("stufftandability.subtotal_m_12").value)*4/10)*10/10;
		...
		function numVali_13(itemName) {
            ...
            itemName.value = itemName.value.replace(/(\.\d)\d+/ig,"$1");
			ret = (parseFloat(document.getElementById("stufftandability.subtotal_d_13").value)*6/10+parseFloat(document.getElementById("stufftandability.subtotal_m_13").value)*4/10)*10/10;
		...
		function numVali_14(itemName) {
            ...
            itemName.value = itemName.value.replace(/(\.\d)\d+/ig,"$1");
			ret = (parseFloat(document.getElementById("stufftandability.subtotal_d_14").value)*6/10+parseFloat(document.getElementById("stufftandability.subtotal_m_14").value)*4/10)*10/10;
        ...
        <br/>
              ...
              <tr>
                ...
                <td bgcolor="#FFFFFF"><div align="center">
                  <input name="stufftandability.subtotal_z_1" type="text" id="subtotal_z_1"  size="8" maxlength="11" onChange="numVali_1(this)" onBlur="numVali_1(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="stufftandability.subtotal_z_1"/>' />
                </div></td>
                         <td  bgcolor="#FFFFFF"><div align="center">
                           <textarea cols="16" rows="12" name="stufftandability.remark_z_1" 
												id="remark_z_1"><s:property value="stufftandability.remark_z_1"/></textarea>
                         </div></td>
                <td  bgcolor="#FFFFFF"><div align="center">
                  <input name="stufftandability.subtotal_d_1" type="text" id="subtotal_d_1"  size="8" maxlength="10" class="bgg"  value='<s:property value="stufftandability.subtotal_d_1"/>' readonly="readonly">
                      ...
                      <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="stufftandability.subtotal_m_1" type="text" id="subtotal_m_1" class="bgg" size="8" maxlength="10" value='<s:property value="stufftandability.subtotal_m_1"/>' readonly="readonly">
                      </div></td>
                       <td  bgcolor="#FFFFFF"><div align="center">
                ...
                <td bgcolor="#FFFFFF"><div align="center">3</div></td>
                <td bgcolor="#FFFFFF"><div align="center">
                        <input name="stufftandability.subtotal_z_2" type="text" id="subtotal_z_2"  size="8" maxlength="10" onChange="numVali_2(this)" onBlur="numVali_2(this)" onFocus="numClear(this)"  format="NN"  value='<s:property value="stufftandability.subtotal_z_2"/>' >
                      </div></td>
                         <td  bgcolor="#FFFFFF"><div align="center"><textarea cols="16" rows="13" name="stufftandability.remark_z_2"
												id="remark_z_2" ><s:property value="stufftandability.remark_z_2"/></textarea></td>
                <td  bgcolor="#FFFFFF"><div align="center">
                      ...
                      <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="stufftandability.subtotal_m_2" type="text" id="subtotal_m_2" class="bgg" size="8" maxlength="10" value='<s:property value="stufftandability.subtotal_m_2"/>' readonly="readonly">
                      </div></td>
                       <td  bgcolor="#FFFFFF"><div align="center">
              ...
              <tr>
                ...
                <td bgcolor="#FFFFFF"><div align="center">
                  <input name="stufftandability.subtotal_z_3" type="text" id="subtotal_z_3"  size="8" maxlength="10" onChange="numVali_3(this)" onBlur="numVali_3(this)" onFocus="numClear(this)"  format="NN"  value='<s:property value="stufftandability.subtotal_z_3"/>' >
                </div></td>
                         <td  bgcolor="#FFFFFF"><div align="center">
                           <textarea cols="16" rows="12" name="stufftandability.remark_z_3"
												id="stufftandability.remark_z_3" ><s:property value="stufftandability.remark_z_3"/></textarea>
                         </div></td>
                <td  bgcolor="#FFFFFF"><div align="center">
                      ...
                      <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="stufftandability.subtotal_m_3" type="text" id="subtotal_m_3" class="bgg" size="8" maxlength="10" value='<s:property value="stufftandability.subtotal_m_3"/>' readonly="readonly">
                      </div></td>
                       <td  bgcolor="#FFFFFF"><div align="center">
                ...
                <td bgcolor="#FFFFFF"><div align="center">2</div></td>
                <td bgcolor="#FFFFFF"><div align="center">
                        <input name="stufftandability.subtotal_z_4" type="text" id="subtotal_z_4"  size="8" maxlength="10" onChange="numVali_4(this)" onBlur="numVali_4(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="stufftandability.subtotal_z_4"/>' >
                      </div></td>
                         <td  bgcolor="#FFFFFF"><div align="center"><textarea cols="16" rows="10" name="stufftandability.remark_z_4"
												id="stufftandability.remark_z_4" ><s:property value="stufftandability.remark_z_4"/></textarea>
                      </div></td>
                <td  bgcolor="#FFFFFF"><div align="center">
                      ...
                      <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="stufftandability.subtotal_m_4" type="text" id="subtotal_m_4" class="bgg" size="8" maxlength="10" value='<s:property value="stufftandability.subtotal_m_4"/>' readonly="readonly">
                      </div></td>
                       <td  bgcolor="#FFFFFF"><div align="center">
                ...
                <td  bgcolor="#FFFFFF">
                  <div align="left">（0分）对开发语言都不熟悉；</div>  
					...
					<div align="left">（5分）精通C/C++、JAVA和C#语言中的任两种或熟练掌握两种以上。</div>  
                     <div align="left">语言包括如下：C/C++、JAVA、C#、JavaScript、VBScript、HTML、Flex</div>              </td>
                <td bgcolor="#FFFFFF"><div align="center">1</div></td>
                <td bgcolor="#FFFFFF"><div align="center">
                        <input name="stufftandability.subtotal_z_5" type="text" id="subtotal_z_5"  size="8" maxlength="10" onChange="numVali_5(this)" onBlur="numVali_5(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="stufftandability.subtotal_z_5"/>' >
                      </div></td>
                         <td  bgcolor="#FFFFFF"><textarea cols="16" rows="10"  name="stufftandability.remark_z_5"
												id="stufftandability.remark_z_5" ><s:property value="stufftandability.remark_z_5"/></textarea></td>
                <td  bgcolor="#FFFFFF"><div align="center">
                      ...
                      <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="stufftandability.subtotal_m_5" type="text" id="subtotal_m_5" class="bgg" size="8" maxlength="10" value='<s:property value="stufftandability.subtotal_m_5"/>' readonly="readonly">
                      </div></td>
                       <td  bgcolor="#FFFFFF"><div align="center">
               ...
               <tr>
				...
				<div align="left">（5分）能够熟练使用测试工具中的五种以上，且在测试中实际应用。</div>   
                 <div align="left"> 测试工具包括如下：TrueBack、TestTools、SPTestTools、报文解析工具、模拟主机、Insure++、PCLint、Logiscope、QTP、LoadRunner、QC/TD、CheckStyle </div>            </td>
                <td bgcolor="#FFFFFF"><div align="center">3</div></td>
                <td bgcolor="#FFFFFF"><div align="center">
                        <input name="stufftandability.subtotal_z_6" type="text" id="subtotal_z_6" onChange="numVali_6(this)" onBlur="numVali_6(this)" onFocus="numClear(this)"  format="NN"   size="8" maxlength="10"  value='<s:property value="stufftandability.subtotal_z_6"/>' >
                      </div></td>
                         <td  bgcolor="#FFFFFF"><textarea cols="16" rows="15" name="stufftandability.remark_z_6"
												id="stufftandability.remark_z_6" ><s:property value="stufftandability.remark_z_6"/></textarea></td>
                <td  bgcolor="#FFFFFF"><div align="center">
                      ...
                      <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="stufftandability.subtotal_m_6" type="text" id="subtotal_m_6" class="bgg" size="8" maxlength="10" value='<s:property value="stufftandability.subtotal_m_6"/>' readonly="readonly">
                      </div></td>
                       <td  bgcolor="#FFFFFF"><div align="center">
               ...
               <tr>
                ...
                <div align="left">数据库包括如下：SQL SERVER、ORACLE、SYBASE、ACCESS、DB2、Informix、MySQL</div>                </td>
                <td bgcolor="#FFFFFF"><div align="center">2</div></td>
                <td bgcolor="#FFFFFF"><div align="center">
                        <input name="stufftandability.subtotal_z_7" type="text" id="subtotal_z_7" onChange="numVali_7(this)" onBlur="numVali_7(this)" onFocus="numClear(this)"  format="NN" size="8" maxlength="10"  value='<s:property value="stufftandability.subtotal_z_7"/>' >
                      </div></td>
                         <td  bgcolor="#FFFFFF"><textarea cols="16" rows="10" name="stufftandability.remark_z_7"
												id="stufftandability.remark_z_7" ><s:property value="stufftandability.remark_z_7"/></textarea></td>
                <td  bgcolor="#FFFFFF"><div align="center">
                      ...
                      <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="stufftandability.subtotal_m_7" type="text" id="subtotal_m_7" class="bgg" size="8" maxlength="10" value='<s:property value="stufftandability.subtotal_m_7"/>' readonly="readonly">
                      </div></td>
                       <td  bgcolor="#FFFFFF"><div align="center">
               ...
               <tr>
				...
				<div align="left">（5分）善于文档编写，思路清晰，排版美观，且有一定的创意。</div>      
                 <div align="left">文档包括如下：含报告、缺陷描述、方案、PPT、其他文档等</div>                 </td>
                <td bgcolor="#FFFFFF"><div align="center">2</div></td>
                <td bgcolor="#FFFFFF"><div align="center">
                        <input name="stufftandability.subtotal_z_8" type="text" id="subtotal_z_8" onChange="numVali_8(this)" onBlur="numVali_8(this)" onFocus="numClear(this)"  format="NN" size="8" maxlength="10" value='<s:property value="stufftandability.subtotal_z_8"/>' >
                      </div></td>
                         <td  bgcolor="#FFFFFF"><textarea cols="16" rows="8" name="stufftandability.remark_z_8"
												id="stufftandability.remark_z_8" ><s:property value="stufftandability.remark_z_8"/></textarea></td>
                <td  bgcolor="#FFFFFF"><div align="center">
                      ...
                      <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="stufftandability.subtotal_m_8" type="text" id="subtotal_m_8" class="bgg" size="8" maxlength="10" value='<s:property value="stufftandability.subtotal_m_8"/>' readonly="readonly">
                      </div></td>
                       <td  bgcolor="#FFFFFF"><div align="center">
               ...
               <tr>
                ...
                <div align="left">协议标准包括如下:ISO8583、PBOC/EMV、EPP、NDC、XFS、公司的CPV规范</div>       </td>
                <td bgcolor="#FFFFFF"><div align="center">2</div></td>
                <td bgcolor="#FFFFFF"><div align="center">
                        <input name="stufftandability.subtotal_z_9" type="text" id="subtotal_z_9"  size="8" maxlength="10" onChange="numVali_9(this)" onBlur="numVali_9(this)" onFocus="numClear(this)"  format="NN"  value='<s:property value="stufftandability.subtotal_z_9"/>' >
                      </div></td>
                         <td  bgcolor="#FFFFFF"><textarea cols="16" rows="9" name="stufftandability.remark_z_9"
												id="stufftandability.remark_z_9"><s:property value="stufftandability.remark_z_9"/></textarea></td>
                <td  bgcolor="#FFFFFF"><div align="center">
                      ...
                      <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="stufftandability.subtotal_m_9" type="text" id="subtotal_m_9" class="bgg" size="8" maxlength="10" value='<s:property value="stufftandability.subtotal_m_9"/>' readonly="readonly">
                      </div></td>
                       <td  bgcolor="#FFFFFF"><div align="center">
                ...
                <td bgcolor="#FFFFFF"><div align="center">2</div></td>
                <td bgcolor="#FFFFFF"><div align="center">
                        <input name="stufftandability.subtotal_z_10" type="text" id="subtotal_z_10"  size="8" maxlength="10" onChange="numVali_10(this)" onBlur="numVali_10(this)" onFocus="numClear(this)"  format="NN"   value='<s:property value="stufftandability.subtotal_z_10"/>' >
                      </div></td>
                         <td  bgcolor="#FFFFFF"><textarea cols="16" rows="13" name="stufftandability.remark_z_10"
												id="stufftandability.remark_z_10" ><s:property value="stufftandability.remark_z_10"/></textarea></td>
                <td  bgcolor="#FFFFFF"><div align="center">
                      ...
                      <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="stufftandability.subtotal_m_10" type="text" id="subtotal_m_10" class="bgg" size="8" maxlength="10" value='<s:property value="stufftandability.subtotal_m_10"/>' readonly="readonly">
                      </div></td>
                       <td  bgcolor="#FFFFFF"><div align="center">
               ...
               <tr>
                ...
                <td bgcolor="#FFFFFF"><div align="center">1</div></td>
                <td bgcolor="#FFFFFF"><div align="center">
                        <input name="stufftandability.subtotal_z_11" type="text" id="subtotal_z_11" onChange="numVali_11(this)" onBlur="numVali_11(this)" onFocus="numClear(this)"  format="NN"  size="8" maxlength="15" value='<s:property value="stufftandability.subtotal_z_11"/>' >
                      </div></td>
                         <td  bgcolor="#FFFFFF"><textarea cols="16" rows="13" name="stufftandability.remark_z_11"
												id="stufftandability.remark_z_11" ><s:property value="stufftandability.remark_z_11"/></textarea></td>
                <td  bgcolor="#FFFFFF"><div align="center">
                      ...
                      <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="stufftandability.subtotal_m_11" type="text" id="subtotal_m_11" class="bgg" size="8" maxlength="10" value='<s:property value="stufftandability.subtotal_m_11"/>' readonly="readonly">
                      </div></td>
                       <td  bgcolor="#FFFFFF"><div align="center">
                ...
                <td bgcolor="#FFFFFF"><div align="center">1</div></td>
                <td bgcolor="#FFFFFF"><div align="center">
                        <input name="stufftandability.subtotal_z_12" type="text" id="subtotal_z_12"  size="8" maxlength="15" onChange="numVali_12(this)" onBlur="numVali_12(this)" onFocus="numClear(this)"  format="NN"  value='<s:property value="stufftandability.subtotal_z_12"/>' >
                      </div></td>
                         <td  bgcolor="#FFFFFF"><textarea cols="16" rows="12" name="stufftandability.remark_z_12"
												id="stufftandability.remark_z_12" ><s:property value="stufftandability.remark_z_12"/></textarea></td>
                <td  bgcolor="#FFFFFF"><div align="center">
                      ...
                      <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="stufftandability.subtotal_m_12" type="text" id="subtotal_m_12" class="bgg" size="8" maxlength="10" value='<s:property value="stufftandability.subtotal_m_12"/>' readonly="readonly">
                      </div></td>
                       <td  bgcolor="#FFFFFF"><div align="center">
                ...
                <td bgcolor="#FFFFFF"><div align="center">1</div></td>
                <td bgcolor="#FFFFFF"><div align="center">
                        <input name="stufftandability.subtotal_z_13" type="text" id="subtotal_z_13"  size="8" maxlength="15" onChange="numVali_13(this)" onBlur="numVali_13(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="stufftandability.subtotal_z_13"/>' >
                      </div></td>
                         <td  bgcolor="#FFFFFF"><textarea cols="16" rows="11" name="stufftandability.remark_z_13"
												id="stufftandability.remark_z_13" ><s:property value="stufftandability.remark_z_13"/></textarea></td>
                <td  bgcolor="#FFFFFF"><div align="center">
                      ...
                      <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="stufftandability.subtotal_m_13" type="text" id="subtotal_m_13" class="bgg" size="8" maxlength="10" value='<s:property value="stufftandability.subtotal_m_13"/>' readonly="readonly">
                      </div></td>
                       <td  bgcolor="#FFFFFF"><div align="center">
                ...
                <td bgcolor="#FFFFFF"><div align="center">1</div></td>
                <td bgcolor="#FFFFFF"><div align="center">
                        <input name="stufftandability.subtotal_z_14" type="text" id="subtotal_z_14"  size="8" maxlength="15" onChange="numVali_14(this)" onBlur="numVali_14(this)" onFocus="numClear(this)"  format="NN"  value='<s:property value="stufftandability.subtotal_z_14"/>' >
                      </div></td>
                         <td  bgcolor="#FFFFFF"><textarea cols="16" rows="12" name="stufftandability.remark_z_14"
												id="stufftandability.remark_z_14" ><s:property value="stufftandability.remark_z_14"/></textarea></td>
                <td  bgcolor="#FFFFFF"><div align="center">
                      ...
                      <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="stufftandability.subtotal_m_14" type="text" id="subtotal_m_14" class="bgg" size="8" maxlength="10" value='<s:property value="stufftandability.subtotal_m_14"/>' readonly="readonly">
                      </div></td>
                       <td  bgcolor="#FFFFFF"><div align="center">
