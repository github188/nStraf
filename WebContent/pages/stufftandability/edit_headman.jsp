...
-->
	...
	String.prototype.trim = function()
	{
		...
		function numClear(itemName){
			...
			document.getElementById("stufftandability.subtotal_d").value = 0;
			document.getElementById("stufftandability.subtotal_s").value = 0;
			ret1 = (parseFloat(document.getElementById("stufftandability.subtotal_d_1").value)*30/10 + parseFloat(document.getElementById("stufftandability.subtotal_d_2").value)*30/10+ parseFloat(document.getElementById("stufftandability.subtotal_d_3").value)*20/10 + parseFloat(document.getElementById("stufftandability.subtotal_d_4").value)*20/10 + parseFloat(document.getElementById("stufftandability.subtotal_d_5").value) + parseFloat(document.getElementById("stufftandability.subtotal_d_6").value)*30/10 + parseFloat(document.getElementById("stufftandability.subtotal_d_7").value)*20/10 + parseFloat(document.getElementById("stufftandability.subtotal_d_8").value)*20/10 + parseFloat(document.getElementById("stufftandability.subtotal_d_9").value)*20/10 + parseFloat(document.getElementById("stufftandability.subtotal_d_10").value)*20/10)*10/10;
			ret2 = (parseFloat(document.getElementById("stufftandability.subtotal_d_11").value) + parseFloat(document.getElementById("stufftandability.subtotal_d_12").value)+ parseFloat(document.getElementById("stufftandability.subtotal_d_13").value) + parseFloat(document.getElementById("stufftandability.subtotal_d_14").value))*10/10;
			document.getElementById("stufftandability.subtotal_d").value = (ret1+ ret2).toFixed(1);	
			document.getElementById("stufftandability.subtotal_d").value =document.getElementById("stufftandability.subtotal_d").value.replace(/(\.\d)\d+/ig,"$1");
	...
	<body id="bodyid" leftmargin="0" topmargin="10">
        ...
        <br/>
              ...
              <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">
                  <input name="stufftandability.subtotal_d_1" type="text" id="subtotal_d_1"  size="8" maxlength="10"  onChange="numVali_1(this)" onBlur="numVali_1(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="stufftandability.subtotal_d_1"/>' >
                </div></td>
                         <td  bgcolor="#FFFFFF"><div align="center"><textarea cols="16" rows="12"  name="stufftandability.remark_d_1"
												id="remark_d_1" ><s:property value="stufftandability.remark_d_1"/></textarea>
                      </div></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
                ...
                <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="stufftandability.subtotal_d_2" type="text" id="subtotal_d_2"  size="8" maxlength="10"  onChange="numVali_2(this)" onBlur="numVali_2(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="stufftandability.subtotal_d_2"/>'>
                      </div></td>
                         <td  bgcolor="#FFFFFF"><div align="center"><textarea cols="16" rows="13"  name="stufftandability.remark_d_2"
												id="remark_d_2"><s:property value="stufftandability.remark_d_2"/></textarea>
                      </div></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
              ...
              <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="stufftandability.subtotal_d_3" type="text" id="subtotal_d_3"  size="8" maxlength="10"  onChange="numVali_3(this)" onBlur="numVali_3(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="stufftandability.subtotal_d_3"/>' >
                      </div></td>
                         <td  bgcolor="#FFFFFF"><textarea cols="16" rows="12"  name="stufftandability.remark_d_3"
												id="stufftandability.remark_d_3"><s:property value="stufftandability.remark_d_3"/></textarea></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
                ...
                <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="stufftandability.subtotal_d_4" type="text" id="subtotal_d_4" size="8" maxlength="10"  onChange="numVali_4(this)" onBlur="numVali_4(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="stufftandability.subtotal_d_4"/>'>
                      </div></td>
                         <td  bgcolor="#FFFFFF"><div align="center"><textarea cols="16" rows="10" name="stufftandability.remark_d_4"
												id="stufftandability.remark_d_4"><s:property value="stufftandability.remark_d_4"/></textarea>
                      </div></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
               ...
               <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="stufftandability.subtotal_d_5" type="text" id="subtotal_d_5" size="8" maxlength="10"  onChange="numVali_5(this)" onBlur="numVali_5(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="stufftandability.subtotal_d_5"/>'>
                      </div></td>
                         <td  bgcolor="#FFFFFF"><textarea cols="16" rows="10" name="stufftandability.remark_d_5"
												id="stufftandability.remark_d_5"><s:property value="stufftandability.remark_d_5"/></textarea></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
               ...
               <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="stufftandability.subtotal_d_6" type="text" id="subtotal_d_6"  size="8" maxlength="10"  onChange="numVali_6(this)" onBlur="numVali_6(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="stufftandability.subtotal_d_6"/>' >
                      </div></td>
                         <td  bgcolor="#FFFFFF"><textarea cols="16" rows="15"  name="stufftandability.remark_d_6"
												id="stufftandability.remark_d_6" ><s:property value="stufftandability.remark_d_6"/></textarea></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
               ...
               <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="stufftandability.subtotal_d_7" type="text" id="subtotal_d_7"  size="8" maxlength="10"  onChange="numVali_7(this)" onBlur="numVali_7(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="stufftandability.subtotal_d_7"/>' >
                      </div></td>
                         <td  bgcolor="#FFFFFF"><textarea cols="16" rows="10"  name="stufftandability.remark_d_7"
												id="stufftandability.remark_d_7"><s:property value="stufftandability.remark_d_7"/></textarea></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
               ...
               <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="stufftandability.subtotal_d_8" type="text" id="subtotal_d_8"  size="8" maxlength="10"  onChange="numVali_8(this)" onBlur="numVali_8(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="stufftandability.subtotal_d_8"/>'>
                      </div></td>
                         <td  bgcolor="#FFFFFF"><textarea cols="16" rows="8"  name="stufftandability.remark_d_8"
												id="stufftandability.remark_d_8" ><s:property value="stufftandability.remark_d_8"/></textarea></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
               ...
               <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="stufftandability.subtotal_d_9" type="text" id="subtotal_d_9"  size="8" maxlength="10"  onChange="numVali_9(this)" onBlur="numVali_9(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="stufftandability.subtotal_d_9"/>' >
                      </div></td>
                         <td  bgcolor="#FFFFFF"><textarea cols="16" rows="9"  name="stufftandability.remark_d_9"
												id="stufftandability.remark_d_9" ><s:property value="stufftandability.remark_d_9"/></textarea></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
                ...
                <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="stufftandability.subtotal_d_10" type="text" id="subtotal_d_10"  size="8" maxlength="10"  onChange="numVali_10(this)" onBlur="numVali_10(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="stufftandability.subtotal_d_10"/>' >
                      </div></td>
                         <td  bgcolor="#FFFFFF"><textarea cols="16" rows="13"  name="stufftandability.remark_d_10"
												id="stufftandability.remark_d_10" ><s:property value="stufftandability.remark_d_10"/></textarea></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
               ...
               <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="stufftandability.subtotal_d_11" type="text" id="subtotal_d_11"  size="8" maxlength="10"  onChange="numVali_11(this)" onBlur="numVali_11(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="stufftandability.subtotal_d_11"/>' >
                      </div></td>
                         <td  bgcolor="#FFFFFF"><textarea cols="16" rows="13" name="stufftandability.remark_d_11"
												id="stufftandability.remark_d_11" ><s:property value="stufftandability.remark_d_11"/></textarea></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
                ...
                <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="stufftandability.subtotal_d_12" type="text" id="subtotal_d_12"  size="8" maxlength="10"  onChange="numVali_12(this)" onBlur="numVali_12(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="stufftandability.subtotal_d_12"/>' >
                      </div></td>
                         <td  bgcolor="#FFFFFF"><textarea cols="16" rows="12"  name="stufftandability.remark_d_12"
												id="stufftandability.remark_d_12" ><s:property value="stufftandability.remark_d_12"/></textarea></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
                ...
                <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="stufftandability.subtotal_d_13" type="text" id="subtotal_d_13"  size="8" maxlength="10"  onChange="numVali_13(this)" onBlur="numVali_13(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="stufftandability.subtotal_d_13"/>' >
                      </div></td>
                         <td  bgcolor="#FFFFFF"><textarea cols="16" rows="11"  name="stufftandability.remark_d_13"
												id="stufftandability.remark_d_13" ><s:property value="stufftandability.remark_d_13"/></textarea></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
                ...
                <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="stufftandability.subtotal_d_14" type="text" id="subtotal_d_14"  size="8" maxlength="10"  onChange="numVali_14(this)" onBlur="numVali_14(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="stufftandability.subtotal_d_14"/>' >
                </div></td>
                         <td  bgcolor="#FFFFFF"><textarea cols="16" rows="12"  name="stufftandability.remark_d_14"
												id="stufftandability.remark_d_14" ><s:property value="stufftandability.remark_d_14"/></textarea></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
