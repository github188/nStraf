...
<script type="text/javascript"> 
	...
	function setHTML(entry,entryInfo){
		...
		html += '<td>' + entryInfo["mindate"] + '</td>';
		html += '<td>' + entryInfo["morn_islast"] + '</td>';
		html += '<td>' + entryInfo["etime"] + '</td>';
		html += '<td>' + entryInfo["maxdate"] + '</td>';
		html += '<td>' + entryInfo["after_isleave"] + '</td>';
		html += '<td>' + entryInfo["iscatch"] + '</td>';
		html += '<td>' + entryInfo["overtime"] + '</td>';
		var overtype = entryInfo["overtype"];
		if(overtype=="0"){
			overtype="周末或节假日";
		}
		if(overtype=="1"){
		...
		html += '<td>' + overtype + '</td>';
		html += '<td>' + entryInfo["expensemoney"] + '</td>';
		html += '<td>' + entryInfo["all_expensemoney"] + '</td>';
	  	html += '</tr>';
	 	<% k++;%>;
		return html;
	}
 ...
 <body id="bodyid" style="margin: 0" onload="init();">
	...
	<table width="100%" border="0" cellpadding="1" cellspacing="1" bgcolor="#000066">
		<tr>
			...
			<td nowrap width="8%" class="oracolumncenterheader"><div align="center">上班</div></td>
			<td nowrap width="8%" class="oracolumncenterheader"><div align="center">上班打卡</div></td>
			<td nowrap width="8%" class="oracolumncenterheader"><div align="center">是否迟到</div></td>
			<td nowrap width="8%" class="oracolumncenterheader"><div align="center">下班</div></td>
			<td nowrap width="8%" class="oracolumncenterheader"><div align="center">下班打卡</div></td>
            <td nowrap width="8%" class="oracolumncenterheader"><div align="center">是否早退</div></td>
            <td nowrap width="10%" class="oracolumncenterheader"><div align="center">是否异常数据</div></td>
            <td nowrap width="8%" class="oracolumncenterheader"><div align="center">加班时长</div></td>
            <td nowrap width="12%" class="oracolumncenterheader"><div align="center">加班类型</div></td>
            <td nowrap width="10%" class="oracolumncenterheader"><div align="center">报销金额(元)</div></td>
            <td nowrap width="10%" class="oracolumncenterheader"><div align="center">报销总金额(元)</div></td>
		</tr>
