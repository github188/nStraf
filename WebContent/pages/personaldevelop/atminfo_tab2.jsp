...
<script language="JavaScript">
		function goto(obj,url,target)
		{
		    ...
		    {
		    	url=url+"?id="+clientId;
		    	document.getElementById("td1").width="1100";
		    }
		    else{
		...
		function showLi(){
			document.getElementById("td1").width="1112";
...
<body class="body" onLoad="goto(document.getElementById( 'task' ),'<%=request.getContextPath() %>/pages/personaldevelop/personaldevelopinfo!edit.action','actmainFrame')">
	...
	<table width="98%" height="98%" border="0" align='center' cellspacing="0" cellpadding="0">
	  <tr>
	    <td valign="top" height="23" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
	      ...
	      <tr>
	        <td  style="width:1000" id="td1">
            <div class="tabNav">
	          <ul id="ulTab">
	          	 <li> <a href="javascript:void(0);" id="task" onClick="goto(this,'<%=request.getContextPath() %>/pages/personaldevelop/personaldevelopinfo!edit.action','actmainFrame')"><span class="TabbedPanelsTab">自我优势分析</span></a></li>
	             <li style="display:none;" id="tab1"> <a href="javascript:void(0);" id="order" onClick="goto(this,'<%=request.getContextPath() %>/pages/personaldevelop/personaldevelopinfo!editWaitupDevelop.action','actmainFrame')"><span class="TabbedPanelsTab">待提升能力</span></a></li>
	             <li style="display:none;" id="tab2"> <a href="javascript:void(0);" id="order" onClick="goto(this,'<%=request.getContextPath() %>/pages/personaldevelop/personaldevelopinfo!editAbilityDevelopPlan.action','actmainFrame')"><span class="TabbedPanelsTab">能力发展计划</span></a></li>
                  <li style="display:none;" id="tab3"> <a href="javascript:void(0);" id="order" onClick="goto(this,'<%=request.getContextPath() %>/pages/personaldevelop/personaldevelopinfo!showAbilityLog.action','actmainFrame')"><span class="TabbedPanelsTab">日志记录</span></a></li>
               </ul>
	          </div>
	          </td>
