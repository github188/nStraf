...
<html>
	...
	<body id="bodyid" leftmargin="0" topmargin="10" onLoad="init();">
		<form name="reportInfoForm" method="post" action="<%=request.getContextPath() %>/pages/personaldevelop/personaldevelopinfo!save.action">
					<input type="hidden" id="id" name="id"
				value='<s:property value="id"/>'>
        <input type="hidden" id="log" name="abilitylog.log"
				value='<s:property value="abilitylog.log"/>'>
        <input type="hidden" name="addgroupname" id="addgroupname" value='<s:property value="addgroupname"/>'>
        <input type="hidden" name="addname" id="addname" value='<s:property value="addname"/>'>
        <input type="hidden" name="createyearTmp" id="createyearTmp"  value='<s:date name="new java.util.Date()" format="yyyy"/>' >  
    ...
    <fieldset class="jui_fieldset" width="100%">
                ...
                <td width="15%" align="center" bgcolor="#999999"><div align="center"> 姓名<font color="#FF0000">*</font></div></td>
                <td   bgcolor="#FFFFFF"><input name="abilityanalyse.name" type="text" class="bgg" id="name" size="10"  maxlength="20" value='<s:property value="abilityanalyse.name"/>' readonly="readonly">                </td>
                <td width="15%" align="center" bgcolor="#999999"><div align="center"> 组别<font color="#FF0000">*</font> </div></td>
                <td   bgcolor="#FFFFFF"><input name="abilityanalyse.groupname" type="text" id="groupname" class="bgg" value='<s:property value="abilityanalyse.groupname"/>' size="16"  maxlength="20" readonly="readonly">    </td>
              </tr>
								<tr>
						  ...
						  <div align="center" style="width: 100px">
                       	...
                       	<textarea cols="63" rows="11" name="abilityanalyse.analyse"
												id="analyse" ><s:property value="abilityanalyse.analyse"/></textarea>
									</td>
	     <script type="text/javascript">
		 if(document.getElementById("groupname").value == "")
		 {
	     	document.getElementById("groupname").value = document.getElementById("addgroupname").value;
		 }
		 if(document.getElementById("name").value == "")
		 {
	     	document.getElementById("name").value = document.getElementById("addname").value;
		 }
		 if(document.getElementById("createyear").value == "")
		 {
	     	document.getElementById("createyear").value = document.getElementById("createyearTmp").value;
		 }
		 </script>
							  </tr>
