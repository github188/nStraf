...
<body class="body" onLoad="goto(document.getElementById( 'task' ),'<%=request.getContextPath() %>/pages/personaldevelop/personaldevelopinfo!add.action','actmainFrame')">
	  ...
	  <tr>
	    <td valign="top" height="23" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
	      ...
	      <tr>
            ...
            <div class="tabNav">
	          <ul id="ulTab">
	          	 <li> <a href="javascript:void(0);" id="task" onClick="goto(this,'<%=request.getContextPath() %>/pages/personaldevelop/personaldevelopinfo!add.action','actmainFrame')"><span class="TabbedPanelsTab">自我优势分析</span></a></li>
	             <li style="display:none;" id="tab1"> <a href="javascript:void(0);" id="order" onClick="goto(this,'<%=request.getContextPath() %>/pages/personaldevelop/personaldevelopinfo!addWaitupDevelop.action','actmainFrame')"><span class="TabbedPanelsTab">待提升能力</span></a></li>
	             <li style="display:none;" id="tab2"> <a href="javascript:void(0);" id="order" onClick="goto(this,'<%=request.getContextPath() %>/pages/personaldevelop/personaldevelopinfo!addAbilityDevelopPlan.action','actmainFrame')"><span class="TabbedPanelsTab">能力发展计划</span></a></li>
