		...
		<table width="80%" align="center" cellPadding="1" cellSpacing="1" class="popnewdialog1">
            <tr>
              ...
              <tr id='task<s:property value="#st.index"/>'>
                      ...
                      <td  bgcolor="#FFFFFF">
                      <input name="taskDesc"  id="taskDesc"  size="40" maxlength="40" value='<s:property value="taskDesc"/>'>
									</td>
                                                          <td nowrap  bgcolor="#FFFFFF">
                      <input name="capabilityExplain" type="text"  id="capabilityExplain"  size="73" maxlength="73" value='<s:property value="capabilityExplain"/>'>
									</td>
