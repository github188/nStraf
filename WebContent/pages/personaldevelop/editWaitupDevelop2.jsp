...
<body id="bodyid"  leftmargin="0" topmargin="10"  onLoad="init();">
	<form name="reportInfoForm" action="<%=request.getContextPath() %>/pages/personaldevelop/personaldevelopinfo!updateWaitupDevelop.action"   method="post">
			<input type="hidden" id="id" name="id"
                ...
                <input type="hidden" id="capabilityexplain444" name="waitupdevelop.capabilityexplain"
		...
		<table width="80%" align="center" cellPadding="1" cellSpacing="1" class="popnewdialog1">
            <tr>
              ...
              <tr id='task<s:property value="#st.index"/>'>
                      ...
                      <td  bgcolor="#FFFFFF">
                      <input name="taskDesc"  id="taskDesc" class="bgg" size="40" maxlength="40" value='<s:property value="taskDesc"/>' readonly="readonly">
									</td>
                      <td nowrap  bgcolor="#FFFFFF">
                      <input name="capabilityExplain" type="text" class="bgg" id="capabilityExplain"  size="73" maxlength="73" value='<s:property value="capabilityExplain"/>' readonly="readonly">
									</td>
                         	...
                         	<script language="javascript">
												...
												if(document.getElementById("level").value == "0")
												{
													for(var ind=0; ind<document.getElementsByName("taskDesc").length; ind++){
														...
														document.getElementsByName("capabilityExplain")[ind].readOnly = false;
														document.getElementsByName("capabilityExplain")[ind].style.backgroundColor='#FFFFFF';
													}
												}
						         </script>
                      </s:iterator>
