	...
	<script type="text/javascript">
		...
		function save(){
			...
			for(var ind=0; ind<iFuskTotal; ind++){
				...
				var finishdate = document.getElementsByName("finishDate")[ind]; 
				...
				if(finishdate!=null )
				{
					if(finishdate.value.trim() != "")
					{
						var flag1;
						flag1 = Validate(finishdate.value,"reg");
						if(flag1 == false)
						{
							alert("输入完成日期格式有误");
							return;
        ...
        <tr>
                ...
                <fieldset class="jui_fieldset" width="100%">
					...
					<tr id='task<s:property value="#st.index"/>'>
                      ...
                      <td  bgcolor="#FFFFFF"><textarea cols="15" rows="3" name="taskDesc" class="bgg" id="taskDesc" readonly><s:property value="taskDesc"/></textarea></td>
                      <td   bgcolor="#FFFFFF"><input name="planDate" class="bgg" type="text" id="planDate" size="15" maxlength="100"  value='<s:property value="planDate"/>' readonly="readonly"></td>
                      <td  bgcolor="#FFFFFF">
                      <input name="suggestMode" type="text" class="bgg" id="suggestMode"  size="10" maxlength="30" value='<s:property value="suggestMode"/>' readonly="readonly"></td>
                      <td  bgcolor="#FFFFFF"><textarea cols="20" rows="3" class="bgg" name="wishInstance" id="wishInstance" readonly><s:property value="wishInstance"/></textarea></td>
                      <td  bgcolor="#FFFFFF"><textarea cols="20" rows="3" name="finishInstance" 
												id="finishInstance" ><s:property value="finishInstance"/></textarea></td>
                    <td  bgcolor="#FFFFFF"><label><input name="finishDate" type="text" id="finishDate" size="15" maxlength="100"   value='<s:property value="finishDate"/>'></label></td>
                    <td  bgcolor="#FFFFFF"><textarea cols="20" rows="3" name="headmanScore" 
												id="headmanScore" ><s:property value="headmanScore"/></textarea></td>
                      <td  bgcolor="#FFFFFF"><textarea cols="20" rows="3" name="manageScore" 
												id="manageScore" ><s:property value="manageScore"/></textarea></td>
                     </tr>
                     					           	<script language="javascript">
												if(document.getElementById("level").value == "2")
												{
													for(var ind=0; ind<document.getElementsByName("taskDesc").length; ind++){
														document.getElementsByName("headmanScore")[ind].readOnly = true;
												   		document.getElementsByName("manageScore")[ind].readOnly = true;
												  	 	document.getElementsByName("headmanScore")[ind].style.backgroundColor='#999999';
														document.getElementsByName("manageScore")[ind].style.backgroundColor='#999999';
													}
												...
												{
													for(var ind=0; ind<document.getElementsByName("taskDesc").length; ind++){
														document.getElementsByName("taskDesc")[ind].readOnly = false;
														document.getElementsByName("taskDesc")[ind].style.backgroundColor='#FFFFFF';
													  	document.getElementsByName("planDate")[ind].readOnly = false;
														document.getElementsByName("planDate")[ind].style.backgroundColor='#FFFFFF';
														document.getElementsByName("suggestMode")[ind].readOnly = false;
														document.getElementsByName("suggestMode")[ind].style.backgroundColor='#FFFFFF';
													   	document.getElementsByName("wishInstance")[ind].readOnly = false;
														document.getElementsByName("wishInstance")[ind].style.backgroundColor='#FFFFFF';
												   		document.getElementsByName("headmanScore")[ind].readOnly = false;
														document.getElementsByName("headmanScore")[ind].style.backgroundColor='#FFFFFF';
														document.getElementsByName("finishInstance")[ind].readOnly = false;
														document.getElementsByName("finishInstance")[ind].style.backgroundColor='#FFFFFF';
														document.getElementsByName("finishDate")[ind].readOnly = false;
														document.getElementsByName("finishDate")[ind].style.backgroundColor='#FFFFFF';
													}
												}
						         </script>
                     </s:iterator>
				...
				<table width="100%" >
                      <tr>
                        <td><s:text name="label.admin.content"/></td>
                                            ...
                                            <tr>
                        <td align="left" valign="middle"><span class="STYLE4">●</span> &nbsp;请输入时间日期格式为:yyyy-MM-dd , 如2013-01-01</td>
                  </tr>
                  </table>
              </fieldset>
      </td>  
