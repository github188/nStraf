...
-->
   ...
   <script type="text/javascript" src="../../calendar/fixDate.js"></script>
	...
	<script type="text/javascript">
		...
		function validateInputInfo(plandate){
   ...
   return flag;
	...
	<body id="bodyid" leftmargin="0" topmargin="10" onLoad="init();">
		<form name="reportInfoForm"
			action="<%=request.getContextPath()%>/pages/personaldevelop/personaldevelopinfo!saveAbilityDevelopPlan.action"
			method="post">
        ...
        <tr>
                ...
                <fieldset class="jui_fieldset" width="100%">
                    ...
                    <table width="1000" align="center" border="0" cellspacing="1" cellpadding="1" bgcolor="#583F70"  id="record">
                    <br/>
                    <tr>
					...
					<tr id="task0">
                       ...
                       <td  bgcolor="#FFFFFF"><textarea cols="15" rows="3" name="taskDesc" id="taskDesc"></textarea></td>
                      <td  bgcolor="#FFFFFF">
                      <input name="planDate" type="text" id="planDate" size="15" maxlength="100" ></td>
                      <td  bgcolor="#FFFFFF"><input name="suggestMode" type="text" id="suggestMode"  size="10" maxlength="30"></td>
                      <td  bgcolor="#FFFFFF"><textarea cols="20" rows="3" name="wishInstance" id="wishInstance"></textarea></td>
                      <td  bgcolor="#FFFFFF"><textarea cols="20" rows="3" class="bgg" name="finishInstance" id="finishInstance" readonly></textarea></td>
                    <td  bgcolor="#FFFFFF"><label><input name="finishDate" type="text" id="finishDate" size="15" class="bgg" maxlength="100" readonly="readonly"></label></td>
                    <td  bgcolor="#FFFFFF"><textarea cols="15" rows="3" class="bgg" name="headmanScore" id="headmanScore" readonly></textarea></td>
                    <td  bgcolor="#FFFFFF"><textarea cols="15" rows="3" class="bgg" name="manageScore" id="manageScore" readonly></textarea></td>
                     </tr>
                    </table>
                </fieldset>
                </td> 
