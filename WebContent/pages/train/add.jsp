	...
	function vertiyt(obj) {
		...
		with (obj) {
			for (var i = 0; i < addressName.length; i++) {
				...
				if (addressName[i] == selectedText
						|| addressHelpCode[i] == selectedText) {
					yy = true;
					jj = i;
				}
			}
...
<body id="bodyid" leftmargin="0" topmargin="10">
	<form name="reportInfoForm"
		action="<%=request.getContextPath()%>/pages/train/traininfo!save.action"
		method="post">
				...
				<td>
					<table width="95%" class="input_table">
						...
						<tr>
							...
							<td bgcolor="#FFFFFF" width="28%"><select
								name="train.courseName" style="width: 163px;" id="courseName"
								onBlur="vertiyt(this)" onkeydown="catch_keydown(this)"
								onkeypress="writeSelect(this)">
									<option value=''>---</option>
									<s:iterator value="#request.courses" status="stuts" id="test">
										<option value='<s:property value="#test.courseName"/>'><s:property
												value="#test.courseName" /></option>
									</s:iterator>
							</select></td>
							<td width="13%" class="input_label2"><div align="center">
									分类<font color="#FF0000">*</font>
								</div></td>
							<td width="20%" bgcolor="#FFFFFF"><s:select
									list="{'内训','外训','外派'}" name="train.category" value="category"
									theme="simple" cssStyle="width:141px;" headerKey=""
									headerValue="----" id="category"></s:select></td>
							<td width="10%" class="input_label2"><div align="center">
									讲师<font color="#FF0000">*</font>
								</div></td>
							<td width="23%" bgcolor="#FFFFFF"><input
								name="train.teacher" type="text" id="teacher" size="25"
								maxlength="20" value='<s:property value="trip.oa_seqno"/>'></td>
						</tr>
						<tr>
							<td width="13%" class="input_label2"><div align="center">
									培训日期<font color="#FF0000"></font><font color="#FF0000">*</font>
								</div></td>
							<td bgcolor="#FFFFFF"><input name="train.trainDate"
								type="text" id="trainDate" size="18" maxlength="100"
								class="MyInput" /></td>
							<td width="13%" class="input_label2"><div align="center">
									培训时长<font color="#FF0000">*</font>
								</div></td>
							<td bgcolor="#FFFFFF"><input name="train.trainHour"
								onkeyup="this.value=this.value.replace(/[^\d\.]/g,'')" onKeyDown="this.value=this.value.replace(/[^\d\.]/g,'')"
								type="text" id="trainHour" size="20" maxlength="3">
							<div align="center"></div></td>
							<td class="input_label2"><div align="center">
									地点<font color="#FF0000">*</font>
								</div></td>
							<td bgcolor="#FFFFFF"><input name="train.addr" type="text"
								id="addr" size="25" maxlength="150"></td>
						</tr>
						<tr>
							<td class="input_label2">培训时间<font color="#FF0000">*</font></td>
							<td bgcolor="#FFFFFF"><input name="train.start" type="text"
								id="start" size="8" maxlength="100" class="timeInput" />--<input
								name="train.end" type="text" id="end" size="8" maxlength="100"
								class="timeInput" /></td>
							<td class="input_label2"><div align="center">
									参训人员<font color="#FF0000">*</font>
								</div></td>
							<td bgcolor="#FFFFFF" colspan="3"><textarea
									name="train.student" id="student" cols="35" rows="3"
									style="word-break:break-all;word-wrap:break-word;width:85%;"><s:property
										value='train.student' /></textarea> <input type="hidden"
								name="train.studentids" id="studentids" size="50"
								value="<s:property value='train.studentids'/>"> <input
								type="button" value="选择" id="zhusong"
								onClick="selectPeople('student','studentids')" /></td>

						</tr>
						<tr>
							<td width="13%" class="input_label2"><div align="center">备注</div></td>
							<td colspan="5" bgcolor="#FFFFFF"><textarea
									name="train.note" cols="77" rows="3" style="word-break:break-all;word-wrap:break-word;width:100%;"></textarea></td>

						</tr>
						<tr>
							<td colspan="6" bgcolor="#FFFFFF"><input type="checkbox"
								name="anon_flag" id="anon_flag" value="1" />跨部门</td>
						</tr>
					</table>
				</td>
			</tr>
