...
<body id="bodyid"  leftmargin="0" topmargin="10" >
	<form name="reportInfoForm" action="<%=request.getContextPath() %>/pages/totalPriceHist/totalPriceHistinfo!update.action" method="post">
                ...
                <table width="80%" align="center">
                    <tr>
                        <td align="left" bgcolor="#FFFFFF">姓名：
                        	<input name="totalPriceHist.id" type="hidden" value='<s:property value="totalPriceHist.id"/>'/>
                        	<input name="totalPriceHist.currentName" type="text" id="currentName" maxlength="100" size="22" value='<s:property value="totalPriceHist.currentName"/>' readonly style="background-color:#FFFFFF; border-right-style:none; border-bottom-style:none; border-left-style:none; border-top-style:none; color:#336699; padding-top:2">
                        </td> 
                        <td align="right" bgcolor="#FFFFFF">组别：
                        <input name="totalPriceHist.groupName" type="text" id="groupName" maxlength="100" size="22" value='<s:property value="totalPriceHist.groupName"/>' readonly style="background-color:#FFFFFF; border-right-style:none; border-bottom-style:none; border-left-style:none; border-top-style:none; color:#336699; padding-top:2"></td>
                    </tr>
                </table>
  <table width="90%" align="center" border="0" cellspacing="1" cellpadding="1" bgcolor="#583F70" style="border-bottom:none">
                    <br/>
                        <tr>
                            ...
                            <td bgcolor="#FFFFFF"><div align="left"><input name="totalPriceHist.monthDate" type="text" id="start" size="22" readonly value='<s:property value="totalPriceHist.monthDate"/>' style="background-color:#FFFFFF; border-right-style:none; border-bottom-style:none; border-left-style:none; border-top-style:none; color:#000000"></div></td> 
                      </tr>
		      <tr>
                      	<td align="center" bgcolor="#A5A5A5">总分</td>
                        <td bgcolor="#FFFFFF">
                        <div align="left"><input name="totalPriceHist.totalScore" type="text" id="start" size="22" readonly value='<s:property value="totalPriceHist.totalScore"/>' style="background-color:#FFFFFF; border-right-style:none; border-bottom-style:none; border-left-style:none; border-top-style:none; color:#000000"></div></td>
                      </tr>
                      <tr>
                      	<td align="center" bgcolor="#A5A5A5">原岗位</td>
                        <td bgcolor="#FFFFFF">
                        <div align="left"><input name="totalPriceHist.workTitleFut" type="text" id="start" size="22" readonly value='<s:property value="totalPriceHist.workTitleFut"/>' style="background-color:#FFFFFF; border-right-style:none; border-bottom-style:none; border-left-style:none; border-top-style:none; color:#000000"></div></td>
                      </tr>
                      <tr>
                      	<td align="center" bgcolor="#A5A5A5">调整后岗位</td>
                        <td bgcolor="#FFFFFF">
                        <select name="totalPriceHist.workTitleHist" id="workTitleFutSel">
                    ...
                    <input id="workTitleFutHidId" type="hidden" value='<s:property value="totalPriceHist.workTitleFut"/>' />
					<input id="workTitleFutSelid" type="hidden" value='<s:property value="totalPriceHist.workTitleHist"/>' />
...
<br/>
<script type="text/javascript">
if(document.getElementById("workTitleFutSelid").value!=""||document.getElementById("workTitleFutSelid").value!=null)
{
	var szTmp = $("#workTitleFutSelid").val();
	$("#workTitleFutSel").val(szTmp);
	
}
else
{
	var szTmp = $("#workTitleFutHidId").val();
	$("#workTitleFutSel").val(szTmp);
}
</script>
...
<script type="text/javascript">
	var ret;
	ret = $("input[name='totalPriceHist.totalScore']").val().trim();
	ret = Math.round(ret*10.0, 1);
	if(isNaN(ret))	ret = 0;
	$("input[name='totalPriceHist.totalScore']").val(ret/10.0);
