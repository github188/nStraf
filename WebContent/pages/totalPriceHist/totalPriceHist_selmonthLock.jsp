 ...
 <head></head>
	...
	<script type="text/javascript">
		...
		function save(){
			...
			if($("#monthDate").val().indexOf("所有月份")!=-1){
				alert("所有月份数据都已提交，请无需再提交了");
				return;
			}
...
<body id="bodyid"  leftmargin="0" topmargin="10" >
	<form name="reportInfoForm" action="<%=request.getContextPath() %>/pages/totalPriceHist/totalPriceHistinfo!upLock.action" method="post">
  ...
  <table width="90%" align="center" border="0" cellspacing="1" cellpadding="1" bgcolor="#FFFFFF" style="border-bottom:none">
                    <br/>
                        <tr>
							...
							<select name="monthDate" id="monthDate" style="width:163px;"></select>
							</div></td> 
                            <td>&nbsp;
...
<table width="80%" cellpadding="0" cellspacing="0" align="center"> 
    ...
    <script type="text/javascript">
	//startMonthHdl();
	var url="totalPriceHistinfo!queryNoEditMonth.action";
	var params={};
	...
	function fucku(json){
		...
		if(json!=null&&json.length>0)
			...
			$("#monthDate").append("<option>所有月份数据都已提交</option>");
		}
	}
	</script>
</body>  
