...
<body id="bodyid"  leftmargin="0" topmargin="10" >
  ...
  <table width="60%" align="center" border="0" cellspacing="1" cellpadding="1" bgcolor="#583F70" style="border-bottom:none">
                    <br/>
                        <tr>
                            <td align="center" bgcolor="#A5A5A5" width="20%">月份</td>
                            <td align="center" bgcolor="#A5A5A5" width="20%" id="legScoreID">得分</td> 
                      </tr>
                        <s:iterator value="MonthMissionMap" id="curData">
                        <tr align="center">
                        	<td bgcolor="#FFFFFF" name="mMonth"><s:property value="key"/></td>
                            <td bgcolor="#FFFFFF" name="mScore"><s:property value="value"/></td>
                        </tr>
                        </s:iterator>
                        <tr>
                            <td align="center" bgcolor="#A5A5A5">平均分</td>
                            <td align="center" id="avgid" bgcolor="#FFFFFF" style="color:#3333FF">&nbsp;</td> 
                      </tr>
                    </table>
                </fieldset>
                </td> 
    ...
    <input type="hidden" name="khType" id="khType" value='<s:property value="khType"/>' />
<br/>
...
<table width="80%" cellpadding="0" cellspacing="0" align="center"> 
	...
	switch($("#khType").val())
	{
		case "MS":
			$("#legID").text("月度考核明细");
			$("#legScoreID").text("月度考核得分");
			break;
		case "KS":
			$("#legID").text("KPI明细");
			$("#legScoreID").text("KPI得分");
			break;
	}
	var sum = 0;
	var count = 0;
	$("td[name='mScore']").each(function(){
		sum += parseFloat($(this).text().trim());
		count++;
	});
	var ret = Math.round(sum*10.0/count, 1);
	if(isNaN(ret))	ret = 0;
	$("#avgid").text(ret/10.0);
	</script>
</body>  
