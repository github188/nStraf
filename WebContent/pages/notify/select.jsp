...
<body id="menu">
 ...
 <s:iterator value="#request.deptUser" id="dept" status="status">
	  ...
	  <ul class="no">
	  	<s:iterator value="value">
		   <a href="javascript:void(0)"><input name="<s:property value="key"/>" type="checkbox" value='<s:property value="userid"/>:<s:property value="username"/>'><s:property value="username"/></a>
	   </s:iterator>
	  </ul>
  </s:iterator>
 </span>
 <h1 onClick="javascript:ShowMenu(this,1)"><a href="javascript:void(0)">按组别选择</a></a></h1>
 <span class="no">
 <s:iterator value="#request.usrGroups" status="status">
	  ...
	  <s:iterator value="#request.grpUser[code]">
	   <a href="javascript:void(0)"><input name="<s:property value="code"/>" type="checkbox" value='<s:property value="userid"/>:<s:property value="username"/>'><s:property value="username"/></a>
	   </s:iterator>
	  </ul>
  </s:iterator>
 </span>
