...
<body>
	<s:form action="/pages/expense/expenseInfo!importData.action" method="post" enctype="multipart/form-data">
      <br>
      <table border="0" width="100%" cellspacing="0" cellpadding="0">
      	<input name="expenseId" type="hidden"  value='<%=request.getParameter("expenseId") %>' >
      	<tr>
