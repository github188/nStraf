...
<body id="bodyid" leftmargin="0" topmargin="10">
	<form name="expenseInfoForm" id="expenseInfoForm"
		action="<%=request.getContextPath()%>/pages/expense/expenseInfo!audit.action"
		method="post">
			...
			<tr>
				<td>
					<table width="100%" align="center" border="0" cellspacing="1" cellpadding="1" class="input_table">
						...
						<tr>
							<td class="input_tablehead">报销行政审核</td>
						</tr>
					</table>
					<table width="95%" class="input_table">
						<tr>
							<td colspan="2">
								...
								报销状态：行政审核中&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input name="expenseAccount.status" id="status" readonly="true" type="hidden" value='1'>
						...
						<tr>
							...
							<td bgcolor="#FFFFFF">
								<select name="approveStatus" width="15%" id="approveStatus" onChange="approveStatusChange()">
               						<option value="1" >行政审核通过</option>
									<option value="0">行政审核不通过</option>
                				</select>
							</td>
						</tr>
						<tr id="finApproveTr">
		...
		<table width="80%" cellpadding="0" cellspacing="0" align="center">
			<tr>
				<td align="center">
					...
					<input type="button" name="return" value='打印报销明细单' class="MyButton" onclick="printDetail()" image="../../images/share/f_closed.gif">
					<input type="button" name="return" value='打印报销费用单' class="MyButton" onclick="printCost()" image="../../images/share/f_closed.gif">
					<input type="button" name="return" value='<s:text  name="button.close"/>' class="MyButton" onclick="closeModal(true);" image="../../images/share/f_closed.gif"></td>
			</tr>
		</table>
	</form>
</body>
