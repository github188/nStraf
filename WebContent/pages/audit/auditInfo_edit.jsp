...
<tr><td>c_audit_status</td> 
  <td><input name="auditStatus" type="text" id="auditStatus"  size="30" maxlength="20" value='<s:property value="auditStatus"/>' >  </td> 
<td>c_org_id</td> 
  <td><input name="orgId" type="text" id="orgId"  size="30" maxlength="20" value='<s:property value="orgId"/>'>  </td> 
 </tr><tr><td>c_apply_name</td> 
  <td><input name="applyName" type="text" id="applyName"  size="30" maxlength="20" value='<s:property value="applyName"/>' >  </td> 
<td>c_applay_date</td> 
  ...
  <td><input name="applytyp" type="text" id="applytyp"  size="30" maxlength="20" value='<s:property value="applytyp"/>' >  </td> 
<td>c_id</td> 
