	...
	<script type="text/javascript">
		...
		$(function(){
			...
			$("#weekSelect").change(function(){
				...
				location="<%=request.getContextPath()%>/pages/weeklog/logInfo!show.action?selectedWeek="+$(this).val()+"&personUserId="+$("#personUserId").val();
			});
		});
...
<td bgcolor="#FFFFFF">
	...
	<table width="100%" align="center">
     	<tr>
     		<td align="left" width="10%" class="input_label2"><b><div align="left" style="padding-top:4">姓名：<s:property value='#request.usr.username'/></div></b></td> 
         	<td align="left" width="3%"></td> 
     	 	<td align="left" width="10%" class="input_label2"><b><div align="left" style="padding-top:4">部门：<s:property value='#request.deptNameStr'/></div></b></td> 
         	<td align="right"></td>  
             ...
             <td align="left" width="20%"><div align="right">
           		...
           		<input type="hidden" name="personUserId" id="personUserId" value="<s:property value='#request.usr.userid'/>"  >
             </div></td>
			...
			<tr>
				...
				<td bgcolor="#FFFFFF" width="90%">
					...
					<table width="100%" border="0" align="center" cellspacing="1" cellpadding="1" bgcolor="#583F70">
	                  ...
	                  <tr>
	                      <td width="10%" class="input_label2"><div align="center"><font color="#000000">计划任务</font></div></td>
	                      <td colspan="5"  bgcolor="#FFFFFF" >
	                      		<div align="left">
	                      			<textarea style="border-color:transparent;text-align: left;"  readonly="readonly" type="text"  rows="2" cols="82" ><s:property value='desc'/></textarea>
	                      		</div>
	                      </td>
	                 </tr>
	                 <tr>
	                  <td width="10%" class="input_label2"><div align="center"><font color="#000000">任务描述</font></div></td>
	                     <td colspan="5"  bgcolor="#FFFFFF" >
	                     		<div align="left">
	                     			<textarea style="border-color:transparent;"  readonly="readonly" type="text"  rows="3" cols="82" ><s:property value='reason'/></textarea>
	                     		</div>
	                     </td>
	              </table>
			    </s:iterator>
	...
	<fieldset class="jui_fieldset" width="100%">
		...
		<div class="scrollFeild-loginfo" id="voteListContentDiv">
			<s:iterator value="#request.dateVoteList" id="dateVote" status="st">
				<table width="100%" align="center" border="0" cellspacing="1" cellpadding="1"  bgcolor="#583F70" style="word-break:break-all;word-wrap:break-word;">
				<tr>
					<td width="10%" bgcolor="#FFFFFF" style="text-align: center">
					        	...
					        	<tr>
					        		<td align="left">
						        		<div align="left" style="padding-top:4">
						        			<s:property value='voter'/>(<s:property value='voterDept'/>) <s:date name='voteTime' format="yyyy-MM-dd"/>:<s:property value='content'/>
						                </div>
					                </td>
				                </tr>
			                </s:iterator>
		...
		<table width="100%" align="center" border="0" cellspacing="1" cellpadding="1"  bgcolor="#583F70">
			<tr>
				<td class="input_label2" width="10%"><div align="center"><font color="red">本周总结</font></div></td>
	           	<td  bgcolor="#FFFFFF" >
	              	<div align="left">
	              		<textarea style="border-color:transparent;"  readonly="readonly"  type="text"  rows="3" cols="80" id="mySumary" name='personWeekLog.desc'><s:property value='personWeekLog.desc'/></textarea>
	              	</div>
	          	</td>
			</tr>
			<tr>
	           	...
	           	<td  bgcolor="#FFFFFF" >
	              	<div align="left">
	              		<textarea style="border-color:transparent;"  readonly="readonly"  type="text"  rows="3" cols="80" id="myPlan" name='personWeekLog.plan'><s:property value='personWeekLog.plan'/></textarea>
	              	</div>
          		</td>
			</tr>
		</table>
