...
/* 	function closeModal() {
	...
	function save() {
		var actionUrl="<%=request.getContextPath()%>/pages/weeklog/logInfo!exportData.action";
		if(timeGroup==""){
			timeGroup="week";
		}
		if(areaGroup==""){
...
<body id="bodyid" leftmargin="0" topmargin="10">
	<form name="reportInfoForm" action="<%=request.getContextPath()%>/pages/weeklog/logInfo!exportData.action" method="post">
		...
		<table width="99%" typeGroup="checkTable" align="center" cellPadding="1" cellSpacing="1" >
			<tr>
				...
				<td width="33%" style="size:25px;text-align: left;background-color:#E3E3E3">
					<input type="radio" name="timeGroup"  value='beforeweek' typeGroup='timeGroupRadio'/>上周
				</td>
