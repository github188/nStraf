	...
	<script type="text/javascript">
		...
		$(function(){
			...
			$("#weekSelect").change(function(){
				location="<%=request.getContextPath()%>/pages/weeklog/logInfo!refreshByWeek.action?selectedWeek="+$(this).val();
			});
		});
			...
			<tr>
				...
				<td bgcolor="#FFFFFF">
					...
					<table width="100%" border="0" align="center" cellspacing="1" cellpadding="1" bgcolor="#583F70">
	   		    		<tr >
	                          <td class="column_label"><div align="center"><font color="#000000">项目名称</font></div></td>
	                          <td class="column_label" ><div align="center"><font color="#000000">类别</font></div></td>
	                          <td class="column_label" ><div align="center"><font color="#000000">状态</font></div></td>
	                          <td class="column_label" ><div align="center"><font color="#000000">完成%</font></div></td>
	                          <td class="column_label" ><div align="center"><font color="#000000">计划/新增</font></div></td>
	                          <td class="column_label" ><div align="center"><font color="#000000">工时</font></div></td>
	                    </tr>
	                    <tr>
	                       	<td bgcolor="#FFFFFF">
	                  ...
	                  <tr >
	                      ...
	                      <td colspan="5"  bgcolor="#FFFFFF" >
	                      		<div align="left">
	                      			<textarea style="border-color:transparent;"   readonly="readonly" type="text"  rows="4" cols="65" ><s:property value='desc'/></textarea>
	                      		</div>
	                      </td>
	                 </tr>
	                 <tr>
	                  <td class="input_label2"><div align="center"><font color="#000000">任务描述</font></div></td>
	                     <td colspan="5"  bgcolor="#FFFFFF" >
	                     		<div align="left">
	                     			<textarea style="border-color:transparent;"  readonly="readonly" type="text"  rows="4" cols="65" ><s:property value='reason'/></textarea>
	                     		</div>
	                     </td>
	                    </tr>
	              </table>
	...
	<fieldset class="jui_fieldset" width="100%">
		...
		<div class="scrollFeild-loginfo" id="voteListContentDiv">
			<s:iterator value="#request.dateVoteList" id="dateVote" status="st">
				<table width="100%" style="table-layout:fixed" align="center" border="0" cellspacing="1" cellpadding="1"  bgcolor="#583F70">
				<tr>
					<td width="10%" bgcolor="#FFFFFF" style="text-align: center">
		...
		<table width="100%" align="center" border="0" cellspacing="1" cellpadding="1"  bgcolor="#583F70">
			<tr>
				<td class="input_label2" width="10%"><div align="center"><font color="red">本周总结</font></div></td>
	           	<td  bgcolor="#FFFFFF" >
	              	<div align="left">
	              		<textarea onclick="cacelSumaryPrompt(true)" onkeyup="checkSumary(this)"  type="text"  rows="4" cols="80" id="mySumary" name='personWeekLog.desc'></textarea>
	              	</div>
	          	</td>
			</tr>
			<tr>
	           	...
	           	<td  bgcolor="#FFFFFF" >
	              	<div align="left">
	              		<textarea onclick="cacelPlanPrompt(true)" onkeyup="checkPlan(this)"  type="text"  rows="4" cols="80" id="myPlan" name='personWeekLog.plan'></textarea>
	              	</div>
          		</td>
			</tr>
		</table>
