	...
	var re=/^((((1[6-9]|[2-9]\d)\d{2})-(0?[13578]|1[02]))|(((1[6-9]|[2-9]\d)\d{2})-(0?[13456789]|1[012]))|(((1[6-9]|[2-9]\d)\d{2})-0?2)|(((1[6-9]|[2-9]\d)(0[48]|[2468][048]|[13579][26])|((16|[2468][048]|[3579][26])00))-0?2))$/g;    
  	var thisDate = document.getElementById("startDate").value.trim();
		...
		function numVali(itemName) {
			...
			/*if(itemName.id == "punishRate")
			{
				var tmp = Math.round(parseFloat(itemName.value)*100)/100;
				itemName.value = -tmp;
			}*/
		}
...
<body id="bodyid"  leftmargin="0" topmargin="10" >
	<form name="reportInfoForm" action="<%=request.getContextPath() %>/pages/behavior/behaviorinfo!update.action" method="post">
                ...
                <table width="80%" align="center">
                    <tr>
                        <td align="left" bgcolor="#FFFFFF">姓名：
                        	<input name="behavior.id" type="hidden" value='<s:property value="behavior.id"/>'/>
							<input name="behavior.createName" type="hidden" value='<s:property value="behavior.createName"/>'/>
                        	<input name="behavior.username" type="text" id="username" maxlength="100" size="22" value='<s:property value="behavior.username"/>' readonly style="background-color:#FFFFFF; border-right-style:none; border-bottom-style:none; border-left-style:none; border-top-style:none; color:#336699; padding-top:2">
                        </td> 
                        <td align="right" bgcolor="#FFFFFF">组别：
                        <input name="behavior.groupName" type="text" id="groupName" maxlength="100" size="22" value='<s:property value="behavior.groupName"/>' readonly style="background-color:#FFFFFF; border-right-style:none; border-bottom-style:none; border-left-style:none; border-top-style:none; color:#336699; padding-top:2"></td>
                    </tr>
                </table>
  <table width="90%" align="center" border="0" cellspacing="1" cellpadding="1" bgcolor="#583F70" style="border-bottom:none">
                    <br/>
                        <tr>
                            <td align="center" bgcolor="#A5A5A5" width="20%"><font color="#000000">日期：</font></td>
                      ...
                      <tr>
                        ...
                        <td bgcolor="#FFFFFF" ><textarea name="behavior.prise" type="text" id="prise" rows="3" cols="50" ><s:property value="behavior.prise"/></textarea></td>
                       <td bgcolor="#A5A5A5" align="center"><input name="behavior.priseValue" type="text" id="priseRate" size="3" maxlength="3" value='<s:property value="behavior.priseValue"/>' onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"></td>
                      </tr>
                      <tr>
                      	<td height="44" align="center" bgcolor="#A5A5A5">惩罚事项：</td>
                        <td bgcolor="#FFFFFF"><textarea name="behavior.punish" type="text" id="punish" rows="3" cols="50" style="color:#FF0000" ><s:property value="behavior.punish"/></textarea></td>
                        <td bgcolor="#A5A5A5" align="center"><input name="behavior.punishValue" type="text" id="punishRate" size="3" maxlength="3" style="color:#FF0000" value='<s:property value="behavior.punishValue"/>' onChange="numVali2(this)" onBlur="numVali2Blur(this)" onFocus="numClear2(this)"></td>
                      </tr>
                      <tr>
                      	<td height="44" align="center" bgcolor="#A5A5A5">改进意见：</td>
                        <td bgcolor="#FFFFFF" colspan="2"><textarea name="behavior.note" type="text" id="note" rows="3" cols="56" ><s:property value="behavior.note"/></textarea></td>
                      </tr>
                    </table>
                </fieldset>
                </td> 
