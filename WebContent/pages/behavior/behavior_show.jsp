                ...
                <table width="80%" align="center">
                    <tr>
                        <td align="left" bgcolor="#FFFFFF">姓名：
                        	<input name="behavior.username" type="text" id="behavior.username" maxlength="100" size="22" value='<s:property value="behavior.username"/>' readonly style="background-color:#FFFFFF; border-right-style:none; border-bottom-style:none; border-left-style:none; border-top-style:none; color:#336699; padding-top:2">
                        </td> 
                        <td align="right" bgcolor="#FFFFFF">组别：
                        <input name="behavior.groupName" type="text" id="behavior.groupName" maxlength="100" size="22" value='<s:property value="behavior.groupName"/>' readonly style="background-color:#FFFFFF; border-right-style:none; border-bottom-style:none; border-left-style:none; border-top-style:none; color:#336699; padding-top:2"></td>
                    </tr>
                </table>
  <table width="90%" align="center" border="0" cellspacing="1" cellpadding="1" bgcolor="#583F70" style="border-bottom:none">
                    <br/>
                        <tr>
                            <td align="center" bgcolor="#A5A5A5" width="20%">日期：</td>
                            <td bgcolor="#FFFFFF"><div align="left"><input name="behavior.startDate" type="text" id="start" size="22" readonly value='<s:date name="behavior.startDate" format="yyyy-MM-dd"/>' style="background-color:#FFFFFF; border-right-style:none; border-bottom-style:none; border-left-style:none; border-top-style:none; color:#000000"></div></td> 
                            <td align="center" bgcolor="#A5A5A5" width="10%" >分值</td>                                 
                      </tr>
                      	<td align="center" bgcolor="#A5A5A5">奖励事项：</td>
                        <td bgcolor="#FFFFFF"><textarea name="behavior.prise" type="text" id="prise" rows="3" cols="50" readonly style= "BORDER-BOTTOM:0px solid; BORDER-LEFT:0px solid; BORDER-RIGHT:0px solid;BORDER-TOP:0px solid;scrollbar-shadow-color:white; overflow-x:hidden;overflow-y:hidden "><s:property value="behavior.prise"/></textarea></td>
                       <td bgcolor="#FFFFFF" align="center"><input name="behavior.priseValue" type="text" id="priseRate" size="5" readonly style="background-color:#FFFFFF; border-right-style:none; border-bottom-style:none; border-left-style:none; border-top-style:none; color:#000000" value='<s:property value="behavior.priseValue"/>'></td>
                      </tr>
                      <tr>
                      	<td height="44" align="center" bgcolor="#A5A5A5">惩罚事项：</td>
                        <td bgcolor="#FFFFFF"><textarea name="behavior.punish" type="text" id="punish" rows="3" cols="50" readonly  style= "BORDER-BOTTOM:0px solid; BORDER-LEFT:0px solid; BORDER-RIGHT:0px solid;BORDER-TOP:0px solid;scrollbar-shadow-color:white; overflow-x:hidden;overflow-y:hidden; color:#FF0000"><s:property value="behavior.punish"/></textarea></td>
                        <td bgcolor="#FFFFFF" align="center"><input name="behavior.punishValue" type="text" id="punishRate" size="5" readonly style="background-color:#FFFFFF; border-right-style:none; border-bottom-style:none; border-left-style:none; border-top-style:none; color:#FF0000" value='<s:property value="behavior.punishValue"/>'></td>
                      </tr>
                      <tr>
                      	<td height="44" align="center" bgcolor="#A5A5A5">改进意见：</td>
                        <td bgcolor="#FFFFFF" colspan="2"><textarea name="behavior.note" type="text" id="note" rows="3" cols="56" readonly style= "BORDER-BOTTOM:0px solid; BORDER-LEFT:0px solid; BORDER-RIGHT:0px solid;BORDER-TOP:0px solid;scrollbar-shadow-color:white; overflow-x:hidden;overflow-y:hidden "><s:property value="behavior.note"/></textarea></td>
                      </tr>
                    </table>
                </fieldset>
                </td> 
