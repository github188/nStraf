...
<body id="bodyid" leftmargin="0" topmargin="10">
	<form name="addCheckCondtionForm" action="<%=request.getContextPath()%>/pages/staffEntry/entryInfo!doAddCheckCondition.action" method="post">
		<table width="100%" align="center" border="0" cellspacing="1" cellpadding="1" bgcolor="#583F70" style="border-bottom: none">
			<tr>
				...
				<td bgcolor="#FFFFFF" width="60%">
					<input 	name="checkCondition.type" type="text" id="checkCondition.type" maxlength="25" size="40" class="MyInput" >
				</td>
			</tr>
			<tr>
				...
				<td bgcolor="#FFFFFF">
					<input 	name="checkCondition.content" type="text" id="checkCondition.content" maxlength="50" size="40" class="MyInput">
				</td>
			</tr>
			<tr>
				<td align="center" bgcolor="#999999">
				...
				<td bgcolor="#FFFFFF" >
					<input 	name="checkCondition.jointDept" type="text" id="checkCondition.jointDept" maxlength="16" size="40" class="MyInput" >
				</td>
			</tr>
			<tr>
				...
				<td bgcolor="#FFFFFF" >
					<div>
						<textarea cols="30" rows="3" name="checkCondition.note" id="checkCondition.note"></textarea>
					</div>
				</td>
			</tr>
		</table>
