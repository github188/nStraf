...
<html> 
 <head></head>
	...
	<script type="text/javascript">
		 ...
		 {	
			...
			{	
				for(var i=1;i<json.length;i++)
				{
				 ...
				 document.getElementById("versionNO").value = "全选";
		...
		{
			var url="prjparamsinfo!checkExist.action";
			var params={prjName1:$("#prjName").val(),versionNO1:$("#versionNO").val()};
			jQuery.post(url, params, $(document).callbackFun23, 'json');
		}
		$.fn.callbackFun23=function (json)
		 {	
		  	if(json!=null)
			{	
				/*for(var i=0;i<json.length;i++)
				{
				 ...
				 {
				 	submitOK = true;
					document.getElementById("prjDefect").disabled = false;
					document.getElementById("codeLine").disabled = false;
					document.getElementById("okButton").disabled = false;
					document.getElementById("showInfo").innerHTML = "";
				 }else{
				 	submitOK = false;
					document.getElementById("prjDefect").disabled = true;
					document.getElementById("codeLine").disabled = true;
					document.getElementById("okButton").disabled = true;
					document.getElementById("showInfo").innerHTML = "温馨提示：存在该记录，你不能新增，只能修改";
				 }
			}
		 }
...
<body id="bodyid"  leftmargin="0" topmargin="10" onLoad="searchPrj();">
	<form name="reportInfoForm" action="<%=request.getContextPath() %>/pages/prjparams/prjparamsinfo!save.action"   method="post">
            ...
            <tr>
                ...
                <fieldset class="jui_fieldset" width="100%">
                    ...
                    <br/>
                    	<tr>
                      	...
                      	<td bgcolor="#FFFFFF">
                        <s:select name="prjparams.prjType1" id="prjType1" theme="simple" list="prjTypes" cssStyle="width:360px;" onchange="searchType();"></s:select>
                ...
                <option value="dongbao">东保押运综合业务系统</option>
                        ...
                        <tr>
                          ...
                          <td bgcolor="#FFFFFF"><select name="prjparams.versionNO" id="versionNO" style="width: 360px" onChange="searchExist()"></select></td> 
                      </tr> 
                      <tr>
                          <td align="center" bgcolor="#999999"><div align="center">工程反馈缺陷数：<font color="#FF0000">*</font></div></td>  
                          <td bgcolor="#FFFFFF"><input name="prjparams.prjDefect" type="text" id="prjDefect" size="57" maxlength="6" value='' onChange="numVali(this)" onBlur="numVali(this)">&nbsp;</td> 
                       </tr>
                       <tr>
                          <td align="center" bgcolor="#999999"><div align="center">代码行数：</div></td>  
                          <td bgcolor="#FFFFFF"><input name="prjparams.codeLine" type="text" id="codeLine" size="57" maxlength="9" value='' onChange="numVali(this)" onBlur="numVali(this)">&nbsp;</td> 
                      </tr> 
                      <tr>
                      	<td align="center" bgcolor="#999999"><div align="center">备注信息：</div></td>
                      	<td bgcolor="#FFFFFF"><textarea name="prjparams.note" rows="4" cols="42"></textarea></td>
                      </tr>
                    </table>
                </fieldset>
                </td> 
