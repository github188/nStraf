...
-->
	...
	<body id="bodyid" leftmargin="0" topmargin="10">
      ...
      <input type="hidden" id="firstedit" name="kpipoint.firstedit" value='<s:property value="kpipoint.firstedit"/>'>
         ...
         <input type="hidden" name="UserfellowValue" id="UserfellowValue" value='<s:property value="UserfellowValue"/>'>
              ...
              <input type="hidden" name="UserTrainStride_num" id="UserTrainStride_num" value='<s:property value="UserTrainStride_num"/>'>
              <input type="hidden" name="UserTrainInner_num" id="UserTrainInner_num" value='<s:property value="UserTrainInner_num"/>'>
  ...
  <tr>
    ...
    <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.subtotal_1" type="text" id="subtotal_1" class="bgg" size="10" maxlength="10"   value='<s:property value="kpipoint.subtotal_1"/>' readonly="readonly">
        ...
        <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.coeff_1" type="text" id="coeff_1" class="bgg" size="10" maxlength="10"  value='4' readonly="readonly">
    </div></td>
    <td   bgcolor="#FFFFFF"><div align="center">
  ...
  <tr>
    ...
    <td  bgcolor="#FFFFFF" align="center"><input name="kpipoint.subtotal_2" type="text" id="subtotal_2" size="10" class="bgg" maxlength="10" format="NN" value='<s:property value="kpipoint.subtotal_2"/>' readonly="readonly"></td>
      <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.coeff_2" type="text" id="coeff_2" class="bgg" size="10" maxlength="10"  value='6' readonly="readonly">
    </div></td>
    <td   bgcolor="#FFFFFF"><div align="center">
  ...
  <tr>
    ...
    <td  bgcolor="#FFFFFF" align="center"><input name="kpipoint.subtotal_3" type="text" id="subtotal_3" size="10" class="bgg" maxlength="10" value='<s:property value="kpipoint.subtotal_3"/>' readonly="readonly"></td>
          <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.coeff_3" type="text" id="coeff_3" class="bgg" size="10" maxlength="10"  value='10' readonly="readonly">
    </div></td>
    <td  bgcolor="#FFFFFF"><div align="center">
   ...
   <tr>
    ...
    <td  bgcolor="#FFFFFF" align="center"><input name="kpipoint.subtotal_31" type="text" id="subtotal_31" size="10" class="bgg" maxlength="10" value='<s:property value="kpipoint.subtotal_31"/>' readonly="readonly"></td>
          <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.coeff_31" type="text" id="coeff_31" class="bgg" size="10" maxlength="10"  value='10' readonly="readonly">
    </div></td>
    <td  bgcolor="#FFFFFF"><div align="center">
  ...
  <tr>
    ...
    <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.subtotal_4" type="text" id="subtotal_4"  size="10" maxlength="10" class="bgg" value='<s:property value="kpipoint.subtotal_4"/>' readonly="readonly">
          ...
          <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.coeff_4" type="text" id="coeff_4" class="bgg" size="10" maxlength="10"  value='50' readonly="readonly">
    </div></td>
    <td   bgcolor="#FFFFFF"><div align="center">
  ...
  <tr>
    ...
    <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.coeff_5" type="text" id="coeff_5" class="bgg" size="10" maxlength="10"  value='3' readonly="readonly">
    </div></td>
    <td  bgcolor="#FFFFFF"><div align="center">
  ...
  <tr>
    ...
    <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.subtotal_6" type="text" id="subtotal_6"  size="10" class="bgg" maxlength="10"  value='<s:property value="kpipoint.subtotal_6"/>' readonly="readonly">
          ...
          <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.coeff_6" type="text" id="coeff_6" class="bgg" size="10" maxlength="10"  value='3' readonly="readonly">
    </div></td>
    <td   bgcolor="#FFFFFF"><div align="center">
  ...
  <tr>
    ...
    <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.subtotal_7" type="text" id="subtotal_7"  size="10" class="bgg" maxlength="10" value='<s:property value="kpipoint.subtotal_7"/>' readonly="readonly">
          ...
          <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.coeff_7" type="text" id="coeff_7" class="bgg" size="10" maxlength="10"  value='1' readonly="readonly">
    </div></td>
    <td   bgcolor="#FFFFFF"><div align="center">
  ...
  <tr>
    ...
    <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.subtotal_8" type="text" id="subtotal_8"  size="10" class="bgg" maxlength="10"  value='<s:property value="kpipoint.subtotal_8"/>' readonly="readonly">
          ...
          <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.coeff_8" type="text" id="coeff_8" class="bgg" size="10" maxlength="10"  value='1' readonly="readonly">
    </div></td>
    <td   bgcolor="#FFFFFF"><div align="center">
  ...
  <tr>
    ...
    <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.subtotal_9" type="text" id="subtotal_9"  size="10" class="bgg" maxlength="10"   value='<s:property value="kpipoint.subtotal_9"/>' readonly="readonly">
          ...
          <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.coeff_9" type="text" id="coeff_9" class="bgg" size="10" maxlength="10"  value='1' readonly="readonly">
    </div></td>
    <td   bgcolor="#FFFFFF"><div align="center">
  ...
  <tr>
    ...
    <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.subtotal_10" type="text" id="subtotal_10"  size="10" class="bgg"  maxlength="10" value='<s:property value="kpipoint.subtotal_10"/>' readonly="readonly">
          ...
          <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.coeff_10" type="text" id="coeff_10" class="bgg" size="10" maxlength="10"  value='1' readonly="readonly">
    </div></td>
    <td  bgcolor="#FFFFFF"><div align="center">
  ...
  <tr>
    ...
    <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.subtotal_11" type="text" id="subtotal_11"  size="10" class="bgg" maxlength="10"  value='<s:property value="kpipoint.subtotal_11"/>' readonly="readonly">
          ...
          <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.coeff_11" type="text" id="coeff_11" class="bgg" size="10" maxlength="10"  value='2' readonly="readonly">
    </div></td>
    <td  bgcolor="#FFFFFF"><div align="center">
  ...
  <tr>
    ...
    <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.subtotal_12" type="text" id="subtotal_12"  size="10" class="bgg" maxlength="10"   value='<s:property value="kpipoint.subtotal_12"/>' readonly="readonly">
          ...
          <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.coeff_12" type="text" id="coeff_12" class="bgg" size="10" maxlength="10"  value='3~5' readonly="readonly">
    </div></td>
    <td  bgcolor="#FFFFFF"><div align="center">
  ...
  <tr>
    ...
    <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.subtotal_13" type="text" id="subtotal_13"  size="10" class="bgg" maxlength="10"  value='<s:property value="kpipoint.subtotal_13"/>' readonly="readonly">
          ...
          <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.coeff_13" type="text" id="coeff_13" class="bgg" size="10" maxlength="10"  value='5' readonly="readonly">
    </div></td>
    <td  bgcolor="#FFFFFF"><div align="center">
  ...
  <tr>
    ...
    <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.subtotal_14" type="text" id="subtotal_14" size="10" class="bgg" maxlength="10"   value='<s:property value="kpipoint.subtotal_14"/>' readonly="readonly">
          ...
          <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.coeff_14" type="text" id="coeff_14" class="bgg" size="10" maxlength="10"  value='2' readonly="readonly">
    </div></td>
    <td  bgcolor="#FFFFFF"><div align="center">
  ...
  <tr>
    ...
    <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.subtotal_15" type="text" id="subtotal_15"  size="10" class="bgg"  maxlength="10" value='<s:property value="kpipoint.subtotal_15"/>' readonly="readonly">
          ...
          <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.coeff_15" type="text" id="coeff_15" class="bgg" size="10" maxlength="10"  value='2' readonly="readonly">
    </div></td>
    <td  bgcolor="#FFFFFF"><div align="center">
  ...
  <tr>
    ...
    <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.subtotal_16" type="text" id="subtotal_16" size="10" class="bgg" maxlength="10" value='<s:property value="kpipoint.subtotal_16"/>' readonly="readonly">
         ...
         <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.coeff_16" type="text" id="coeff_16" class="bgg" size="10" maxlength="10"  value='2' readonly="readonly">
    </div></td>
    <td bgcolor="#FFFFFF"><div align="center">
  ...
  <tr>
    ...
    <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.subtotal_17" type="text" id="subtotal_17"  size="10" class="bgg" maxlength="10"  value='<s:property value="kpipoint.subtotal_17"/>' readonly="readonly">
          ...
          <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.coeff_17" type="text" id="coeff_17" class="bgg" size="10" maxlength="10"  value='3' readonly="readonly">
    </div></td>
    <td  bgcolor="#FFFFFF"><div align="center">
  ...
  <tr>
    ...
    <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.subtotal_18" type="text" id="subtotal_18"  size="10" class="bgg" maxlength="10"   value='<s:property value="kpipoint.subtotal_18"/>' readonly="readonly">
          ...
          <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.coeff_18" type="text" id="coeff_18" class="bgg" size="10" maxlength="10"  value='3' readonly="readonly">
    </div></td>
    <td bgcolor="#FFFFFF"><div align="center"><input name="kpipoint.remark_18" type="text" id="remark_18" size="44" maxlength="44" value='<s:property value="kpipoint.remark_18"/>'></div></td>
  ...
  <tr>
    ...
    <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.subtotal_19" type="text" id="subtotal_19"  size="10" class="bgg" maxlength="10"   value='<s:property value="kpipoint.subtotal_19"/>' readonly="readonly">
          ...
          <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.coeff_19" type="text" id="coeff_19" class="bgg" size="10" maxlength="10"  value='0.5~5' readonly="readonly">
    </div></td>
    <td bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.remark_19" type="text" id="remark_19" size="44" maxlength="44" value='<s:property value="kpipoint.remark_19"/>'>
    </div></td>
    <td align="left" bgcolor="#FFFFFF">每次部门同事互相赞赏或表扬0.5分，主任或经理，从部门管理平台获取</td>
  </tr>
     <tr>
    ...
    <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.subtotal_33" type="text" id="subtotal_33"  size="10" class="bgg" maxlength="10"  value='<s:property value="kpipoint.subtotal_33"/>' readonly="readonly">
          ...
          <td  bgcolor="#FFFFFF"><div align="center">
            <input name="kpipoint.coeff_33" type="text" id="coeff_33"  size="10" maxlength="10" class="bgg" value='3'  readonly="readonly">
          </div></td>
    <td bgcolor="#FFFFFF"><div align="center">
   ...
   <tr>
    ...
    <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.subtotal_34" type="text" id="subtotal_34"  size="10" class="bgg" maxlength="10"  value='<s:property value="kpipoint.subtotal_34"/>' readonly="readonly">
          ...
          <td  bgcolor="#FFFFFF"><div align="center">
            <input name="kpipoint.coeff_34" type="text" id="coeff_34"  size="10" maxlength="10" class="bgg" value='5'  readonly="readonly">
          </div></td>
    <td bgcolor="#FFFFFF"><div align="center">
  ...
  <tr>
    ...
    <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.subtotal_20" type="text" id="subtotal_20"  size="10" class="bgg" maxlength="10"  value='<s:property value="kpipoint.subtotal_20"/>' readonly="readonly">
          ...
          <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.coeff_20" type="text" id="coeff_20" class="bgg" size="10" maxlength="10"  value='3' readonly="readonly">
    </div></td>
    <td  bgcolor="#FFFFFF"><div align="center">
  ...
  <tr>
    ...
    <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.subtotal_21" type="text" id="subtotal_21"  size="10" class="bgg" maxlength="10"  value='<s:property value="kpipoint.subtotal_21"/>' readonly="readonly">
          ...
          <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.coeff_21" type="text" id="coeff_21" class="bgg" size="10" maxlength="10"  value='10' readonly="readonly">
    </div></td>
    <td  bgcolor="#FFFFFF"><div align="center">
  ...
  <tr>
    ...
    <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.subtotal_22" type="text" id="subtotal_22"  size="10" class="bgg" maxlength="10"  value='<s:property value="kpipoint.subtotal_22"/>' readonly="readonly">
          ...
          <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.coeff_22" type="text" id="coeff_22" class="bgg" size="10" maxlength="10"  value='10' readonly="readonly">
    </div></td>
    <td bgcolor="#FFFFFF"><div align="center">
  ...
  <tr>
    ...
    <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.subtotal_23" type="text" id="subtotal_23" size="10" class="bgg" maxlength="10" value='<s:property value="kpipoint.subtotal_23"/>' readonly="readonly">
          ...
          <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.coeff_23" type="text" id="coeff_23" class="bgg" size="10" maxlength="10"  value='10' readonly="readonly">
    </div></td>
    <td  bgcolor="#FFFFFF"><div align="center">
  ...
  <tr>
    ...
    <td  bgcolor="#FFFFFF"><div align="center"><font color="#FF0000">
      <input name="kpipoint.subtotal_24" type="text" id="subtotal_24"  size="10" class="bgg" maxlength="10" value='<s:property value="kpipoint.subtotal_24"/>' readonly="readonly"></font>
          ...
          <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.coeff_24" type="text" id="coeff_24" class="bgg" size="10" maxlength="10"  value='3' readonly="readonly">
    </div></td>
    <td  bgcolor="#FFFFFF"><div align="center">
  ...
  <tr>
    ...
    <td  bgcolor="#FFFFFF"><div align="center"><font color="#FF0000">
      <input name="kpipoint.subtotal_25" type="text" id="subtotal_25"  size="10" class="bgg" maxlength="10" value='<s:property value="kpipoint.subtotal_25"/>' readonly="readonly"></font>
          ...
          <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.coeff_25" type="text" id="coeff_25" class="bgg" size="10" maxlength="10"  value='1' readonly="readonly">
    </div></td>
    <td  bgcolor="#FFFFFF"><div align="center">
  ...
  <tr>
    ...
    <td  bgcolor="#FFFFFF"><div align="center"><font color="#FF0000">
      <input name="kpipoint.subtotal_26" type="text" id="subtotal_26"size="10" class="bgg" maxlength="10"  value='<s:property value="kpipoint.subtotal_26"/>' readonly="readonly"></font>
          ...
          <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.coeff_26" type="text" id="coeff_26" class="bgg" size="10" maxlength="10"  value='0.5' readonly="readonly">
    </div></td>
    <td  bgcolor="#FFFFFF"><div align="center">
  ...
  <tr>
    ...
    <td  bgcolor="#FFFFFF"><div align="center"><font color="#FF0000">
      <input name="kpipoint.subtotal_27" type="text" id="subtotal_27"  size="10" class="bgg" maxlength="10" value='<s:property value="kpipoint.subtotal_27"/>' readonly="readonly"></font>
          ...
          <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.coeff_27" type="text" id="coeff_27" class="bgg" size="10" maxlength="10"  value='10' readonly="readonly">
    </div></td>
    <td   bgcolor="#FFFFFF"><div align="center">
    ...
    <td  bgcolor="#FFFFFF"><div align="center"><font color="#FF0000">
      <input name="kpipoint.subtotal_32" type="text" id="subtotal_32"  size="10" class="bgg" maxlength="10"  value='<s:property value="kpipoint.subtotal_32"/>' readonly="readonly"></font>
          ...
          <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.coeff_32" type="text" id="coeff_32" class="bgg" size="10" maxlength="10"  value='1' readonly="readonly">
    </div></td>
    <td   bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.remark_32" type="text" id="remark_28" size="44" maxlength="44" value='<s:property value="kpipoint.remark_32"/>'>
    </div></td>
    ...
    <td  bgcolor="#FFFFFF"><div align="center"><font color="#FF0000">
      <input name="kpipoint.subtotal_28" type="text" id="subtotal_28"  size="10" class="bgg" maxlength="10" value='<s:property value="kpipoint.subtotal_28"/>' readonly="readonly"></font>
          ...
          <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.coeff_28" type="text" id="coeff_28" class="bgg" size="10" maxlength="10"  value='5' readonly="readonly">
    </div></td>
    <td   bgcolor="#FFFFFF"><div align="center">
  ...
  <tr>
    ...
    <td  bgcolor="#FFFFFF"><div align="center"><font color="#FF0000">
      <input name="kpipoint.subtotal_29" type="text" id="subtotal_29" size="10"  maxlength="10" class="bgg" value='<s:property value="kpipoint.subtotal_29"/>' readonly="readonly"></font>
          ...
          <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.coeff_29" type="text" id="coeff_29" class="bgg" size="10" maxlength="10"  value='2' readonly="readonly">
    </div></td>
    <td  bgcolor="#FFFFFF"><div align="center">
    ...
    <td  bgcolor="#FFFFFF"><div align="center"><font color="#FF0000">
      <input name="kpipoint.subtotal_30" type="text" id="subtotal_30" size="10"  maxlength="10" class="bgg" value='<s:property value="kpipoint.subtotal_30"/>' readonly="readonly"></font>
          ...
          <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.coeff_30" type="text" id="coeff_30" class="bgg" size="10" maxlength="10"  value='5' readonly="readonly">
    </div></td>
    <td  bgcolor="#FFFFFF"><div align="center">
    ...
    <td  bgcolor="#FFFFFF"><div align="center"><font color="#FF0000">
      <input name="kpipoint.subtotal_35" type="text" id="subtotal_35" size="10"  maxlength="10" class="bgg" value='<s:property value="kpipoint.subtotal_35"/>' readonly="readonly"></font>
          ...
          <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.coeff_35" type="text" id="coeff_35" class="bgg" size="10" maxlength="10"  value='2' readonly="readonly">
    </div></td>
    <td  bgcolor="#FFFFFF"><div align="center">
    ...
    <td colspan="7"  bgcolor="#FFFFFF"><div align="left">
      <input name="kpipoint.remark" type="text" id="remark" class="bgg" size="172" maxlength="200" value='<s:property value="kpipoint.remark"/>' readonly="readonly">
    </div>
...
<input name="kpipoint.subtotal_s" type="text" id="subtotal_s" class="bgg" size="10" maxlength="10" value='<s:property value="kpipoint.subtotal_s"/>' readonly="readonly"></div></td>
    ...
    <script type="text/javascript">
								if(document.getElementById("firstedit").value == "初次修改")
								{
										...
										if(document.getElementById("UserTrainStride_num").value != "" && document.getElementById("UserTrainInner_num").value != "")
								        {
										   document.getElementById("number_12").value = parseFloat(document.getElementById("UserTrainStride_num").value) + parseFloat(document.getElementById("UserTrainInner_num").value);
										   document.getElementById("subtotal_12").value = (parseFloat(document.getElementById("UserTrainStride_num").value) *5) + (parseFloat(document.getElementById("UserTrainInner_num").value)*3);		
										   document.getElementById("remark_12").value = "本月部门培训次数为：" + document.getElementById("UserTrainInner_num").value + "，跨部门培训次数为:" +	document.getElementById("UserTrainStride_num").value;				
										}
										else if(document.getElementById("UserTrainStride_num").value != "" && document.getElementById("UserTrainInner_num").value == "")
								        {
										   document.getElementById("number_12").value = parseFloat(document.getElementById("UserTrainStride_num").value);
										   document.getElementById("subtotal_12").value = parseFloat(document.getElementById("UserTrainStride_num").value)*5;								   
										   document.getElementById("remark_12").value = "本月跨部门培训次数为:" +	document.getElementById("UserTrainStride_num").value;
										}
										else if(document.getElementById("UserTrainStride_num").value == "" && document.getElementById("UserTrainInner_num").value != "")
								        {
										   document.getElementById("number_12").value = parseFloat(document.getElementById("UserTrainInner_num").value);
										   document.getElementById("subtotal_12").value = parseFloat(document.getElementById("UserTrainInner_num").value)*3;									
										   document.getElementById("remark_12").value = "本月部门内培训次数为：" + document.getElementById("UserTrainInner_num").value;
										}	
