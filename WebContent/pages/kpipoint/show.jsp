...
-->
	...
	function numVali() {
			...
			ret2 = parseFloat(document.getElementById("kpipoint.subtotal_11").value) + parseFloat(document.getElementById("kpipoint.subtotal_12").value)+ parseFloat(document.getElementById("kpipoint.subtotal_13").value) + parseFloat(document.getElementById("kpipoint.subtotal_14").value) + parseFloat(document.getElementById("kpipoint.subtotal_15").value) + parseFloat(document.getElementById("kpipoint.subtotal_16").value) + parseFloat(document.getElementById("kpipoint.subtotal_17").value) + parseFloat(document.getElementById("kpipoint.subtotal_18").value) + parseFloat(document.getElementById("kpipoint.subtotal_19").value) + parseFloat(document.getElementById("kpipoint.subtotal_20").value);
		...
		function numVali_1(itemName) {
			...
			document.getElementById("kpipoint.subtotal_1").value = parseFloat(document.getElementById("kpipoint.number_1").value)/parseFloat(document.getElementById("kpipoint.coeff_1").value);
			numVali();
		}
		...
		function numVali_7(itemName) {
			...
			if(parseFloat(document.getElementById("kpipoint.subtotal_7").value)>10)
			{
				document.getElementById("kpipoint.subtotal_7").value = 10;
			}
			numVali();
		}
		...
		function numVali_9(itemName) {
			...
			if(parseFloat(document.getElementById("kpipoint.subtotal_9").value)>10)
			{
				document.getElementById("kpipoint.subtotal_9").value = 10;
			}
			numVali();
		}
		...
		function numVali_10(itemName) {
			...
			if(parseFloat(document.getElementById("kpipoint.subtotal_10").value)>10)
			{
				document.getElementById("kpipoint.subtotal_10").value = 10;
			}
			numVali();
		}
  ...
  <tr>
    ...
    <td   bgcolor="#FFFFFF"><input name="kpipoint.number_1" type="text" id="number_1"  size="10" maxlength="10"  value='<s:property value="kpipoint.number_1"/>' readonly="readonly"></td>
    <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.subtotal_1" type="text" id="subtotal_1"  size="10" maxlength="10" class="bgg" value='<s:property value="kpipoint.subtotal_1"/>' readonly="readonly">
    </div></td>
        <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.coeff_1" type="text" id="coeff_1"  size="10" maxlength="10" class="bgg" value='<s:property value="kpipoint.coeff_1"/>' readonly="readonly">
    </div></td>
    <td   bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.remark_1" type="text" id="remark_1" size="44" maxlength="44" value='<s:property value="kpipoint.remark_1"/>' readonly="readonly">
    </div></td>
  ...
  <tr>
    ...
    <td  bgcolor="#FFFFFF"><input name="kpipoint.number_2" type="text" id="number_2"  size="10" maxlength="10"   value='<s:property value="kpipoint.number_2"/>' readonly="readonly"></td>
    ...
    <td   bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.remark_2" type="text" id="remark_2" size="44" maxlength="44" value='<s:property value="kpipoint.remark_2"/>' readonly="readonly">
    </div></td>
  ...
  <tr>
    ...
    <td  bgcolor="#FFFFFF"><input name="kpipoint.number_3" type="text" id="number_3"  size="10" maxlength="10"  value='<s:property value="kpipoint.number_3"/>' readonly="readonly"></td>
    ...
    <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.remark_3" type="text" id="remark_3" size="44" maxlength="44" value='<s:property value="kpipoint.remark_3"/>' readonly="readonly">
    </div></td>
   ...
   <tr>
    ...
    <td  bgcolor="#FFFFFF"><input name="kpipoint.number_31" type="text" id="number_31"  size="10" maxlength="10"  value='<s:property value="kpipoint.number_31"/>' readonly="readonly"></td>
    ...
    <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.remark_31" type="text" id="remark_31" size="44" maxlength="44" value='<s:property value="kpipoint.remark_31"/>' readonly="readonly">
    </div></td>
  ...
  <tr>
    ...
    <td  bgcolor="#FFFFFF"><input name="kpipoint.number_4" type="text" id="number_4"  size="10" maxlength="10"  value='<s:property value="kpipoint.number_4"/>' readonly="readonly"></td>
    <td  bgcolor="#FFFFFF"><div align="center">
    ...
    <td   bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.remark_4" type="text" id="remark_4" size="44" maxlength="44" value='<s:property value="kpipoint.remark_4"/>' readonly="readonly">
    </div></td>
  ...
  <tr>
    ...
    <td  bgcolor="#FFFFFF"><input name="kpipoint.number_5" type="text" id="number_5"  size="10" maxlength="10" value='<s:property value="kpipoint.number_5"/>' readonly="readonly"></td>
    <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.subtotal_5" type="text" id="subtotal_5" size="10"  maxlength="10" class="bgg" value='<s:property value="kpipoint.subtotal_5"/>' readonly="readonly">
    </div></td>
    <td  bgcolor="#FFFFFF"><div align="center">
    ...
    <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.remark_5" type="text" id="remark_5" size="44" maxlength="44" value='<s:property value="kpipoint.remark_5"/>' readonly="readonly">
    </div></td>
  ...
  <tr>
    ...
    <td  bgcolor="#FFFFFF"><input name="kpipoint.number_6" type="text" id="number_6"  size="10" maxlength="10"  value='<s:property value="kpipoint.number_6"/>' readonly="readonly"></td>
    <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.subtotal_6" type="text" id="subtotal_6"  size="10"  maxlength="10" class="bgg" value='<s:property value="kpipoint.subtotal_6"/>' readonly="readonly">
    </div></td>
          <td  bgcolor="#FFFFFF"><div align="center">
    ...
    <td   bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.remark_6" type="text" id="remark_6" size="44" maxlength="44" value='<s:property value="kpipoint.remark_6"/>' readonly="readonly">
    </div></td>
  ...
  <tr>
    ...
    <td  bgcolor="#FFFFFF"><input name="kpipoint.number_7" type="text" id="number_7"  size="10" maxlength="10"  value='<s:property value="kpipoint.number_7"/>' readonly="readonly"></td>
    <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.subtotal_7" type="text" id="subtotal_7"  size="10"  maxlength="10" class="bgg"  value='<s:property value="kpipoint.subtotal_7"/>' readonly="readonly">
    </div></td>
          <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.coeff_7" type="text" id="coeff_7"  size="10" maxlength="10" class="bgg"  value='<s:property value="kpipoint.coeff_7"/>' readonly="readonly">
    </div></td>
    <td   bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.remark_7" type="text" id="remark_7" size="44" maxlength="44" value='<s:property value="kpipoint.remark_7"/>' readonly="readonly">
    </div></td>
  ...
  <tr>
    ...
    <td  bgcolor="#FFFFFF"><input name="kpipoint.number_8" type="text" id="number_8"  size="10" maxlength="10"  value='<s:property value="kpipoint.number_8"/>' readonly="readonly"></td>
    <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.subtotal_8" type="text" id="subtotal_8"  size="10"  maxlength="10" class="bgg" value='<s:property value="kpipoint.subtotal_8"/>' readonly="readonly">
    </div></td>
          <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.coeff_8" type="text" id="coeff_8"  size="10" maxlength="10" class="bgg" value='<s:property value="kpipoint.coeff_8"/>' readonly="readonly">
    </div></td>
    <td   bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.remark_8" type="text" id="remark_8" size="44" maxlength="44" value='<s:property value="kpipoint.remark_8"/>' readonly="readonly">
    </div></td>
  ...
  <tr>
    ...
    <td  bgcolor="#FFFFFF"><input name="kpipoint.number_9" type="text" id="number_9"  size="10" maxlength="10"  value='<s:property value="kpipoint.number_9"/>' readonly="readonly"></td>
    <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.subtotal_9" type="text" id="subtotal_9"  size="10" maxlength="10" class="bgg" value='<s:property value="kpipoint.subtotal_9"/>' readonly="readonly">
    </div></td>
          <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.coeff_9" type="text" id="coeff_9"  size="10" maxlength="10"  class="bgg" value='<s:property value="kpipoint.coeff_9"/>' readonly="readonly">
    </div></td>
    <td   bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.remark_9" type="text" id="remark_9" size="44" maxlength="44" value='<s:property value="kpipoint.remark_9"/>' readonly="readonly">
    </div></td>
  ...
  <tr>
    ...
    <td  bgcolor="#FFFFFF"><input name="kpipoint.number_10" type="text" id="number_10"  size="10" maxlength="10"  value='<s:property value="kpipoint.number_10"/>' readonly="readonly"></td>
    <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.subtotal_10" type="text" id="subtotal_10"  size="10"  maxlength="10" class="bgg" value='<s:property value="kpipoint.subtotal_10"/>' readonly="readonly">
    </div></td>
          <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.coeff_10" type="text" id="coeff_10"  size="10" maxlength="10" class="bgg" value='<s:property value="kpipoint.coeff_10"/>' readonly="readonly">
    </div></td>
    <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.remark_10" type="text" id="remark_10" size="44" maxlength="44" value='<s:property value="kpipoint.remark_10"/>' readonly="readonly">
    </div></td>
  ...
  <tr>
    ...
    <td  bgcolor="#FFFFFF"><input name="kpipoint.number_11" type="text" id="number_11"  size="10" maxlength="10"   value='<s:property value="kpipoint.number_11"/>' readonly="readonly"></td>
    <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.subtotal_11" type="text" id="subtotal_11"  size="10"  maxlength="10" class="bgg"  value='<s:property value="kpipoint.subtotal_11"/>' readonly="readonly">
    </div></td>
          <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.coeff_11" type="text" id="coeff_11"  size="10" maxlength="10" class="bgg"  value='<s:property value="kpipoint.coeff_11"/>' readonly="readonly">
    </div></td>
    <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.remark_11" type="text" id="remark_11" size="44" maxlength="44" value='<s:property value="kpipoint.remark_11"/>' readonly="readonly">
    </div></td>
  ...
  <tr>
    ...
    <td  bgcolor="#FFFFFF"><input name="kpipoint.number_12" type="text" id="number_12"  size="10" maxlength="10"  value='<s:property value="kpipoint.number_12"/>' readonly="readonly"></td>
    <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.subtotal_12" type="text" id="subtotal_12"  size="10"  maxlength="10" class="bgg" value='<s:property value="kpipoint.subtotal_12"/>' readonly="readonly">
    </div></td>
          <td  bgcolor="#FFFFFF"><div align="center">
    ...
    <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.remark_12" type="text" id="remark_12" size="44" maxlength="44" value='<s:property value="kpipoint.remark_12"/>' readonly="readonly">
    </div></td>
  ...
  <tr>
    ...
    <td  bgcolor="#FFFFFF"><input name="kpipoint.number_13" type="text" id="number_13"  size="10" maxlength="10"   value='<s:property value="kpipoint.number_13"/>' readonly="readonly"></td>
    <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.subtotal_13" type="text" id="subtotal_13"  size="10"  maxlength="10" class="bgg" value='<s:property value="kpipoint.subtotal_13"/>' readonly="readonly">
    </div></td>
          <td  bgcolor="#FFFFFF"><div align="center">
    ...
    <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.remark_13" type="text" id="remark_13" size="44" maxlength="44" value='<s:property value="kpipoint.remark_13"/>' readonly="readonly">
    </div></td>
  ...
  <tr>
    ...
    <td  bgcolor="#FFFFFF"><input name="kpipoint.number_14" type="text" id="number_14"  size="10" maxlength="10"   value='<s:property value="kpipoint.number_14"/>' readonly="readonly"></td>
    <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.subtotal_14" type="text" id="subtotal_14" size="10"  maxlength="10" class="bgg"  value='<s:property value="kpipoint.subtotal_14"/>' readonly="readonly">
    </div></td>
          <td  bgcolor="#FFFFFF"><div align="center">
    ...
    <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.remark_14" type="text" id="remark_14" size="44" maxlength="44" value='<s:property value="kpipoint.remark_14"/>' readonly="readonly">
    </div></td>
  ...
  <tr>
    ...
    <td  bgcolor="#FFFFFF"><input name="kpipoint.number_15" type="text" id="number_15"  size="10" maxlength="10"    value='<s:property value="kpipoint.number_15"/>' readonly="readonly"></td>
    <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.subtotal_15" type="text" id="subtotal_15"  size="10"   maxlength="10" class="bgg" value='<s:property value="kpipoint.subtotal_15"/>' readonly="readonly">
    </div></td>
          <td  bgcolor="#FFFFFF"><div align="center">
    ...
    <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.remark_15" type="text" id="remark_15" size="44" maxlength="44" value='<s:property value="kpipoint.remark_15"/>' readonly="readonly">
    </div></td>
  ...
  <tr>
    ...
    <td  bgcolor="#FFFFFF"><input name="kpipoint.number_16" type="text" id="number_16"  size="10" maxlength="10"   value='<s:property value="kpipoint.number_16"/>' readonly="readonly"></td>
    <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.subtotal_16" type="text" id="subtotal_16" size="10"  maxlength="10" class="bgg" value='<s:property value="kpipoint.subtotal_16"/>' readonly="readonly">
    </div></td>
         <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.coeff_16" type="text" id="coeff_16"  size="10" maxlength="10" class="bgg"   value='<s:property value="kpipoint.coeff_16"/>' readonly="readonly">
    </div></td>
    <td bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.remark_16" type="text" id="remark_16" size="44" maxlength="44" value='<s:property value="kpipoint.remark_16"/>' readonly="readonly">
    </div></td>
  ...
  <tr>
    ...
    <td  bgcolor="#FFFFFF"><input name="kpipoint.number_17" type="text" id="number_17"  size="10" maxlength="10"  value='<s:property value="kpipoint.number_17"/>' readonly="readonly"></td>
    <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.subtotal_17" type="text" id="subtotal_17"  size="10"  maxlength="10" class="bgg" value='<s:property value="kpipoint.subtotal_17"/>' readonly="readonly">
    </div></td>
          <td  bgcolor="#FFFFFF"><div align="center">
    ...
    <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.remark_17" type="text" id="remark_17" size="44" maxlength="44" value='<s:property value="kpipoint.remark_17"/>' readonly="readonly">
    </div></td>
  ...
  <tr>
    ...
    <td  bgcolor="#FFFFFF"><input name="kpipoint.number_18" type="text" id="number_18"  size="10" maxlength="10"  value='<s:property value="kpipoint.number_18"/>' readonly="readonly"></td>
    <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.subtotal_18" type="text" id="subtotal_18"  size="10"  maxlength="10" class="bgg" value='<s:property value="kpipoint.subtotal_18"/>' readonly="readonly">
    </div></td>
          <td  bgcolor="#FFFFFF"><div align="center">
    ...
    <td bgcolor="#FFFFFF"><input name="kpipoint.remark_18" type="text" id="remark_18" size="44" maxlength="44" value='<s:property value="kpipoint.remark_18"/>' readonly="readonly"></td>
    <td align="left" bgcolor="#FFFFFF">次数*3分，要有案例分析和改进措施，通过审核，不超过10分，从部门管理平台获取</td>
  </tr>
  <tr>
    <td bgcolor="#FFFFFF"><div align="center">20</div></td>
    <td   bgcolor="#FFFFFF"><div align="left">平台被表扬/赞赏次数</div></td>
    <td  bgcolor="#FFFFFF"><input name="kpipoint.number_19" type="text" id="number_19"  size="10" maxlength="10"  value='<s:property value="kpipoint.number_19"/>' readonly="readonly"></td>
    <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.subtotal_19" type="text" id="subtotal_19"  size="10" maxlength="10" class="bgg" value='<s:property value="kpipoint.subtotal_19"/>' readonly="readonly">
    </div></td>
          <td  bgcolor="#FFFFFF"><div align="center">
    ...
    <td bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.remark_19" type="text" id="remark_19" size="44" maxlength="44" value='<s:property value="kpipoint.remark_19"/>' readonly="readonly">
    </div></td>
   ...
   <tr>
    ...
    <td  bgcolor="#FFFFFF"><input name="kpipoint.number_33" type="text" id="number_33"  size="10" maxlength="10"   value='<s:property value="kpipoint.number_33"/>' readonly="readonly"></td>
    <td  bgcolor="#FFFFFF"><div align="center">
    ...
    <td bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.remark_33" type="text" id="remark_33" size="44" maxlength="44" value='<s:property value="kpipoint.remark_33"/>'  readonly="readonly">
    </div></td>
   ...
   <tr>
    ...
    <td  bgcolor="#FFFFFF"><input name="kpipoint.number_34" type="text" id="number_34"  size="10" maxlength="10"  value='<s:property value="kpipoint.number_34"/>' readonly="readonly"></td>
    <td  bgcolor="#FFFFFF"><div align="center">
    ...
    <td bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.remark_34" type="text" id="remark_34" size="44" maxlength="44" value='<s:property value="kpipoint.remark_34"/>'  readonly="readonly">
    </div></td>
  ...
  <tr>
    ...
    <td  bgcolor="#FFFFFF"><input name="kpipoint.number_20" type="text" id="number_20"  size="10" maxlength="10"   value='<s:property value="kpipoint.number_20"/>' readonly="readonly"></td>
    <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.subtotal_20" type="text" id="subtotal_20"  size="10"  maxlength="10"  class="bgg" value='<s:property value="kpipoint.subtotal_20"/>' readonly="readonly">
    </div></td>
          <td  bgcolor="#FFFFFF"><div align="center">
    ...
    <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.remark_20" type="text" id="remark_20" size="44" maxlength="44" value='<s:property value="kpipoint.remark_20"/>' readonly="readonly">
    </div></td>
  ...
  <tr>
    ...
    <td  bgcolor="#FFFFFF"><input name="kpipoint.number_21" type="text" id="number_21"  size="10" maxlength="10"  value='<s:property value="kpipoint.number_21"/>' readonly="readonly"></td>
    <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.subtotal_21" type="text" id="subtotal_21"  size="10"  maxlength="10" class="bgg" value='<s:property value="kpipoint.subtotal_21"/>' readonly="readonly">
    </div></td>
          <td  bgcolor="#FFFFFF"><div align="center">
    ...
    <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.remark_21" type="text" id="remark_21" size="44" maxlength="44" value='<s:property value="kpipoint.remark_21"/>' readonly="readonly">
    </div></td>
  ...
  <tr>
    ...
    <td  bgcolor="#FFFFFF"><input name="kpipoint.number_22" type="text" id="number_22"  size="10" maxlength="10"  value='<s:property value="kpipoint.number_22"/>' readonly="readonly"></td>
    <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.subtotal_22" type="text" id="subtotal_22"  size="10" maxlength="10" class="bgg" value='<s:property value="kpipoint.subtotal_22"/>' readonly="readonly">
    </div></td>
          <td  bgcolor="#FFFFFF"><div align="center">
    ...
    <td bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.remark_22" type="text" id="remark_22" size="44" maxlength="44" value='<s:property value="kpipoint.remark_22"/>' readonly="readonly">
    </div></td>
  ...
  <tr>
    ...
    <td  bgcolor="#FFFFFF"><input name="kpipoint.number_23" type="text" id="number_23"  size="10" maxlength="10"  value='<s:property value="kpipoint.number_23"/>' readonly="readonly"></td>
    <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.subtotal_23" type="text" id="subtotal_23" size="10"  maxlength="10" class="bgg" value='<s:property value="kpipoint.subtotal_23"/>' readonly="readonly">
    </div></td>
          <td  bgcolor="#FFFFFF"><div align="center">
    ...
    <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.remark_23" type="text" id="remark_23" size="44" maxlength="44" value='<s:property value="kpipoint.remark_23"/>' readonly="readonly">
    </div></td>
  ...
  <tr>
    ...
    <td  bgcolor="#FFFFFF"><input name="kpipoint.number_24" type="text" id="number_24"  size="10" maxlength="10"   value='<s:property value="kpipoint.number_24"/>' readonly="readonly"></td>
    <td  bgcolor="#FFFFFF"><div align="center"><font color="#FF0000">
      <input name="kpipoint.subtotal_24" type="text" id="subtotal_24"  size="10"  maxlength="10" class="bgg"  value='<s:property value="kpipoint.subtotal_24"/>' readonly="readonly"></font>
    </div></td>
          <td  bgcolor="#FFFFFF"><div align="center">
    ...
    <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.remark_24" type="text" id="remark_24" size="44" maxlength="44" value='<s:property value="kpipoint.remark_24"/>' readonly="readonly">
    </div></td>
  ...
  <tr>
    ...
    <td  bgcolor="#FFFFFF"><input name="kpipoint.number_25" type="text" id="number_25"  size="10" maxlength="10"  value='<s:property value="kpipoint.number_25"/>' readonly="readonly"></td>
    <td  bgcolor="#FFFFFF"><div align="center"><font color="#FF0000">
      <input name="kpipoint.subtotal_25" type="text" id="subtotal_25"  size="10"  maxlength="10" class="bgg" value='<s:property value="kpipoint.subtotal_25"/>' readonly="readonly"></font>
    </div></td>
          <td  bgcolor="#FFFFFF"><div align="center">
    ...
    <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.remark_25" type="text" id="remark_25" size="44" maxlength="44" value='<s:property value="kpipoint.remark_25"/>' readonly="readonly">
    </div></td>
  ...
  <tr>
    ...
    <td  bgcolor="#FFFFFF"><input name="kpipoint.number_26" type="text" id="number_26"  size="10" maxlength="10" value='<s:property value="kpipoint.number_26"/>' readonly="readonly"></td>
    <td  bgcolor="#FFFFFF"><div align="center"><font color="#FF0000">
      <input name="kpipoint.subtotal_26" type="text" id="subtotal_26"size="10"  maxlength="10" class="bgg" value='<s:property value="kpipoint.subtotal_26"/>' readonly="readonly"></font>
    </div></td>
          <td  bgcolor="#FFFFFF"><div align="center">
    ...
    <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.remark_26" type="text" id="remark_26" size="44" maxlength="44" value='<s:property value="kpipoint.remark_26"/>' readonly="readonly">
    </div></td>
  ...
  <tr>
    ...
    <td  bgcolor="#FFFFFF"><input name="kpipoint.number_27" type="text" id="number_27"  size="10" maxlength="10"  value='<s:property value="kpipoint.number_27"/>' readonly="readonly"></td>
    <td  bgcolor="#FFFFFF"><div align="center"><font color="#FF0000">
      <input name="kpipoint.subtotal_27" type="text" id="subtotal_27"  size="10"  maxlength="10" class="bgg" value='<s:property value="kpipoint.subtotal_27"/>' readonly="readonly"></font>
    </div></td>
          <td  bgcolor="#FFFFFF"><div align="center">
    ...
    <td   bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.remark_27" type="text" id="remark_27" size="44" maxlength="44" value='<s:property value="kpipoint.remark_27"/>' readonly="readonly">
    </div></td>
    ...
    <td  bgcolor="#FFFFFF"><input name="kpipoint.number_32" type="text" id="number_32"  size="10" maxlength="10"  value='<s:property value="kpipoint.number_32"/>' readonly="readonly"></td>
    <td  bgcolor="#FFFFFF"><div align="center"><font color="#FF0000">
      <input name="kpipoint.subtotal_32" type="text" id="subtotal_32"  size="10"  maxlength="10" class="bgg" value='<s:property value="kpipoint.subtotal_32"/>' readonly="readonly"></font>
    </div></td>
    <td  bgcolor="#FFFFFF"><div align="center">
    ...
    <td   bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.remark_32" type="text" id="remark_32" size="44" maxlength="44" value='<s:property value="kpipoint.remark_32"/>' readonly="readonly">
    </div></td>
    <td align="left" bgcolor="#FFFFFF">次数*1分，从OA或邮件获取</td>
  </tr>
  
  <tr>
    <td bgcolor="#FFFFFF"><div align="center">32</div></td>
    <td   bgcolor="#FFFFFF"><div align="left">被通报批评次数</div></td>
    <td  bgcolor="#FFFFFF"><input name="kpipoint.number_28" type="text" id="number_28"  size="10" maxlength="10"  value='<s:property value="kpipoint.number_28"/>' readonly="readonly"></td>
    <td  bgcolor="#FFFFFF"><div align="center"><font color="#FF0000">
      <input name="kpipoint.subtotal_28" type="text" id="subtotal_28"  size="10"  maxlength="10" class="bgg" value='<s:property value="kpipoint.subtotal_28"/>' readonly="readonly"></font>
    </div></td>
    <td  bgcolor="#FFFFFF"><div align="center">
    ...
    <td   bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.remark_28" type="text" id="remark_28" size="44" maxlength="44" value='<s:property value="kpipoint.remark_28"/>' readonly="readonly">
    </div></td>
  ...
  <tr>
    ...
    <td  bgcolor="#FFFFFF"><input name="kpipoint.number_29" type="text" id="number_29"  size="10" maxlength="10"  value='<s:property value="kpipoint.number_29"/>' readonly="readonly"></td>
    <td  bgcolor="#FFFFFF"><div align="center"><font color="#FF0000">
    ...
    <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.remark_29" type="text" id="remark_29" size="44" maxlength="44" value='<s:property value="kpipoint.remark_29"/>' readonly="readonly">
    </div></td>
    ...
    <td  bgcolor="#FFFFFF"><input name="kpipoint.number_30" type="text" id="number_30"  size="10" maxlength="10"  value='<s:property value="kpipoint.number_30"/>' readonly="readonly"></td>
    <td  bgcolor="#FFFFFF"><div align="center"><font color="#FF0000">
    ...
    <td  bgcolor="#FFFFFF"><div align="center">
      <input name="kpipoint.remark_30" type="text" id="remark_30" size="44" maxlength="44" value='<s:property value="kpipoint.remark_30"/>' readonly="readonly">
    </div></td>
    ...
    <td  bgcolor="#FFFFFF"><input name="kpipoint.number_35" type="text" id="number_35"  size="10" maxlength="10"   value='<s:property value="kpipoint.number_35"/>' readonly="readonly"></td>
    <td  bgcolor="#FFFFFF"><div align="center"><font color="#FF0000">
    ...
    <td colspan="7"  bgcolor="#FFFFFF"><div align="left">
      <input name="remark" type="text" id="remark" size="172" maxlength="200" value='<s:property value="kpipoint.remark"/>' readonly="readonly">
    </div>
