...
<!--
   	...
   	-->
  <input name="postremove.name" type="text" id="name" size="10" class="bgg" maxlength="100" value='<s:property value="createMan"/>' readonly="readonly">
    	</label></td>
    <td width="10%" align="center"  bgcolor="#999999"><div align="center">提出日期<font color="#FF0000">*</font></div></td>
    <td width="15%" bgcolor="#FFFFFF">
<label>
<input name="postremove.advencedate" type="text" id="advencedate" size="14" maxlength="100" class="MyInput" issel="true" isdate="true" onFocus="ShowDate(this)" dofun="ShowDate(this)" value='<s:date name="new java.util.Date()" format="yyyy-MM-dd"/>'>
</label></td>
                     <td width="10%" align="center"  bgcolor="#999999"><div align="center">轮岗部门<font color="#FF0000">*</font></div></td>
                    <td width="15%" bgcolor="#FFFFFF">
                      <input name="postremove.groupname" type="text" id="groupname" size="18" maxlength="100"></td>
<td align="center" width="10%" bgcolor="#999999"><div align="center">轮岗领域<font color="#FF0000">*</font></div></td>
                    <td width="15%" bgcolor="#FFFFFF">
                      <input name="postremove.domain" type="text" id="domain" size="18" maxlength="100"></td>
                  </tr> 
                  <tr> 
<td  align="center" bgcolor="#999999">轮岗计划时长<font color="#FF0000">*</font></td>
<td  bgcolor="#FFFFFF">
              <input name="postremove.plantotaltime" type="text" id="plantotaltime" size="4" maxlength="100">
              个月</td>  
...
<!--
   		     <input name="meeting.currentDateTime" type="text" id="currentDateTime" size="15" />
   	-->
<input name="postremove.planstartdate" type="text" id="planstartdate" size="14" maxlength="100" class="MyInput" issel="true" isdate="true" onFocus="ShowDate(this)" dofun="ShowDate(this)">
</label></td>
                    <td   bgcolor="#999999"><div align="center">计划结束日期<font color="#FF0000">*</font></div></td>
    <td colspan="3" bgcolor="#FFFFFF">
<label>
<!--
   		     <input name="meeting.currentDateTime" type="text" id="currentDateTime" size="15" />
   	-->
<input name="postremove.planfinishdate" type="text" id="planfinishdate" size="14" maxlength="100" class="MyInput" issel="true" isdate="true" onFocus="ShowDate(this)" dofun="ShowDate(this)">
</label></td>
                  </tr>
                  <tr>
                  	  <td align="center"  width="13%" bgcolor="#999999"><div align="center">轮岗目标<font color="#FF0000">*</font></div></td> 
					<td colspan="7" bgcolor="#FFFFFF"> <textarea name="postremove.wishgut" id="wishgut" cols="88" rows="5" ></textarea></td>
                  </tr>
                    <tr> 
<td  align="center" bgcolor="#999999">轮岗实际时长</td>
<td  bgcolor="#FFFFFF">
              <input name="postremove.endtotaltime" type="text" id="endtotaltime" size="4" maxlength="100" readonly="readonly" class="bgg">
              个月</td>  
...
<!--
   		     <input name="meeting.currentDateTime" type="text" id="currentDateTime" size="15" />
   	-->
<input name="postremove.endstartdate" type="text" id="endstartdate" size="14" maxlength="100" class="bgg"  readonly="readonly">
</label></td>
...
<!--
   		     <input name="meeting.currentDateTime" type="text" id="currentDateTime" size="15" />
   	-->
<input name="postremove.endfinishdate" type="text" id="endfinishdate" size="14" maxlength="100" class="bgg"  readonly="readonly">
</label></td>
<td align="center"  bgcolor="#999999"><div align="center">状态</div></td>
                    <td  bgcolor="#FFFFFF">
                      <input name="postremove.status" type="text" id="status" size="18" maxlength="100" class="bgg" value='未提交' readonly="readonly"></td>
                  </tr>
                  <tr>
                  	  <td align="center"  width="13%" bgcolor="#999999"><div align="center">自评</div></td> 
					<td colspan="7" bgcolor="#FFFFFF"> <textarea name="postremove.selfscore" id="selfscore" cols="88" rows="5" class="bgg" readonly></textarea></td>
                  </tr>
                                    <tr>
                  	  <td align="center"  width="13%" bgcolor="#999999"><div align="center">上级评价</div></td> 
					<td colspan="7" bgcolor="#FFFFFF">
                  	  <textarea name="postremove.headmanscore" id="headmanscore" cols="88" rows="5" class="bgg" readonly></textarea></td>
                  </tr>
                  <tr>
                  	  <td align="center"  width="13%" bgcolor="#999999"><div align="center">上上级评价</div></td> 
					  <td colspan="7" bgcolor="#FFFFFF"><textarea name="postremove.managescore" id="managescore" cols="88" rows="5" class="bgg" readonly></textarea></td>
                  </tr>
                    </table>
                </fieldset>
                </td> 
