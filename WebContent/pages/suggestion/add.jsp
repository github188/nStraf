...
<html>
	...
	<body id="bodyid" leftmargin="0" topmargin="10">
		<form name="reportInfoForm"
			action="<%=request.getContextPath()%>/pages/suggestion/suggestioninfo!save.action"
			method="post">
...
<div align="center">
								  ...
								  <input name="suggestion.raise_man" type="text" id="raise_man"
											maxlength="20" size="20" value='<s:property value="raiseMan"/>'>									</td>
							...
							<tr>
								<td width="13%" align="center" bgcolor="#999999">
									...
									评估意见							</td>
						      <td  bgcolor="#FFFFFF" colspan="5">
							<textarea name="suggestion.mamager_sugggestion" cols="74" rows="3" disabled class="bgg"
								id="mamager_sugggestion" ></textarea>							</td>
							</tr>
							...
							<td width="27%" bgcolor="#FFFFFF">
							  <input name="suggestion.finishing_date" type="text" disabled class="bgg"
									id="finishing_date" 
...
<s:if test="flag.equals('0')"></s:if>
										<s:else>
											<input name="suggestion.resolve_man" type="text" disabled class="bgg"
												id="resolve_man" value='' size="20" maxlength="20">
								  </s:else>									</td>
									
								  <td width="11%" bgcolor="#999999"><div align="center"> 价值分</div></td>
								  <td bgcolor="#FFFFFF"><select name="suggestion.price_score" disabled class="bgg" id="price_score" style="width:78px"
											align="left">
                                    <option value='' selected="true"></option>
								...
								<tr>
									<td align="center" bgcolor="#999999">
										解决措施									</td>
									<td bgcolor="#FFFFFF" colspan="5">
										<textarea name="suggestion.solution" cols="74" rows="3" disabled class="bgg"
											id="solution" ></textarea>									</td>
								</tr>
				   	  ...
				   	  <td bgcolor="#FFFFFF"  colspan="3">
								  		<input name="suggestion.pratical_date" type="text" disabled class="bgg"
											id="pratical_date" 	value='<s:date name="suggestion.pratical_date" format="yyyy-MM-dd"/>'>									
                                  </td>
							  ...
							  <td  bgcolor="#FFFFFF"   >
                                    <select name="suggestion.effect_score" disabled class="bgg" id="effect_score"  style="width:78px"
                                    align="left"> 
                                    <option value='' selected="true"></option>
                                    <option value='5'>
                                        5											</option>
	    ...
	    <div align="center">
								  效果评价</div>									</td>
<td bgcolor="#FFFFFF" colspan="5" >
										<textarea name="suggestion.public_evaluation" cols="74" rows="5" disabled class="bgg" id="public_evaluation" ></textarea>									</td>
								</tr>
							</table>
					  </fieldset>
					</td>
				...
				<tr>
					<td align="center"><input type="button" name="ok" id="ok"
					  ...
					  <input type="button" name="return"
							...
							onclick="closeModal();" image="../../images/share/f_closed.gif">					</td>
				</tr>
			</table>
	</form>
	</body>
