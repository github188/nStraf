...
<fieldset class="jui_fieldset" width="90%">
		  ...
		  <div align="center">
								  ...
								  <input name="suggestion.raise_date" type="text" class="bgg"
											id="raise_date"
...
<div align="center">
									...
									<td bgcolor="#FFFFFF" colspan="5">
										<div >
										  <textarea cols="74" rows="3" name="suggestion.description"
												id="description"  ><s:property value="suggestion.description"/>
										  </textarea>
										</div>																				
                                        <script language="javascript">
                                         if(document.getElementById("usernameHidden").value != document.getElementById("raise_man").value)
										 {
										 	document.getElementById("description").readOnly = true;
											document.getElementById("description").style.backgroundColor='#999999';
										 }
                                        </script></td>
								</tr>
								...
								<tr>
									...
									<td bgcolor="#FFFFFF" colspan="5"><textarea cols="74" rows="3" name="suggestion.giving_solution" 
											id="solution"><s:property value="suggestion.giving_solution"/>
									</textarea></td>
							</tr>
							<tr>
								<td width="13%" align="center" bgcolor="#999999">
									...
									评估意见							</td>
						      <td  bgcolor="#FFFFFF" colspan="5"><textarea name="suggestion.mamager_sugggestion" cols="74" rows="3" readonly class="bgg"
								id="mamager_sugggestion" ><s:property value="suggestion.mamager_sugggestion"/>
						      </textarea></td>
							</tr>
							...
							<td width="27%" bgcolor="#FFFFFF">
							  <input name="suggestion.finishing_date" type="text" class="bgg"
									id="finishing_date" 
									value='<s:date name="suggestion.finishing_date" format="yyyy-MM-dd"/>' readonly>							</td>
...
<div align="center" >
							  ...
							  <td width="26%" bgcolor="#FFFFFF">
								...
								<s:else>
											<input name="suggestion.resolve_man" type="text" class="bgg"
												id="resolve_man" value='<s:property value="suggestion.resolve_man"/>' size="20" maxlength="20" readonly> 
								  </s:else>									</td>
									
								  <td width="11%" bgcolor="#999999"><div align="center"> 价值分</div></td>
								  <td bgcolor="#FFFFFF"><select name="price_score11" disabled id="price_score" style="width:78px"
											align="left">
                                    <option value='' selected="true"></option>
                                  ...
                                  <input type="hidden" name="suggestion.price_score" value="<s:property value='suggestion.price_score'/>"/>
								...
								<tr>
									...
									<td bgcolor="#FFFFFF" colspan="5">
										<textarea cols="74" rows="3" name="suggestion.solution"
											id="solution"  ><s:property value="suggestion.solution"/></textarea>									</td>
								</tr>
				   	  ...
				   	  <td bgcolor="#FFFFFF"  colspan="3">
								  		<input name="suggestion.pratical_date" type="text"
											id="pratical_date" class="MyInput" 
							  ...
							  <td align="center" bgcolor="#999999">
  									<div align="center">
											效果分                                    </div>                              </td>
							  <td  bgcolor="#FFFFFF"   >
                                    <select name="effect_score11"  disabled id="effect_score"  style="width:78px"
                                    align="left"> 
                                    <option value='' selected="true"></option>
                                    <option value='5'>
                                        5											</option>
                                    ...
                                    <option value='1'>
                                     ...
                                     <input type="hidden" name="suggestion.effect_score" value="<s:property value='suggestion.effect_score'/>"/>		
