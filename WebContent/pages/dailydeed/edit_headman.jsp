...
-->
	...
	String.prototype.trim = function()
	{
		...
		function numClear(itemName){
			...
			document.getElementById("dailydeed.subtotal_d").value = 0;
			document.getElementById("dailydeed.subtotal_s").value = 0;
			ret1 = (parseFloat(document.getElementById("dailydeed.subtotal_d_1").value)*40/10 + parseFloat(document.getElementById("dailydeed.subtotal_d_2").value)*50/10+ parseFloat(document.getElementById("dailydeed.subtotal_d_3").value)*40/10 + parseFloat(document.getElementById("dailydeed.subtotal_d_4").value)*30/10 + parseFloat(document.getElementById("dailydeed.subtotal_d_5").value)*30/10 + parseFloat(document.getElementById("dailydeed.subtotal_d_6").value)*30/10 + parseFloat(document.getElementById("dailydeed.subtotal_d_7").value)*20/10 + parseFloat(document.getElementById("dailydeed.subtotal_d_8").value))*10/10;
			document.getElementById("dailydeed.subtotal_d").value = ret1.toFixed(1);	
			document.getElementById("dailydeed.subtotal_d").value =document.getElementById("dailydeed.subtotal_d").value.replace(/(\.\d)\d+/ig,"$1");
            ...
            itemName.value = itemName.value.replace(/(\.\d)\d+/ig,"$1");
			ret = (parseFloat(document.getElementById("dailydeed.subtotal_d_4").value)*6/10+parseFloat(document.getElementById("dailydeed.subtotal_m_4").value)*4/10)*30/10;
        ...
        <br/>
              ...
              <tr>
               <td width="6%" bgcolor="#FFFFFF"><div align="center">1</div></td>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">
                  <input name="dailydeed.subtotal_d_1" type="text" id="subtotal_d_1"  size="8" maxlength="10"  onChange="numVali_1(this)" onBlur="numVali_1(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="dailydeed.subtotal_d_1"/>' >
                </div></td>
                         <td  bgcolor="#FFFFFF"><div align="center"><textarea cols="16" rows="12"  name="dailydeed.remark_d_1"
												id="remark_d_1" ><s:property value="dailydeed.remark_d_1"/></textarea>
                      </div></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
               ...
               <td width="6%" bgcolor="#FFFFFF"><div align="center">2</div></td>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="dailydeed.subtotal_d_2" type="text" id="subtotal_d_2"  size="8" maxlength="10"  onChange="numVali_2(this)" onBlur="numVali_2(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="dailydeed.subtotal_d_2"/>'>
                      </div></td>
                         <td  bgcolor="#FFFFFF"><div align="center"><textarea cols="16" rows="13"  name="dailydeed.remark_d_2"
												id="remark_d_2"><s:property value="dailydeed.remark_d_2"/></textarea>
                      </div></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
              ...
              <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="dailydeed.subtotal_d_3" type="text" id="subtotal_d_3"  size="8" maxlength="10"  onChange="numVali_3(this)" onBlur="numVali_3(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="dailydeed.subtotal_d_3"/>' >
                      </div></td>
                         <td  bgcolor="#FFFFFF"><textarea cols="16" rows="12"  name="dailydeed.remark_d_3"
												id="dailydeed.remark_d_3"><s:property value="dailydeed.remark_d_3"/></textarea></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
                ...
                <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="dailydeed.subtotal_d_4" type="text" id="subtotal_d_4" size="8" maxlength="10"  onChange="numVali_4(this)" onBlur="numVali_4(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="dailydeed.subtotal_d_4"/>'>
                      </div></td>
                         <td  bgcolor="#FFFFFF"><div align="center"><textarea cols="16" rows="10" name="dailydeed.remark_d_4"
												id="dailydeed.remark_d_4"><s:property value="dailydeed.remark_d_4"/></textarea>
                      </div></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
              ...
              <td width="6%" bgcolor="#FFFFFF"><div align="center">5</div></td>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="dailydeed.subtotal_d_5" type="text" id="subtotal_d_5" size="8" maxlength="10"  onChange="numVali_5(this)" onBlur="numVali_5(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="dailydeed.subtotal_d_5"/>'>
                      </div></td>
                         <td  bgcolor="#FFFFFF"><textarea cols="16" rows="10" name="dailydeed.remark_d_5"
												id="dailydeed.remark_d_5"><s:property value="dailydeed.remark_d_5"/></textarea></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
               ...
               <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="dailydeed.subtotal_d_6" type="text" id="subtotal_d_6"  size="8" maxlength="10"  onChange="numVali_6(this)" onBlur="numVali_6(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="dailydeed.subtotal_d_6"/>' >
                      </div></td>
                         <td  bgcolor="#FFFFFF"><textarea cols="16" rows="15"  name="dailydeed.remark_d_6"
												id="dailydeed.remark_d_6" ><s:property value="dailydeed.remark_d_6"/></textarea></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
             ...
             <td width="6%" bgcolor="#FFFFFF"><div align="center">7</div></td>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="dailydeed.subtotal_d_7" type="text" id="subtotal_d_7"  size="8" maxlength="10"  onChange="numVali_7(this)" onBlur="numVali_7(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="dailydeed.subtotal_d_7"/>' >
                      </div></td>
                         <td  bgcolor="#FFFFFF"><textarea cols="16" rows="10"  name="dailydeed.remark_d_7"
												id="dailydeed.remark_d_7"><s:property value="dailydeed.remark_d_7"/></textarea></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
               ...
               <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="dailydeed.subtotal_d_8" type="text" id="subtotal_d_8"  size="8" maxlength="10"  onChange="numVali_8(this)" onBlur="numVali_8(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="dailydeed.subtotal_d_8"/>'>
                      </div></td>
                         <td  bgcolor="#FFFFFF"><textarea cols="16" rows="8"  name="dailydeed.remark_d_8"
												id="dailydeed.remark_d_8" ><s:property value="dailydeed.remark_d_8"/></textarea></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
