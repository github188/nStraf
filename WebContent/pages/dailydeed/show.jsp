...
-->
        ...
        <br/>
              ...
              <tr>
                ...
                <td bgcolor="#FFFFFF"><div align="center">
                  <input name="dailydeed.subtotal_z_1" type="text" id="subtotal_z_1"  size="8" maxlength="11" value='<s:property value="dailydeed.subtotal_z_1"/>' readonly="readonly">
                </div></td>
                         <td  bgcolor="#FFFFFF"><div align="center">
                           <textarea cols="16" rows="12" name="dailydeed.remark_z_1" 
												id="remark_z_1" readonly><s:property value="dailydeed.remark_z_1"/></textarea>
                         </div></td>
                <td  bgcolor="#FFFFFF"><div align="center">
                  <input name="dailydeed.subtotal_d_1" type="text" id="subtotal_d_1"  size="8" maxlength="10"  value='<s:property value="dailydeed.subtotal_d_1"/>' readonly="readonly">
                </div></td>
                         <td  bgcolor="#FFFFFF"><div align="center"><textarea cols="16" rows="12"  name="dailydeed.remark_d_1"
												id="remark_d_1" readonly><s:property value="dailydeed.remark_d_1"/></textarea>
                      </div></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="dailydeed.subtotal_m_1" type="text" id="subtotal_m_1"  size="8" maxlength="10" value='<s:property value="dailydeed.subtotal_m_1"/>' readonly="readonly">
                      </div></td>
                       <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="dailydeed.subtotal_s_1" type="text" id="subtotal_s_1" size="8" maxlength="12" value='<s:property value="dailydeed.subtotal_s_1"/>' readonly="readonly">
                      </div></td>
              </tr>    
                 <tr>
                ...
                <td bgcolor="#FFFFFF"><div align="center">
                        <input name="dailydeed.subtotal_z_2" type="text" id="subtotal_z_2"  size="8" maxlength="10"  value='<s:property value="dailydeed.subtotal_z_2"/>' readonly="readonly">
                      </div></td>
                         <td  bgcolor="#FFFFFF"><div align="center"><textarea cols="16" rows="13"  name="dailydeed.remark_z_2"
												id="remark_z_2" readonly><s:property value="dailydeed.remark_z_2"/></textarea></td>
                <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="dailydeed.subtotal_d_2" type="text" id="subtotal_d_2"  size="8" maxlength="10"  value='<s:property value="dailydeed.subtotal_d_2"/>' readonly="readonly">
                      </div></td>
                         <td  bgcolor="#FFFFFF"><div align="center"><textarea cols="16" rows="13"  name="dailydeed.remark_d_2"
												id="remark_d_2" readonly><s:property value="dailydeed.remark_d_2"/></textarea>
                      </div></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="dailydeed.subtotal_m_2" type="text" id="subtotal_m_2" size="8" maxlength="10"  value='<s:property value="dailydeed.subtotal_m_2"/>' readonly="readonly">
                      </div></td>
                       <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="dailydeed.subtotal_s_2" type="text" id="subtotal_s_2"  size="8" maxlength="12" value='<s:property value="dailydeed.subtotal_s_2"/>' readonly="readonly">
                      </div></td>
              </tr> 
              ...
              <tr>
                ...
                <td bgcolor="#FFFFFF"><div align="center">4</div></td>
                <td bgcolor="#FFFFFF"><div align="center">
                  <input name="dailydeed.subtotal_z_3" type="text" id="subtotal_z_3"  size="8" maxlength="10"  value='<s:property value="dailydeed.subtotal_z_3"/>' readonly="readonly">
                </div></td>
                         <td  bgcolor="#FFFFFF"><div align="center">
                           <textarea cols="16" rows="12"  name="dailydeed.remark_z_3"
												id="dailydeed.remark_z_3" readonly><s:property value="dailydeed.remark_z_3"/></textarea>
                         </div></td>
                <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="dailydeed.subtotal_d_3" type="text" id="subtotal_d_3"  size="8" maxlength="10"  value='<s:property value="dailydeed.subtotal_d_3"/>' readonly="readonly">
                      </div></td>
                         <td  bgcolor="#FFFFFF"><textarea cols="16" rows="12"  name="dailydeed.remark_d_3"
												id="dailydeed.remark_d_3"  readonly><s:property value="dailydeed.remark_d_3"/></textarea></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="dailydeed.subtotal_m_3" type="text" id="subtotal_m_3"  size="8" maxlength="10"   value='<s:property value="dailydeed.subtotal_m_3"/>' readonly="readonly">
                      </div></td>
                       <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="dailydeed.subtotal_s_3" type="text" id="subtotal_s_3" size="8" maxlength="12" value='<s:property value="dailydeed.subtotal_s_3"/>' readonly="readonly">
                      </div></td>                  
              </tr> 
             ...
             <td width="6%" bgcolor="#FFFFFF"><div align="center">4</div></td>
                ...
                <td bgcolor="#FFFFFF"><div align="center">
                        <input name="dailydeed.subtotal_z_4" type="text" id="subtotal_z_4"  size="8" maxlength="10"  value='<s:property value="dailydeed.subtotal_z_4"/>' readonly="readonly">
                      </div></td>
                         <td  bgcolor="#FFFFFF"><div align="center"><textarea cols="16" rows="10"  name="dailydeed.remark_z_4"
												id="dailydeed.remark_z_4" readonly><s:property value="dailydeed.remark_z_4"/></textarea>
                      </div></td>
                <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="dailydeed.subtotal_d_4" type="text" id="subtotal_d_4" size="8" maxlength="10"   value='<s:property value="dailydeed.subtotal_d_4"/>' readonly="readonly">
                      </div></td>
                         <td  bgcolor="#FFFFFF"><div align="center"><textarea cols="16" rows="10" name="dailydeed.remark_d_4"
												id="dailydeed.remark_d_4" readonly><s:property value="dailydeed.remark_d_4"/></textarea>
                      </div></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="dailydeed.subtotal_m_4" type="text" id="subtotal_m_4"  size="8" maxlength="10"  value='<s:property value="dailydeed.subtotal_m_4"/>' readonly="readonly">
                      </div></td>
                       <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="dailydeed.subtotal_s_4" type="text" id="subtotal_s_4"  size="8" maxlength="12" value='<s:property value="dailydeed.subtotal_s_4"/>' readonly="readonly">
                      </div></td>                  
              </tr> 
               ...
               <tr>
                ...
                <td bgcolor="#FFFFFF"><div align="center">3</div></td>
                <td bgcolor="#FFFFFF"><div align="center">
                        <input name="dailydeed.subtotal_z_5" type="text" id="subtotal_z_5"  size="8" maxlength="10"  value='<s:property value="dailydeed.subtotal_z_5"/>'  readonly="readonly">
                      </div></td>
                         <td  bgcolor="#FFFFFF"><textarea cols="16" rows="10"  name="dailydeed.remark_z_5"
												id="dailydeed.remark_z_5"readonly><s:property value="dailydeed.remark_z_5"/></textarea></td>
                <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="dailydeed.subtotal_d_5" type="text" id="subtotal_d_5" size="8" maxlength="10"   value='<s:property value="dailydeed.subtotal_d_5"/>' readonly="readonly">
                      </div></td>
                         <td  bgcolor="#FFFFFF"><textarea cols="16" rows="10"  name="dailydeed.remark_d_5"
							id="dailydeed.remark_d_5" readonly><s:property value="dailydeed.remark_d_5"/></textarea></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="dailydeed.subtotal_m_5" type="text" id="subtotal_m_5"  size="8" maxlength="10"  value='<s:property value="dailydeed.subtotal_m_5"/>' readonly="readonly">
                      </div></td>
                       <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="dailydeed.subtotal_s_5" type="text" id="subtotal_s_5"  size="8" maxlength="12" value='<s:property value="dailydeed.subtotal_s_5"/>' readonly="readonly">
                      </div></td>                  
              </tr> 
               <tr>
                ...
                <td bgcolor="#FFFFFF"><div align="center">3</div></td>
                <td bgcolor="#FFFFFF"><div align="center">
                        <input name="dailydeed.subtotal_z_6" type="text" id="subtotal_z_6"  size="8" maxlength="10"  value='<s:property value="dailydeed.subtotal_z_6"/>' readonly="readonly">
                      </div></td>
                         <td  bgcolor="#FFFFFF"><textarea cols="16" rows="15" name="dailydeed.remark_z_6"
												id="dailydeed.remark_z_6" readonly><s:property value="dailydeed.remark_z_6"/></textarea></td>
                <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="dailydeed.subtotal_d_6" type="text" id="subtotal_d_6"  size="8" maxlength="10"   value='<s:property value="dailydeed.subtotal_d_6"/>' readonly="readonly">
                      </div></td>
                         <td  bgcolor="#FFFFFF"><textarea cols="16" rows="15"  name="dailydeed.remark_d_6"  
												id="dailydeed.remark_d_6" readonly><s:property value="dailydeed.remark_d_6"/></textarea></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="dailydeed.subtotal_m_6" type="text" id="subtotal_m_6"  size="8" maxlength="10" value='<s:property value="dailydeed.subtotal_m_6"/>' readonly="readonly">
                      </div></td>
                       <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="dailydeed.subtotal_s_6" type="text" id="subtotal_s_6"  size="8" maxlength="12" value='<s:property value="dailydeed.subtotal_s_6"/>' readonly="readonly">
                      </div></td>                  
              </tr> 
              ...
              <td width="6%" bgcolor="#FFFFFF"><div align="center">7</div></td>
                ...
                <td bgcolor="#FFFFFF"><div align="center">
                        <input name="dailydeed.subtotal_z_7" type="text" id="subtotal_z_7"  size="8" maxlength="10"  value='<s:property value="dailydeed.subtotal_z_7"/>' readonly="readonly">
                      </div></td>
                         <td  bgcolor="#FFFFFF"><textarea cols="16" rows="10"  name="dailydeed.remark_z_7"
												id="dailydeed.remark_z_7" readonly><s:property value="dailydeed.remark_z_7"/></textarea></td>
                <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="dailydeed.subtotal_d_7" type="text" id="subtotal_d_7"  size="8" maxlength="10"   value='<s:property value="dailydeed.subtotal_d_7"/>' readonly="readonly">
                      </div></td>
                         <td  bgcolor="#FFFFFF"><textarea cols="16" rows="10" name="dailydeed.remark_d_7"
												id="dailydeed.remark_d_7" readonly><s:property value="dailydeed.remark_d_7"/></textarea></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="dailydeed.subtotal_m_7" type="text" id="subtotal_m_7"  size="8" maxlength="10" value='<s:property value="dailydeed.subtotal_m_7"/>' readonly="readonly">
                      </div></td>
                       <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="dailydeed.subtotal_s_7" type="text" id="subtotal_s_7"  size="8" maxlength="12" value='<s:property value="dailydeed.subtotal_s_7"/>' readonly="readonly">
                      </div></td>                  
              </tr> 
               ...
               <tr>
                ...
                <td bgcolor="#FFFFFF"><div align="center">
                        <input name="dailydeed.subtotal_z_8" type="text" id="subtotal_z_8"  size="8" maxlength="10" value='<s:property value="dailydeed.subtotal_z_8"/>' readonly="readonly">
                      </div></td>
                         <td  bgcolor="#FFFFFF"><textarea cols="16" rows="8"  name="dailydeed.remark_z_8"
												id="dailydeed.remark_z_8" readonly><s:property value="dailydeed.remark_z_8"/></textarea></td>
                <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="dailydeed.subtotal_d_8" type="text" id="subtotal_d_8"  size="8" maxlength="10"  value='<s:property value="dailydeed.subtotal_d_8"/>' readonly="readonly">
                      </div></td>
                         <td  bgcolor="#FFFFFF"><textarea cols="16" rows="8"  name="dailydeed.remark_d_8" 
												id="dailydeed.remark_d_8" readonly><s:property value="dailydeed.remark_d_8"/></textarea></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="dailydeed.subtotal_m_8" type="text" id="subtotal_m_8" size="8" maxlength="10" value='<s:property value="dailydeed.subtotal_m_8"/>' readonly="readonly">
                      </div></td>
                       <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="dailydeed.subtotal_s_8" type="text" id="subtotal_s_8"  size="8" maxlength="12" value='<s:property value="dailydeed.subtotal_s_8"/>' readonly="readonly">
                      </div></td>                  
              </tr> 
   ...
   <td  bgcolor="#CCFFFF"><div align="center">
                     <input name="dailydeed.subtotal_z" type="text" id="subtotal_z"  size="8" maxlength="10" value='<s:property value="dailydeed.subtotal_z"/>' format="NNN" readonly="readonly">
                   </div></td>
                   <td  bgcolor="#CCFFFF"></td>
   <td  bgcolor="#CCFFFF"><div align="center">
     <input name="dailydeed.subtotal_d" type="text" id="subtotal_d"  size="8" maxlength="10" value='<s:property value="dailydeed.subtotal_d"/>' format="NNN" readonly="readonly">
   </div></td>
                   <td  bgcolor="#CCFFFF"></td>
<td  bgcolor="#CCFFFF"><div align="center">
                        <input name="dailydeed.subtotal_m" type="text" id="subtotal_m"   size="8" maxlength="10" value='<s:property value="dailydeed.subtotal_m"/>' readonly="readonly">
                      </div></td>
                      
                     
<td   bgcolor="#CCFFFF"><div align="center">
                        <input name="dailydeed.subtotal_s" type="text" id="subtotal_s"  size="8" maxlength="12" value='<s:property value="dailydeed.subtotal_s"/>' readonly="readonly">
          </div></td>
        </tr>
          </table>
