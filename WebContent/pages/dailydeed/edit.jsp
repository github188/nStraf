...
-->
	...
	String.prototype.trim = function()
	{
		...
		function numClear(itemName){
			...
			document.getElementById("dailydeed.subtotal_z").value = 0;
			ret1 = (parseFloat(document.getElementById("dailydeed.subtotal_z_1").value)*40/10 + parseFloat(document.getElementById("dailydeed.subtotal_z_2").value)*50/10+ parseFloat(document.getElementById("dailydeed.subtotal_z_3").value)*40/10 + parseFloat(document.getElementById("dailydeed.subtotal_z_4").value)*30/10 + parseFloat(document.getElementById("dailydeed.subtotal_z_5").value)*30/10 + parseFloat(document.getElementById("dailydeed.subtotal_z_6").value)*30/10 + parseFloat(document.getElementById("dailydeed.subtotal_z_7").value)*20/10 + parseFloat(document.getElementById("dailydeed.subtotal_z_8").value))*10/10;
			document.getElementById("dailydeed.subtotal_z").value = ret1.toFixed(1);	
			document.getElementById("dailydeed.subtotal_z").value =document.getElementById("dailydeed.subtotal_z").value.replace(/(\.\d)\d+/ig,"$1");
		}
        ...
        <br/>
              ...
              <tr>
                ...
                <td bgcolor="#FFFFFF"><div align="center">
                  <input name="dailydeed.subtotal_z_1" type="text" id="subtotal_z_1"  size="8" maxlength="11"  onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="dailydeed.subtotal_z_1"/>'>
                </div></td>
                         <td  bgcolor="#FFFFFF"><div align="center">
                           <textarea cols="16" rows="12" name="dailydeed.remark_z_1"
												id="remark_z_1" ><s:property value="dailydeed.remark_z_1"/></textarea>
                         </div></td>
                <td  bgcolor="#FFFFFF"><div align="center">
                  <input name="dailydeed.subtotal_d_1" type="text" id="subtotal_d_1" class="bgg" size="8" maxlength="10" value='<s:property value="dailydeed.subtotal_d_1"/>' readonly="readonly">
                </div></td>
                      ...
                      <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="dailydeed.subtotal_m_1" type="text" id="subtotal_m_1" class="bgg" size="8" maxlength="10" value='<s:property value="dailydeed.subtotal_m_1"/>' readonly="readonly">
                      </div></td>
                       <td  bgcolor="#FFFFFF"><div align="center">
                ...
                <td bgcolor="#FFFFFF"><div align="center">
                        <input name="dailydeed.subtotal_z_2" type="text" id="subtotal_z_2"  size="8" maxlength="10"  onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="dailydeed.subtotal_z_2"/>'>
                      </div></td>
                         <td  bgcolor="#FFFFFF"><div align="center"><textarea cols="16" rows="13" name="dailydeed.remark_z_2"
												id="remark_z_2" ><s:property value="dailydeed.remark_z_2"/></textarea></td>
                <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="dailydeed.subtotal_d_2" type="text" id="subtotal_d_2" class="bgg" size="8" maxlength="10" value='<s:property value="dailydeed.subtotal_d_2"/>' readonly="readonly">
                      </div></td>
                      ...
                      <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="dailydeed.subtotal_m_2" type="text" id="subtotal_m_2" class="bgg" size="8" maxlength="10" value='<s:property value="dailydeed.subtotal_m_2"/>' readonly="readonly">
                      </div></td>
                       <td  bgcolor="#FFFFFF"><div align="center">
              ...
              <tr>
                ...
                <td bgcolor="#FFFFFF"><div align="center">4</div></td>
                <td bgcolor="#FFFFFF"><div align="center">
                  <input name="dailydeed.subtotal_z_3" type="text" id="subtotal_z_3"  size="8" maxlength="10"  onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="dailydeed.subtotal_z_3"/>'>
                </div></td>
                         <td  bgcolor="#FFFFFF"><div align="center">
                           <textarea cols="16" rows="12" name="dailydeed.remark_z_3"
												id="dailydeed.remark_z_3" ><s:property value="dailydeed.remark_z_3"/></textarea>
                         </div></td>
                <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="dailydeed.subtotal_d_3" type="text" id="subtotal_d_3" class="bgg" size="8" maxlength="10" value='<s:property value="dailydeed.subtotal_d_3"/>' readonly="readonly">
                      </div></td>
                         <td  bgcolor="#FFFFFF"><textarea cols="16" rows="12" class="bgg" name="dailydeed.remark_d_3"
												id="dailydeed.remark_d_3" readonly><s:property value="dailydeed.remark_d_3"/></textarea></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="dailydeed.subtotal_m_3" type="text" id="subtotal_m_3" class="bgg" size="8" maxlength="10" value='<s:property value="dailydeed.subtotal_m_3"/>' readonly="readonly">
                      </div></td>
                       <td  bgcolor="#FFFFFF"><div align="center">
                ...
                <td bgcolor="#FFFFFF"><div align="center">
                        <input name="dailydeed.subtotal_z_4" type="text" id="subtotal_z_4"  size="8" maxlength="10"  onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="dailydeed.subtotal_z_4"/>'>
                      </div></td>
                         <td  bgcolor="#FFFFFF"><div align="center"><textarea cols="16" rows="10" name="dailydeed.remark_z_4"
												id="dailydeed.remark_z_4" ><s:property value="dailydeed.remark_z_4"/></textarea>
                      </div></td>
                <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="dailydeed.subtotal_d_4" type="text" id="subtotal_d_4" class="bgg" size="8" maxlength="10" value='<s:property value="dailydeed.subtotal_d_4"/>' readonly="readonly">
                      </div></td>
                      ...
                      <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="dailydeed.subtotal_m_4" type="text" id="subtotal_m_4" class="bgg" size="8" maxlength="10" value='<s:property value="dailydeed.subtotal_m_4"/>' readonly="readonly">
                      </div></td>
                       <td  bgcolor="#FFFFFF"><div align="center">
               ...
               <tr>
                ...
                <td bgcolor="#FFFFFF"><div align="center">3</div></td>
                <td bgcolor="#FFFFFF"><div align="center">
                        <input name="dailydeed.subtotal_z_5" type="text" id="subtotal_z_5"  size="8" maxlength="10"  onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="dailydeed.subtotal_z_5"/>'>
                      </div></td>
                         <td  bgcolor="#FFFFFF"><textarea cols="16" rows="10" name="dailydeed.remark_z_5"
												id="dailydeed.remark_z_5" ><s:property value="dailydeed.remark_z_5"/></textarea></td>
                <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="dailydeed.subtotal_d_5" type="text" id="subtotal_d_5" class="bgg" size="8" maxlength="10" value='<s:property value="dailydeed.subtotal_d_5"/>' readonly="readonly">
                      </div></td>
                      ...
                      <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="dailydeed.subtotal_m_5" type="text" id="subtotal_m_5" class="bgg" size="8" maxlength="10" value='<s:property value="dailydeed.subtotal_m_5"/>' readonly="readonly">
                      </div></td>
                       <td  bgcolor="#FFFFFF"><div align="center">
               ...
               <tr>
                ...
                <td bgcolor="#FFFFFF"><div align="center">3</div></td>
                <td bgcolor="#FFFFFF"><div align="center">
                        <input name="dailydeed.subtotal_z_6" type="text" id="subtotal_z_6"  size="8" maxlength="10"  onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="dailydeed.subtotal_z_6"/>'>
                      </div></td>
                         <td  bgcolor="#FFFFFF"><textarea cols="16" rows="15" name="dailydeed.remark_z_6"
												id="dailydeed.remark_z_6" ><s:property value="dailydeed.remark_z_6"/></textarea></td>
                <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="dailydeed.subtotal_d_6" type="text" id="subtotal_d_6" class="bgg" size="8" maxlength="10" value='<s:property value="dailydeed.subtotal_d_6"/>' readonly="readonly">
                      </div></td>
                         <td  bgcolor="#FFFFFF"><textarea cols="16" rows="15" class="bgg" name="dailydeed.remark_d_6"
												id="dailydeed.remark_d_6" readonly><s:property value="dailydeed.remark_d_6"/></textarea></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="dailydeed.subtotal_m_6" type="text" id="subtotal_m_6" class="bgg" size="8" maxlength="10" value='<s:property value="dailydeed.subtotal_m_6"/>' readonly="readonly">
                      </div></td>
                       <td  bgcolor="#FFFFFF"><div align="center">
               ...
               <tr>
                ...
                <td bgcolor="#FFFFFF"><div align="center">
                        <input name="dailydeed.subtotal_z_7" type="text" id="subtotal_z_7"  size="8" maxlength="10"  onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="dailydeed.subtotal_z_7"/>'>
                      </div></td>
                         <td  bgcolor="#FFFFFF"><textarea cols="16" rows="10" name="dailydeed.remark_z_7"
												id="dailydeed.remark_z_7" ><s:property value="dailydeed.remark_z_7"/></textarea></td>
                <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="dailydeed.subtotal_d_7" type="text" id="subtotal_d_7" class="bgg" size="8" maxlength="10" value='<s:property value="dailydeed.subtotal_d_7"/>' readonly="readonly">
                      </div></td>
                      ...
                      <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="dailydeed.subtotal_m_7" type="text" id="subtotal_m_7" class="bgg" size="8" maxlength="10" value='<s:property value="dailydeed.subtotal_m_7"/>' readonly="readonly">
                      </div></td>
                       <td  bgcolor="#FFFFFF"><div align="center">
               ...
               <tr>
                ...
                <td bgcolor="#FFFFFF"><div align="center">
                        <input name="dailydeed.subtotal_z_8" type="text" id="subtotal_z_8"  size="8" maxlength="10"  onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="dailydeed.subtotal_z_8"/>'>
                      </div></td>
                         <td  bgcolor="#FFFFFF"><textarea cols="16" rows="8" name="dailydeed.remark_z_8"
												id="dailydeed.remark_z_8" ><s:property value="dailydeed.remark_z_8"/></textarea></td>
                <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="dailydeed.subtotal_d_8" type="text" id="subtotal_d_8" class="bgg" size="8" maxlength="10" value='<s:property value="dailydeed.subtotal_d_8"/>' readonly="readonly">
                      </div></td>
                         <td  bgcolor="#FFFFFF"><textarea cols="16" rows="8" class="bgg" name="dailydeed.remark_d_8"
												id="dailydeed.remark_d_8" readonly><s:property value="dailydeed.remark_d_8"/></textarea></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="dailydeed.subtotal_m_8" type="text" id="subtotal_m_8" class="bgg" size="8" maxlength="10" value='<s:property value="dailydeed.subtotal_m_8"/>' readonly="readonly">
                      </div></td>
                       <td  bgcolor="#FFFFFF"><div align="center">
