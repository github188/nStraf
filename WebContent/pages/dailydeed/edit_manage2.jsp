...
-->
	...
	String.prototype.trim = function()
	{
		...
		function numClear(itemName){
			...
			ret = parseFloat(document.getElementById("dailydeed.subtotal_m_1").value)*40/10;
            ...
            itemName.value = itemName.value.replace(/(\.\d)\d+/ig,"$1");
			ret = parseFloat(document.getElementById("dailydeed.subtotal_m_2").value)*50/10;
            ...
            itemName.value = itemName.value.replace(/(\.\d)\d+/ig,"$1");
			ret = +parseFloat(document.getElementById("dailydeed.subtotal_m_3").value)*40/10;
            ...
            itemName.value = itemName.value.replace(/(\.\d)\d+/ig,"$1");
			ret = parseFloat(document.getElementById("dailydeed.subtotal_m_4").value)*30/10;
            ...
            itemName.value = itemName.value.replace(/(\.\d)\d+/ig,"$1");
			ret = parseFloat(document.getElementById("dailydeed.subtotal_m_5").value)*30/10;
            ...
            itemName.value = itemName.value.replace(/(\.\d)\d+/ig,"$1");
			ret = parseFloat(document.getElementById("dailydeed.subtotal_m_6").value)*30/10;
            ...
            itemName.value = itemName.value.replace(/(\.\d)\d+/ig,"$1");
			ret = parseFloat(document.getElementById("dailydeed.subtotal_m_7").value)*20/10;
            ...
            itemName.value = itemName.value.replace(/(\.\d)\d+/ig,"$1");
			ret = parseFloat(document.getElementById("dailydeed.subtotal_m_8").value)*10/10;
