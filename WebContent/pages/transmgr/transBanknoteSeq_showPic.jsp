...
<form name="transBanknoteSeqForm" method="post">
...
<table width="100%" border="0" cellpadding="1" cellspacing="1" bgcolor="#000066" id=downloadList>
	...
	<s:iterator value="objList" id="transBanknoteSeq" status="rowstatus">
	<s:if test="#rowstatus.odd == true">
		...
		<td align="center">
			<tm:dataDir beanName="transBanknoteSeq" property="checkResult" path="transMgr.checkResult" scope="request"/>
		</td>
		<td align="center">
			<tm:dataDir beanName="transBanknoteSeq" property="noteType" path="transMgr.noteType" />
		</td>
		<td align="center">
			<tm:dataDir beanName="transBanknoteSeq" property="currency" path="ruleMgr.moneyType" />
		</td>
		<td align="center">
			<tm:dataDir beanName="transBanknoteSeq" property="denomination" path="ruleMgr.moneyDenomination" />
		</td>
	</s:iterator>
	</tr>
 </table>
