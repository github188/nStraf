...
<html>
	...
	<body id="bodyid" leftmargin="0" topmargin="10">
		<form action="/pages/tranInfo/tranInfo!show.action" method="post">
				...
				<tr>
					<td>
						<fieldset class="jui_fieldset" width="100%">
							...
							<s:iterator value="tranInfo" id="tranInfo">
								<table width="100%" align="center" class="popnewdialog1">
									...
									<tr>
										...
										<td>
											<tm:dataDir beanName="tranInfo" property="transResult"
						...
						<fieldset class="jui_fieldset" width="100%">
							...
							<table width="100%" border="0" cellpadding="1" cellspacing="1"
								...
								<tr id="tr" class="trClass0" oriClass="" onMouseOut=TrMove(this)
									...
									<s:iterator value="transBanknoteSeqList1"
										id="transBanknoteSeq1" status="status">
										...
										<td nowrap align="center">
											<tm:dataDir beanName="transBanknoteSeq1" property="noteType" path="transMgr.noteType" />
										</td>
										<td nowrap align="center">
											<tm:dataDir beanName="transBanknoteSeq1" property="currency" path="ruleMgr.moneyType" />
										</td nowrap align="center">
										<td nowrap align="center">
											<tm:dataDir beanName="transBanknoteSeq1" property="denomination" path="ruleMgr.moneyDenomination" />
										</td>
					...
					<td>
						<fieldset class="jui_fieldset" width="100%">
							...
							<table width="100%" border="0" cellpadding="1" cellspacing="1"
								...
								<tr id="tr" class="trClass0" oriClass="" onMouseOut=TrMove(this)
									onMouseOver=TrMove(this)>
									<s:iterator value="transBanknoteSeqList2"
										id="transBanknoteSeq2" status="status">
										<td nowrap align="center">
										...
										<td nowrap align="center">
											<tm:dataDir beanName="transBanknoteSeq2" property="noteType" path="transMgr.noteType" />
										</td>
										<td nowrap align="center">
											<tm:dataDir beanName="transBanknoteSeq2" property="currency" path="ruleMgr.moneyType" />
										</td>
										<td nowrap align="center">
											<tm:dataDir beanName="transBanknoteSeq2" property="denomination" path="ruleMgr.moneyDenomination" />
										</td>
										<s:if test="#status.count%2 == 0">
											<s:if test="(#status.count/2)%2 == 0">
								</tr>
