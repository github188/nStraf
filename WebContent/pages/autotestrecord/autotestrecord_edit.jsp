		 ...
		 {	
			...
			{	
				for(var i=0;i<json.length;i++)
				{
				 ...
				 $("#currentName").val(decodeURI($("#currentNameHidden").val()));
			}
		 }
	</script>
<body id="bodyid"  leftmargin="0" topmargin="10" >
  ...
  <table width="90%" align="center" border="0" cellspacing="1" cellpadding="1" bgcolor="#583F70" style="border-bottom:none">
                    ...
                    <tr>
                        ...
                        <td bgcolor="#FFFFFF"><div align="left"><input name="autoTestRecord.ExecTime" type="text" id="startDate" size="20" class="MyInput" isSel="true" isDate="true" onFocus="ShowDateTime(this)" dofun="ShowDateTime(this)" value='<s:date name="new java.util.Date()" format="yyyy-MM-dd hh:mm:ss"/>'></div></td> 
