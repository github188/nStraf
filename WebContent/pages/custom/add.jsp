...
<form name="customInfoForm" action="<%=request.getContextPath()%>/pages/custom/customInfo!save.action" method="post">
					...
					<td class="input_tablehead">
						新增客户信息
			      		...
			      		<tr>
							...
							<input name="custom.client" maxlength="16" size="40" id="client">
							</td>
							...
							<td  bgcolor="#FFFFFF" width="25%">
								<input name="custom.mouthPiece" maxlength="16" size="40" id="mouthPiece">
							</td>
						</tr>
						...
						<tr>
							...
							<td  bgcolor="#FFFFFF" >
								<input name="custom.address" maxlength="20" size="40" id="address">
							</td>
							<td class="input_label2">
								<div align="center"> 
							...
							<td bgcolor="#FFFFFF" colspan="3">
								...
								readonly="readonly"  
								value='<s:date name="custom.creattDate" format="yyyy-MM-dd"/>'>
                           	</td>
						</tr>
						<tr>
						<td class="input_label2" width="13%">
							...
							<td width="14%" bgcolor="#FFFFFF">
								<input name="custom.tel" maxlength="15" size="40" id="tel" onkeyup="this.value=this.value.replace(/[^0-9\-]+/,'')" onKeyDown="this.value=this.value.replace(/[^0-9\-]+/,'')">
                           	</td>
                           	<td class="input_label2">
								<div align="center"> 
							...
							<td width="14%" bgcolor="#FFFFFF">
								<input name="custom.mail" maxlength="25" size="40" id="mail" onkeyup="this.value=this.value.replace(/[^0-9a-zA-Z@_.\-]+/,'')" onKeyDown="this.value=this.value.replace(/[^0-9a-zA-Z@_.\-]+/,'')">
                           	</td>
						</tr>
						<tr>
							<td class="input_label2">
							...
							<td  colspan="5">
								<div >
									<textarea name="custom.prjList" cols="84" onkeyup="limitLen(500,this)" rows="3" id="prjList"></textarea>
								</div>									
							</td>
						</tr>
						...
						<tr>
							...
							<td bgcolor="#FFFFFF" colspan="5">
								<div >
									<textarea name="custom.note" onkeyup="limitLen(500,this)" cols="84" rows="3" id="note"></textarea>
								</div>									
							</td>
						</tr>
