...
<body id="bodyid"  leftmargin="0" topmargin="10" onLoad="init();">
	<form name="reportInfoForm" action="<%=request.getContextPath() %>/pages/atm/atminfo!saveDeviceConfig.action"   method="post">
                ...
                <fieldset class="jui_fieldset" width="100%">
                    ...
                    <tr>
                     ...
                     <tr>
                          ...
                          <td bgcolor="#FFFFFF"><input name="config.atmCore" type="text" id="atmCore" maxlength="20" size="20" value='<s:property value="config.atmCore"/>'>&nbsp;</td>
                          ...
                          <s:if test="config.core_trans_type!=null&&!config.core_trans_type.equals('')">
                            ...
                            &nbsp;</td>
                               ...
                               <td bgcolor="#FFFFFF"><input name="config.core_port" type="text" id="machineNo" maxlength="20" size="20" value='<s:property value="config.core_port"/>'>&nbsp;</td>
                     </tr> 
                    
                     <tr>
                          <td align="center" width="20%" bgcolor="#999999"><div align="center" style="width:63px">读卡器</div></td>
                          <td bgcolor="#FFFFFF"><input name="config.readCard" type="text" id="readCard" maxlength="20" size="20" value='<s:property value="config.readCard"/>'>&nbsp;</td>
                           <td bgcolor="#FFFFFF"><tm:tmSelect name="config.read_trans_type" id="read_trans_type" selType="dataDir" path="systemConfig.communicateType" style="width:80%"/>
                            ...
                            &nbsp;</td>
                             ...
                             <td bgcolor="#FFFFFF"><input name="config.read_port" type="text" id="machineNo" maxlength="20" size="20" value='<s:property value="config.read_port"/>'>&nbsp;</td>
                    </tr>
    
                     <tr>
                          <td align="center" width="20%" bgcolor="#999999"><div align="center" style="width:63px">键盘</div></td>  
                          <td bgcolor="#FFFFFF"><input name="config.key" type="text" id="key" maxlength="20" size="20" value='<s:property value="config.key"/>'>&nbsp;</td>
                         ...
                         <s:if test="config.key_trans_type!=null&&!config.key_trans_type.equals('')">
                            ...
                            &nbsp;</td>
                             ...
                             <td bgcolor="#FFFFFF"><input name="config.key_port" type="text" id="machineNo" maxlength="20" size="20" value='<s:property value="config.key_port"/>'>&nbsp;</td>
                    </tr>
                  
                     <tr>
                        <td align="center" width="20%" bgcolor="#999999"><div align="center" style="width:63px">流水打印机</div></td>
                          <td bgcolor="#FFFFFF"><input name="config.runningPrinter" type="text" id="runningPrinter" maxlength="20" size="20" value='<s:property value="config.runningPrinter"/>'>&nbsp;</td>
                           <td bgcolor="#FFFFFF"><tm:tmSelect name="config.running_trans_type" id="running_trans_type" selType="dataDir" path="systemConfig.communicateType" style="width:80%"/>
                            ...
                            &nbsp;</td>
                             ...
                             <td bgcolor="#FFFFFF"><input name="config.running_port" type="text" id="machineNo" maxlength="20" size="20" value='<s:property value="config.running_port"/>'>&nbsp;</td>
                    </tr>
   
                     <tr>
                        <td align="center" width="20%" bgcolor="#999999"><div align="center" style="width:63px">凭条打印机</div></td>  
                          <td bgcolor="#FFFFFF"><input name="config.proofPrinter" type="text" id="proofPrinter" maxlength="20" size="20" value='<s:property value="config.proofPrinter"/>'>&nbsp;</td>
                           ...
                           <td bgcolor="#FFFFFF"><tm:tmSelect name="config.proof_pc_sata" id="proof_pc_sata" selType="dataDir" path="systemConfig.pc_port" style="width:80%"/>
                            &nbsp;</td>
                             ...
                             <td bgcolor="#FFFFFF"><input name="config.proof_port" type="text" id="machineNo" maxlength="20" size="20" value='<s:property value="config.proof_port"/>'>&nbsp;</td>
                    </tr>
      
                     <tr>
                          <td align="center" width="20%" bgcolor="#999999"><div align="center" style="width:63px">机芯门</div></td>
                          <td bgcolor="#FFFFFF"><input name="config.coreDoor" type="text" id="coreDoor" maxlength="20" size="20" value='<s:property value="config.coreDoor"/>'>&nbsp;</td>
                           ...
                           <td bgcolor="#FFFFFF"><tm:tmSelect name="config.door_pc_sata" id="door_pc_sata" selType="dataDir" path="systemConfig.pc_port" style="width:80%"/>
                            &nbsp;</td>
                             ...
                             <td bgcolor="#FFFFFF"><input name="config.door_port" type="text" id="machineNo" maxlength="20" size="20" value='<s:property value="config.door_port"/>'>&nbsp;</td>
                    </tr>

                     <tr>
                          <td align="center" width="20%" bgcolor="#999999"><div align="center" style="width:63px">后台维护</div></td>
                          <td bgcolor="#FFFFFF"><input name="config.backdoor" type="text" id="backdoor" maxlength="20" size="20" value='<s:property value="config.backdoor"/>'>&nbsp;</td>
                           <td bgcolor="#FFFFFF"><tm:tmSelect name="config.back_trans_type" id="back_trans_type" selType="dataDir" path="systemConfig.communicateType" style="width:80%"/>
                            ...
                            &nbsp;</td>
                             ...
                             <td bgcolor="#FFFFFF"><input name="config.back_port" type="text" id="machineNo" maxlength="20" size="20" value='<s:property value="config.back_port"/>'>&nbsp;</td>
                    </tr>

                     <tr>
                        <td align="center" width="20%" bgcolor="#999999"><div align="center" style="width:63px">串口分配器</div></td>
                          <td bgcolor="#FFFFFF"><input name="config.dispatcher" type="text" id="dispatcher" maxlength="20" size="20" value='<s:property value="config.dispatcher"/>'>&nbsp;</td>
				  ...
				  <td bgcolor="#FFFFFF"><tm:tmSelect name="config.dispatcher_pc_sata" id="dispatcher_pc_sata" selType="dataDir" path="systemConfig.pc_port" style="width:80%"/>
                            &nbsp;</td>
                             ...
                             <td bgcolor="#FFFFFF"><input name="config.dispatcher_port" type="text" id="machineNo" maxlength="20" size="20" value='<s:property value="config.dispatcher_port"/>'>&nbsp;</td>
                    </tr>
                     <tr>
                          <td align="center" width="20%" bgcolor="#999999"><div align="center" style="width:63px">DVR</div></td>  
                          <td bgcolor="#FFFFFF"><input name="config.dvr" type="text" id="dvr" maxlength="20" size="20" value='<s:property value="config.dvr"/>'>&nbsp;</td>
                          <td bgcolor="#FFFFFF"><tm:tmSelect name="config.dvr_trans_type" id="dvr_trans_type" selType="dataDir" path="systemConfig.communicateType" style="width:80%"/>
                           ...
                           &nbsp;</td>
                            ...
                            <td bgcolor="#FFFFFF"><input name="config.dvr_port" type="text" id="machineNo" maxlength="20" size="20" value='<s:property value="config.dvr_port"/>'>&nbsp;</td>
                    </tr>
                    
                     <tr>
                          <td align="center" width="20%" bgcolor="#999999"><div align="center" style="width:63px">MOXA卡</div></td>
                          <td bgcolor="#FFFFFF"><input name="config.moxaCard" type="text" id="moxaCard" maxlength="20" size="20" value='<s:property value="config.moxaCard"/>'>&nbsp;</td>
                          <td bgcolor="#FFFFFF"><tm:tmSelect name="config.moxaCard_trans_type" id="moxaCard_trans_type" selType="dataDir" path="systemConfig.communicateType" style="width:80%"/>
                           ...
                           &nbsp;</td>
                            ...
                            <td bgcolor="#FFFFFF"><input name="config.moxaCard_port" type="text" id="machineNo" maxlength="20" size="20" value='<s:property value="config.moxaCard_port"/>'>&nbsp;</td>
                    </tr>
                     <tr>
                          <td align="center" width="20%" bgcolor="#999999"><div align="center" style="width:63px">触摸屏</div></td>
                          <td bgcolor="#FFFFFF"><input name="config.touchScreen" type="text" id="dvr" maxlength="20" size="20" value='<s:property value="config.touchScreen"/>'>&nbsp;</td>
                          <td bgcolor="#FFFFFF"><tm:tmSelect name="config.touch_trans_type" id="touch_trans_type" selType="dataDir" path="systemConfig.communicateType" style="width:80%"/>
                           ...
                           &nbsp;</td>
                            ...
                            <td bgcolor="#FFFFFF"><input name="config.touch_port" type="text" d="machineNo" maxlength="20" size="20" value='<s:property value="config.touch_port"/>'>&nbsp;</td>
                     </tr>
