						...
						<table class="input_table">
							...
							<tr>
								...
								<td width="14%" bgcolor="#FFFFFF"><input
									name="prjRisk.status" type="text" id="status" 
									maxlength="10" size="10" value='新建' readonly class="input_readonly"></td>
							...
							<tr>
								...
								<td bgcolor="#FFFFFF" colspan="5"><textarea
										name="prjRisk.plan" cols="74" rows="3" 
							...
							<tr>
								...
								<td bgcolor="#FFFFFF"><input name="prjRisk.factdate"
									type="text" disabled="disabled" class="input_readonly" id="factdate"
