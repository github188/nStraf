				...
				<td>
						<table class="input_table".>
							...
							<tr>
								...
								<td bgcolor="#FFFFFF" width="27%"><input
									name="prjRisk.createdate" type="text" id="createdate"
									value="<%=str_date1%>" class="input_readonly" readonly="readonly"></td>
							...
							<tr>
								...
								<td width="14%" bgcolor="#FFFFFF"><input
									...
									maxlength="10" size="10" value='新建' readonly="readonly" class="input_readonly"></td>
							</tr>
							...
							<tr>
								...
								<td bgcolor="#FFFFFF" colspan="3" onClick="startMonthHdl()"><select
									name="prjRisk.pond" id="pond" style="width: 78px" align="left">
										<option value='' selected="true"></option>
							...
							<tr>
								...
								<td bgcolor="#FFFFFF" colspan="5"><textarea
										name="prjRisk.plan" cols="74" rows="3" disabled class="input_readonly"
										id="plan" style="width:100%"></textarea></td>
							</tr>
							...
							<tr>
								...
								<td bgcolor="#FFFFFF"><input name="prjRisk.factdate"
									type="text" disabled  class="input_readonly" id="factdate"></td>
								 -->
								<td class="input_label2" width="9%" >
									<div align="center">处理者</div>
								</td>
								<td width="26%" bgcolor="#FFFFFF" colspan="3"><input
									name="prjRisk.handleman" type="text" disabled class="input_readonly"
									id="handleman" value='' size="20" maxlength="10"></td>
							</tr>
							<!-- 
							<tr>
