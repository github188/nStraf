...
<html>
	...
	<body id="bodyid" leftmargin="0" topmargin="10">
			...
			<table width="95%" align="center" cellPadding="0" cellSpacing="0">
				<tr>
			      ...
			      <br/>
					  ...
					  <td  width="7%" ><input name="sysInfo.birthdate" type="text" id="birthdate"  class="MyInput" value='<s:date name="sysInfo.birthdate" format="yyyy-MM-dd"/>'/>
					  ...
					  <td colspan="3"><input name="sysInfo.graduateschool"  size="50" type="text" id="graduateschool"  value='<s:property value="sysInfo.graduateschool"/>'>                      </td>
			    ...
			    <input type='hidden' id="st" name="st" value="<s:property value='sysInfo.groupname'/>"/>
                    ...
                    <input name="stat8" type="hidden" id="stat8"  value='<s:property value="sysInfo.status"/>' />
                     <input name="userLevelHidden" type="hidden" id="userLevelHidden"  value="<%=((cn.grgbanking.feeltm.login.domain.UserModel)session.getAttribute("tm.loginUser")).getLevel() %>"/>
							</table>
					  </fieldset>
					</td>
				</tr>
		...
		if(document.getElementById("userLevelHidden").value != 0)
		{
