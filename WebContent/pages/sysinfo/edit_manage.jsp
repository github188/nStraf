		...
		<form name="reportInfoForm"
		  ...
		  <div align="center">
								  ...
								  <input name="suggestion.raise_date" type="text"
											...
											value='<s:date name="suggestion.raise_date" format="yyyy-MM-dd"/>' >									</td>
...
<div align="center">
								  ...
								  <input name="suggestion.raise_man" type="text" id="raise_man"
											maxlength="20" size="20" value='<s:property value="suggestion.raise_man"/>' >									</td>
							...
							<td width="27%" bgcolor="#FFFFFF">
							  <input name="suggestion.finishing_date" type="text"
									id="finishing_date" class="MyInput" 
...
<%--												id="resolve_man" maxlength="20" size="20" value='<s:property value="suggestion.resolve_man"/>'>--%>
								  </s:else>									</td>
				   	  ...
				   	  <td bgcolor="#FFFFFF"  colspan="3">
								  		<input name="suggestion.pratical_date" type="text"
											...
											value='<s:date name="suggestion.pratical_date" format="yyyy-MM-dd"/>' >									
                                  </td>
