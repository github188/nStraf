        	...
        	<tr>
        		...
        		<table width="80%" border="0" align="center" cellspacing="1" cellpadding="1" bgcolor="#583F70">
   		    		<tr >
                          ...
                          <td nowrap bgcolor="#336699" width="10%"><div align="center"><font color="#FFFFFF">完成%</font></div></td>
                          <td nowrap bgcolor="#336699" width="10%"><div align="center"><font color="#FFFFFF">状态</font></div></td>
                          <td nowrap bgcolor="#336699" width="6%"><div align="center"><font color="#FFFFFF">管理</font></div></td>
                          <td nowrap bgcolor="#336699" width="6%"><div align="center"><font color="#FFFFFF">需求</font></div></td>
                          <td nowrap bgcolor="#336699" width="6%"><div align="center"><font color="#FFFFFF">设计</font></div></td>
                          <td nowrap bgcolor="#336699" width="6%"><div align="center"><font color="#FFFFFF">编码</font></div></td>
                          <td nowrap bgcolor="#336699" width="6%"><div align="center"><font color="#FFFFFF">测试</font></div></td>
                          <td nowrap bgcolor="#336699" width="6%"><div align="center"><font color="#FFFFFF">其他</font></div></td>
                          <td nowrap bgcolor="#336699" width="6%"><div align="center"><font color="#FFFFFF">工程</font></div></td>
                        ...
                        <tr>
                            ...
                            <td nowrap bgcolor="#FFFFFF"><div align="center"><input name="managerment" type="text" id="managerment"  size="2" maxlength="2" onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)" value='0'></div></td> 
                          <td nowrap bgcolor="#FFFFFF"><div align="center"><input name="requirement" type="text" id="requirement"  size="2" maxlength="2" onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)" value='0'></div></td> 
                          <td nowrap bgcolor="#FFFFFF"><div align="center"><input name="design" type="text" id="design"  size="2" maxlength="2" onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)" value='0'></div></td>
                          <td nowrap bgcolor="#FFFFFF"><div align="center"><input name="code" type="text" id="code"  size="2" maxlength="2" onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)" value='0'></div></td>
                          <td nowrap bgcolor="#FFFFFF"><div align="center"><input name="test" type="text" id="test"  size="2" maxlength="2" onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)" value='0'></div></td>  
                          <td nowrap bgcolor="#FFFFFF"><div align="center"><input name="other" type="text" id="other"  size="2" maxlength="2" onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)" value='0'></div></td>
                          <td nowrap bgcolor="#FFFFFF" ><div align="center"><input name="project" type="text" id="project"  size="2"  maxlength="2" onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)" value='0'></div></td>
                          <td nowrap bgcolor="#CCCCCC" ><div align="center"><input name="subtotal" id="subtotal" value="0" readonly size="2" style="background:#999999;" /></div></td>
                  </tr>
                      <tr>
                          <td bgcolor="#336699" nowrap width="40%" ><div align="center"><font color="#FFFFFF">交付件</font></div></td>
                          <td colspan="4" nowrap bgcolor="#FFFFFF" ><div align="left"><input name="attachment" type="text" id="attachment" size="39" value=""></div></td>
                          <td colspan="2" bgcolor="#336699" nowrap><div align="center" style="width:80px;"><font color="#FFFFFF">&nbsp;偏差原因&nbsp;</font></div></td>
                          <td colspan="6" nowrap bgcolor="#FFFFFF" ><div align="left"><input name="taskReason" type="text" id="taskReason" size="30" value="" style="color:#FF0000"></div></td>
                      </tr>
                      <tr>
                          <td nowrap bgcolor="#336699"><div align="center"><font color="#FFFFFF">任务描述</font><font color="#FF0000">*</font></div></td>
                          <td colspan="12" nowrap bgcolor="#FFFFFF" ><div align="left"><textarea name="taskDesc" type="text" id="taskDesc" rows="2" cols="65" onBlur="checkHdl(this)" ></textarea>
                          </div></td>
                      </tr>
                  </table>
              </td>
