				...
				if(taskDivPtr!=null && taskDivPtr.id!="")
				{
					if(taskDivPtr.id.indexOf("task")>=0)
					{
						if(taskDivPtr!=null && taskDivPtr.getElementsByTagName("input")[0].checked){
							if(taskDivPPtr.childNodes.length==tableTaskIndex+7)
							{
								//alert("必须至少一项任务");
								allClearFlag = true;
                    ...
                    <tr>
                        ...
                        <table width="80%" align="center" border="1" cellspacing="0" >
                                <tr>
                                  ...
                                  <td colspan="7" bgcolor="#336699"><div align="center"><font color="#FFFFFF">工时(小计: </font><font color="#FF0000"><input name="subtotal" id="subtotal" readonly size="2" value='<s:property value="subtotal"/>' /></font><font color="#FFFFFF"> 小时)</font></div></td>
                                </tr>
                                <tr>
