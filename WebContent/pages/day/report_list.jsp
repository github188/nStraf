...
<head><title>workReport query</title></head>
	...
	<script type="text/javascript"> 
		...
		function setHTML(entry,entryInfo){
			...
			html += '</td>';
			html += '<td align="center"><a href='+str+'><font color="#3366FF">' +entryInfo["dateString"] + '</font></a></td>';
			html += '<td>';
 ...
 <body id="bodyid" leftmargin="0" topmargin="0"><br>
	...
	<script type="text/javascript">
		...
		//当月统计
		function currentStatic(){
			 var strUrl="/pages/day/reportinfo!showCurrentMonthStatic.action";
			var features="800,820,transmgr.traninfo,watch";
			var resultvalue = OpenModal(strUrl,features);
		}
		...
		function static(){
			...
			if(start==""){
				...
				//var actionUrl = "<%=request.getContextPath()%>/pages/day/reportinfo!refresh.action?from=refresh&pageNum="+pageNum;
			var strUrl="/pages/day/reportinfo!showStatic.action?start="+start+"&end="+end;
			var features="800,820,transmgr.traninfo,watch";
			var resultvalue = OpenModal(strUrl,features);
		}
	...
	<table width="100%" height="23" border="0" cellspacing="0" cellpadding="0" background="../../images/main/bgtop.gif">
			<tr>
                 ...
                 <td colspan="2"><input type="button"   value="当月统计" onClick="currentStatic();" class="MyButton"  image="../../images/share/find.gif"/></td>
				 <td colspan="2"><input type="button"   value="指定日期统计" onClick="static();" class="MyButton"  image="../../images/share/find.gif"/></td>
	...
	<table width="100%" border="0" cellpadding="1" cellspacing="1" bgcolor="#000066" id=downloadList>
		<tr> 
			...
			<td nowrap width="15%" class="oracolumncenterheader"><div align="center">创建时间 </div></td>
		...
		<tbody name="formlist" id="formlist" align="center"> 
 		...
 		<tr id="tr" class="trClass1" oriClass="" onMouseOut=TrMove(this) onMouseOver=TrMove(this)>
			...
			<td nowrap ><div align="center">
				<a href='javascript:show("<s:property value="username"/>","<s:date name="createDate" format="yyyy-MM-dd"/>")'><font color="#3366FF"><s:date name="createDate" format="yyyy-MM-dd"/></font></a>
		  	</div></td><!--字段需修改与后台一致-->
		 	<td nowrap ><s:property value="username"/></td>
		 	<td nowrap ><s:property value="groupName"/></td>
			<td nowrap >
