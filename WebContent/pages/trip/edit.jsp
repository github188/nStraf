		...
		<table width="95%" align="center" cellPadding="0" cellSpacing="0">
			<tr>
				<td>
						...
						<div class="user_info_banner">名字：<s:property value="trip.username"/>&nbsp;&nbsp;&nbsp;&nbsp;部门：<s:property value="trip.detname"/></div>
						...
						<!--  	<td width="10%" class="input_label2"><font
							...
							<tr>
								...
								<td colspan="5" bgcolor="#FFFFFF"><textarea
										name="trip.taskdesc" id="taskdesc" cols="80" rows="3" onkeyup="limitLen(200,this)"><s:property
							...
							<tr>
								...
								<td colspan="5" bgcolor="#FFFFFF"><textarea
										name="trip.sumup" id="sumup" cols="80" rows="7" onkeyup="limitLen(500,this)"><s:property value="trip.sumup" /></textarea>
								</td>
							</tr>
							<tr>
								<td width="10%" class="input_label2"><font
								...
								<td colspan="5" bgcolor="#FFFFFF"><select
									name="trip.auditing_man" id="auditing_man" style="width: 50%">
