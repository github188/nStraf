...
-->
	...
	<script type="text/javascript">
		...
		function save(){      
			...
			if(document.getElementById("subtotal_z_1").value==0)
			{
				alert("请给任务类比第一项细则评分");
				return;
			}
			if(document.getElementById("subtotal_z_2").value==0)
			{
				alert("请给任务类第二项细则评分");
				return;
			}			
			if(document.getElementById("subtotal_z_3").value==0)
			{
				alert("请给任务类第三项细则评分");
				return;
			}
		    if(document.getElementById("subtotal_z_4").value==0)
			{
				alert("请给时效类第一项细则评分");
				return;
			}
			if(document.getElementById("subtotal_z_8").value==0)
			{
				alert("请给质量类第一项细则评分");
				return;
			}
			if(document.getElementById("subtotal_z_13").value==0)
			{
				alert("请给过程类第一项细则评分");
				return;
			}
			if(document.getElementById("subtotal_z_14").value==0)
			{
				alert("请给过程类第二项细则评分");
				return;
			}
			if(document.getElementById("subtotal_z_15").value==0)
			{
				alert("请给过程类第三项细则评分");
				return;
			}
			if(document.getElementById("subtotal_z_32").value==0)
			{
				alert("请给其他类第一项细则评分");
				return;
			}
	...
	String.prototype.trim = function()
	{
		...
		function numClear(itemName){
			...
			document.getElementById("performance.subtotal_z").value = 0;
			ret1 = parseFloat(document.getElementById("performance.subtotal_z_1").value) + parseFloat(document.getElementById("performance.subtotal_z_2").value)+ parseFloat(document.getElementById("performance.subtotal_z_3").value) + parseFloat(document.getElementById("performance.subtotal_z_4").value) + parseFloat(document.getElementById("performance.subtotal_z_5").value) + parseFloat(document.getElementById("performance.subtotal_z_6").value) + parseFloat(document.getElementById("performance.subtotal_z_7").value) + parseFloat(document.getElementById("performance.subtotal_z_8").value) + parseFloat(document.getElementById("performance.subtotal_z_9").value) + parseFloat(document.getElementById("performance.subtotal_z_10").value);
			ret2 = parseFloat(document.getElementById("performance.subtotal_z_11").value) + parseFloat(document.getElementById("performance.subtotal_z_12").value)+ parseFloat(document.getElementById("performance.subtotal_z_13").value) + parseFloat(document.getElementById("performance.subtotal_z_14").value) + parseFloat(document.getElementById("performance.subtotal_z_15").value) + parseFloat(document.getElementById("performance.subtotal_z_16").value) + parseFloat(document.getElementById("performance.subtotal_z_17").value) + parseFloat(document.getElementById("performance.subtotal_z_18").value) + parseFloat(document.getElementById("performance.subtotal_z_19").value) + parseFloat(document.getElementById("performance.subtotal_z_20").value);
			ret3 = parseFloat(document.getElementById("performance.subtotal_z_21").value) + parseFloat(document.getElementById("performance.subtotal_z_22").value)+ parseFloat(document.getElementById("performance.subtotal_z_23").value) + parseFloat(document.getElementById("performance.subtotal_z_24").value) + parseFloat(document.getElementById("performance.subtotal_z_25").value) + parseFloat(document.getElementById("performance.subtotal_z_26").value) + parseFloat(document.getElementById("performance.subtotal_z_27").value) + parseFloat(document.getElementById("performance.subtotal_z_28").value) + parseFloat(document.getElementById("performance.subtotal_z_29").value) + parseFloat(document.getElementById("performance.subtotal_z_30").value);
			ret4 = parseFloat(document.getElementById("performance.subtotal_z_31").value) + parseFloat(document.getElementById("performance.subtotal_z_32").value)+ parseFloat(document.getElementById("performance.subtotal_z_33").value) + parseFloat(document.getElementById("performance.subtotal_z_34").value) + parseFloat(document.getElementById("performance.subtotal_z_35").value) + parseFloat(document.getElementById("performance.subtotal_z_36").value) + parseFloat(document.getElementById("performance.subtotal_z_37").value) + parseFloat(document.getElementById("performance.subtotal_z_38").value) + parseFloat(document.getElementById("performance.subtotal_z_39").value) + parseFloat(document.getElementById("performance.subtotal_z_40").value);
			ret5 = parseFloat(document.getElementById("performance.subtotal_z_41").value) + parseFloat(document.getElementById("performance.subtotal_z_42").value)+ parseFloat(document.getElementById("performance.subtotal_z_43").value) + parseFloat(document.getElementById("performance.subtotal_z_44").value) + parseFloat(document.getElementById("performance.subtotal_z_45").value) + parseFloat(document.getElementById("performance.subtotal_z_46").value) + parseFloat(document.getElementById("performance.subtotal_z_47").value) + parseFloat(document.getElementById("performance.subtotal_z_48").value) + parseFloat(document.getElementById("performance.subtotal_z_49").value) + parseFloat(document.getElementById("performance.subtotal_z_50").value)+ parseFloat(document.getElementById("performance.subtotal_z_51").value)+ parseFloat(document.getElementById("performance.subtotal_z_52").value)+ parseFloat(document.getElementById("performance.subtotal_z_53").value)+ parseFloat(document.getElementById("performance.subtotal_z_54").value)+ parseFloat(document.getElementById("performance.subtotal_z_55").value)+ parseFloat(document.getElementById("performance.subtotal_z_56").value);
			document.getElementById("performance.subtotal_z").value = ret1+ ret2 + ret3 + ret4 + ret5;	
        ...
        <br/>
              ...
              <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_z_1" type="text" id="subtotal_z_1"  size="10" maxlength="10"  onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="performance.subtotal_z_1"/>'>
                      </div></td>
                <td  bgcolor="#FFFFFF"><div align="center">
              ...
              <tr>
                ...
                <td  bgcolor="#FFFF00"><div align="center">5~20 (正常:10)<font color="#FF0000">*</font></div></td>
                     <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_z_2" type="text" id="subtotal_z_2" size="10" maxlength="10" onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="performance.subtotal_z_2"/>'>
                      </div></td>
           <td  bgcolor="#FFFFFF"><div align="center">
              ...
              <tr>
                ...
                <td  bgcolor="#FFFF00"><div align="center">0~10 (正常:5)<font color="#FF0000">*</font></div></td>
                              <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_z_3" type="text" id="subtotal_z_3" size="10" maxlength="10" onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="performance.subtotal_z_3"/>'>
                      </div></td>
                        <td  bgcolor="#FFFFFF"><div align="center">
              ...
              <tr>
                ...
                <td width="7%" rowspan="4"  bgcolor="#FFFFFF"><div align="center">时效（20）</div>
                    <div align="center"></div></td>
                ...
                <td  bgcolor="#FFFF00"><div align="center">0~20 (正常:20)<font color="#FF0000">*</font></div></td>
                        <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_z_4" type="text" id="subtotal_z_4" size="10" maxlength="10"  onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="performance.subtotal_z_4"/>'>
              ...
              <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_z_5" type="text" id="subtotal_z_5" size="10" maxlength="10"  onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="performance.subtotal_z_5"/>'>
                      </div></td>
                        <td  bgcolor="#FFFFFF"><div align="center">
              ...
              <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">5</div></td>
                        <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_z_6" type="text" id="subtotal_z_6"  size="10" maxlength="10" onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="performance.subtotal_z_6"/>' >
                      </div></td>
                                             <td  bgcolor="#FFFFFF"><div align="center">
              ...
              <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">-5</div></td>
                        <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_z_7" type="text" id="subtotal_z_7"  size="10" maxlength="10"  onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="performance.subtotal_z_7"/>'>
                      </div></td>
                                                                    <td  bgcolor="#FFFFFF"><div align="center">
              ...
              <tr>
                ...
                <td width="7%" rowspan="5"  bgcolor="#FFFFFF"><div align="center">质量（20）</div>
                    <div align="center"></div></td>
                ...
                <td  bgcolor="#FFFF00"><div align="center">20<font color="#FF0000">*</font></div></td>
                        <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_z_8" type="text" id="subtotal_z_8"  size="10" maxlength="10"  onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="performance.subtotal_z_8"/>'>
                      </div></td>
          <td  bgcolor="#FFFFFF"><div align="center">
              ...
              <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">5</div></td>
                        <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_z_9" type="text" id="subtotal_z_9"  size="10" maxlength="10"  onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="performance.subtotal_z_9"/>' >
                      </div></td>
                                                                       <td  bgcolor="#FFFFFF"><div align="center">
              ...
              <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">-5</div></td>
                        <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_z_10" type="text" id="subtotal_z_10"  size="10" onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN" maxlength="10" value='<s:property value="performance.subtotal_z_10"/>' >
                      </div></td>
                  <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_d_10" type="text" class="bgg" id="subtotal_d_10" size="10" maxlength="10"   value='<s:property value="performance.subtotal_d_10"/>' readonly="readonly">
                      </div></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
              ...
              <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">1~10</div></td>
                        <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_z_11" type="text" id="subtotal_z_11"  size="10" maxlength="10"   onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="performance.subtotal_z_11"/>' >
                      </div></td>
                                                        <td  bgcolor="#FFFFFF"><div align="center">
              ...
              <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">-3</div></td>
                        <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_z_12" type="text" id="subtotal_z_12"  size="10" maxlength="10"  onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="performance.subtotal_z_12"/>' >
                      </div></td>
                                                     <td  bgcolor="#FFFFFF"><div align="center">
              ...
              <tr>
                ...
                <td width="7%" rowspan="19"  bgcolor="#FFFFFF"><div align="center">过程（20）</div>
                    <div align="center"></div></td>
                <td   bgcolor="#FFFFFF"><div align="left">不能与团队和谐相处:0~4； &nbsp;&nbsp;沟通协调正常:5； &nbsp;&nbsp;能主动帮助别人:6~10 </div></td>
                <td  bgcolor="#FFFF00"><div align="center">0~10 (正常:5)<font color="#FF0000">*</font></div></td>
                                        <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_z_13" type="text" id="subtotal_z_13"  size="10" maxlength="10"  onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="performance.subtotal_z_13"/>' >
                      </div></td>
          <td  bgcolor="#FFFFFF"><div align="center">
              ...
              <tr>
                ...
                <td  bgcolor="#FFFF00"><div align="center">0~20 (正常:10)<font color="#FF0000">*</font></div></td>
                                        <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_z_14" type="text" id="subtotal_z_14" size="10" maxlength="10"  onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN"  value='<s:property value="performance.subtotal_z_14"/>' >
                      </div></td>
<td  bgcolor="#FFFFFF"><div align="center">
              ...
              <tr>
                ...
                <td  bgcolor="#FFFF00"><div align="center">0~10  (正常:5)<font color="#FF0000">*</font></div></td>
                                        <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_z_15" type="text" id="subtotal_z_15"  size="10" maxlength="10"  onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="performance.subtotal_z_15"/>' >
                      </div></td>
          <td  bgcolor="#FFFFFF"><div align="center">
              ...
              <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">测试管理平台中分值</div></td>
                                        <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_z_16" type="text" id="subtotal_z_16" size="10" maxlength="10"   onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="performance.subtotal_z_16"/>' >
                      </div></td>
                                  <td  bgcolor="#FFFFFF"><div align="center">
              ...
              <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">1~5</div></td>
                                       <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_z_51" type="text" id="subtotal_z_51"  size="10" maxlength="10"  onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="performance.subtotal_z_51"/>' >
                      </div></td> 
                                      <td  bgcolor="#FFFFFF"><div align="center">
              ...
              <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">1~5</div></td>
                                        <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_z_18" type="text" id="subtotal_z_18"  size="10" maxlength="10"  onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN"  value='<s:property value="performance.subtotal_z_18"/>' >
                      </div></td>
                                   <td  bgcolor="#FFFFFF"><div align="center">
              ...
              <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">-5</div></td>
                                        <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_z_19" type="text" id="subtotal_z_19"  size="10" maxlength="10"   onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="performance.subtotal_z_19"/>' >
                      </div></td>
                                  <td  bgcolor="#FFFFFF"><div align="center">
              ...
              <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">-10</div></td>
                                        <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_z_20" type="text" id="subtotal_z_20"  size="10" maxlength="10" onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN"  value='<s:property value="performance.subtotal_z_20"/>'>
                      </div></td>
                                 <td  bgcolor="#FFFFFF"><div align="center">
              ...
              <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">1~5</div></td>
                                        <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_z_21" type="text" id="subtotal_z_21"  size="10" maxlength="10"  onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN"  value='<s:property value="performance.subtotal_z_21"/>' >
                      </div></td>
                                  <td  bgcolor="#FFFFFF"><div align="center">
              ...
              <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">-5</div></td>
                                                       <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_z_22" type="text" id="subtotal_z_22"  size="10" maxlength="10"  onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN"  value='<s:property value="performance.subtotal_z_22"/>'>
                      </div></td>
                                   <td  bgcolor="#FFFFFF"><div align="center">
              ...
              <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">-3</div></td>
                                                       <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_z_23" type="text" id="subtotal_z_23"size="10" maxlength="10"  onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="performance.subtotal_z_23"/>' >
                      </div></td>
                                  <td  bgcolor="#FFFFFF"><div align="center">
              ...
              <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">5~10</div></td>
                                                       <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_z_24" type="text" id="subtotal_z_24"  size="10" maxlength="10"  onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN"  value='<s:property value="performance.subtotal_z_24"/>' >
                      </div></td>
                                  <td  bgcolor="#FFFFFF"><div align="center">
              ...
              <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">-5~-10</div></td>
                                                       <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_z_25" type="text" id="subtotal_z_25"  size="10" maxlength="10"  onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN"  value='<s:property value="performance.subtotal_z_25"/>' >
                      </div></td>
                                 <td  bgcolor="#FFFFFF"><div align="center">
              ...
              <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">-5</div></td>
                                                       <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_z_26" type="text" id="subtotal_z_26"size="10" maxlength="10" onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN"  value='<s:property value="performance.subtotal_z_26"/>'>
                      </div></td>
                                 <td  bgcolor="#FFFFFF"><div align="center">
              ...
              <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">2~5</div></td>
                                                       <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_z_27" type="text" id="subtotal_z_27"  size="10" maxlength="10" onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN"  value='<s:property value="performance.subtotal_z_27"/>' >
                      </div></td>
                                  <td  bgcolor="#FFFFFF"><div align="center">
              ...
              <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">-3</div></td>
                                                       <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_z_28" type="text" id="subtotal_z_28"  size="10" maxlength="10"  onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN"  value='<s:property value="performance.subtotal_z_28"/>' >
                      </div></td>
                                 <td  bgcolor="#FFFFFF"><div align="center">
              ...
              <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">-5</div></td>
                                                       <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_z_29" type="text" id="subtotal_z_29" size="10" maxlength="10"  onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN"  value='<s:property value="performance.subtotal_z_29"/>'>
                      </div></td>
                                  <td  bgcolor="#FFFFFF"><div align="center">
              ...
              <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">2~5</div></td>
                                                       <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_z_30" type="text" id="subtotal_z_30"size="10" maxlength="10" onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN"  value='<s:property value="performance.subtotal_z_30"/>' >
                      </div></td>
                 <td  bgcolor="#FFFFFF"><div align="center">
              ...
              <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">5~10</div></td>
                 <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_z_31" type="text" id="subtotal_z_31" size="10" maxlength="10"  onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN"  value='<s:property value="performance.subtotal_z_31"/>' >
                      </div></td>
                   <td  bgcolor="#FFFFFF"><div align="center">
              ...
              <tr>
                ...
                <td width="7%" rowspan="23"  bgcolor="#FFFFFF"><div align="center">其他（10）</div>
                    <div align="center"></div></td>
                ...
                <td  bgcolor="#FFFF00"><div align="center">10<font color="#FF0000">*</font></div></td>
                 <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_z_32" type="text" id="subtotal_z_32" size="10" maxlength="10" onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN"  value='<s:property value="performance.subtotal_z_32"/>' >
                      </div></td>
          <td  bgcolor="#FFFFFF"><div align="center">
              ...
              <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">价值分合计/3</div></td>
                 <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_z_33" type="text" id="subtotal_z_33" size="10" maxlength="10" onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN"  value='<s:property value="performance.subtotal_z_33"/>' >
                      </div></td>
                  <td  bgcolor="#FFFFFF"><div align="center">
              ...
              <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">效果分合计/3</div></td>
                 <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_z_34" type="text" id="subtotal_z_34" size="10" maxlength="10"  onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN"  value='<s:property value="performance.subtotal_z_34"/>' >
                      </div></td>
                  <td  bgcolor="#FFFFFF"><div align="center">
              ...
              <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">-(不写日志天数合计/3)</div></td>
                 <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_z_35" type="text" id="subtotal_z_35"  size="10" maxlength="10"  onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="performance.subtotal_z_35"/>'>
                      </div></td>
                  <td  bgcolor="#FFFFFF"><div align="center">
  ...
  <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">1~3</div></td>
                 <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_z_36" type="text" id="subtotal_z_36" size="10" maxlength="10"  onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN"  value='<s:property value="performance.subtotal_z_36"/>'>
                      </div></td>
                   <td  bgcolor="#FFFFFF"><div align="center">
              ...
              <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">-1/次</div></td>
                 <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_z_37" type="text" id="subtotal_z_37"  size="10" maxlength="10"   onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN" v value='<s:property value="performance.subtotal_z_37"/>'>
                      </div></td>
                   <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_d_37" type="text" id="subtotal_d_37" class="bgg" size="10" maxlength="10"alue='<s:property value="performance.subtotal_d_37"/>'  readonly="readonly">
                      </div></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
              ...
              <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">-3</div></td>
                 <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_z_38" type="text" id="subtotal_z_38" size="10" maxlength="10"   onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN"  value='<s:property value="performance.subtotal_z_38"/>' >
                      </div></td>
                  <td  bgcolor="#FFFFFF"><div align="center">
              ...
              <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">-1/个</div></td>
                 <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_z_39" type="text" id="subtotal_z_39"  size="10" maxlength="10"  onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN"  value='<s:property value="performance.subtotal_z_39"/>' >
                      </div></td>
                 <td  bgcolor="#FFFFFF"><div align="center">
              ...
              <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">3</div></td>
                 <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_z_40" type="text" id="subtotal_z_40" size="10" maxlength="10"  onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN"  value='<s:property value="performance.subtotal_z_40"/>'>
                      </div></td>
                 <td  bgcolor="#FFFFFF"><div align="center">
              ...
              <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">-2</div></td>
                                 <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_z_41" type="text" id="subtotal_z_41" size="10" maxlength="10" onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN"  value='<s:property value="performance.subtotal_z_41"/>' >
                      </div></td>
                   <td  bgcolor="#FFFFFF"><div align="center">
              ...
              <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">-2</div></td>
                                 <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_z_42" type="text" id="subtotal_z_42" size="10" maxlength="10"  onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN"  value='<s:property value="performance.subtotal_z_42"/>'>
                      </div></td>
                   <td  bgcolor="#FFFFFF"><div align="center">
              ...
              <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">-3</div></td>
                                 <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_z_43" type="text" id="subtotal_z_43" size="10" maxlength="10"  onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN"  value='<s:property value="performance.subtotal_z_43"/>' >
                      </div></td>
                   <td  bgcolor="#FFFFFF"><div align="center">
              ...
              <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">-3</div></td>
                                 <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_z_44" type="text" id="subtotal_z_44" size="10" maxlength="10" onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN"  value='<s:property value="performance.subtotal_z_44"/>' >
                      </div></td>
                   <td  bgcolor="#FFFFFF"><div align="center">
              ...
              <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">0.5~3分/资料</div></td>
                                 <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_z_45" type="text" id="subtotal_z_45" size="10" maxlength="10"  onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="performance.subtotal_z_45"/>' >
                      </div></td>
                   <td  bgcolor="#FFFFFF"><div align="center">
              ...
              <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">－5～-2分/资料</div></td>
                                 <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_z_46" type="text" id="subtotal_z_46"  size="10" maxlength="10"  onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="performance.subtotal_z_46"/>' >
                      </div></td>
                   <td  bgcolor="#FFFFFF"><div align="center">
              ...
              <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">-3/次</div></td>
                                 <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_z_47" type="text" id="subtotal_z_47"  size="10" maxlength="10"  onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN"  value='<s:property value="performance.subtotal_z_47"/>' >
                      </div></td>
                   <td  bgcolor="#FFFFFF"><div align="center">
              ...
              <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">-1~-5</div></td>
                                 <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_z_48" type="text" id="subtotal_z_48"  size="10" maxlength="10" onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN"  value='<s:property value="performance.subtotal_z_48"/>' >
                      </div></td>
                   <td  bgcolor="#FFFFFF"><div align="center">
                ...
                <td  bgcolor="#FFFFFF"><div align="center">1~5</div></td>
                                 <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_z_49" type="text" id="subtotal_z_49" size="10" maxlength="10"   onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN"  value='<s:property value="performance.subtotal_z_49"/>' >
                      </div></td>
                   <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_d_49" type="text" id="subtotal_d_49"  class="bgg"  size="10" maxlength="10" value='<s:property value="performance.subtotal_d_49"/>' readonly="readonly">
                      </div></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
                ...
                <td  bgcolor="#FFFFFF"><div align="center">-3</div></td>
                                 <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_z_50" type="text" id="subtotal_z_50" size="10" maxlength="10"   onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="performance.subtotal_z_50"/>' >
                      </div></td>
                   <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_d_50" type="text" id="subtotal_d_50" class="bgg"  size="10" maxlength="10"  value='<s:property value="performance.subtotal_d_50"/>' readonly="readonly">
                      </div></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
                ...
                <td  bgcolor="#FFFFFF"><div align="center">3</div></td>
                               <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_z_17" type="text" id="subtotal_z_17"  size="10" maxlength="10"  onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN"  value='<s:property value="performance.subtotal_z_17"/>' >
                      </div></td>
                   <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_d_17" type="text" id="subtotal_d_17" class="bgg" size="10" maxlength="10" value='<s:property value="performance.subtotal_d_17"/>' readonly="readonly">
                      </div></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
                ...
                <td  bgcolor="#FFFFFF"><div align="center">1~5</div></td>
                               <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_z_52" type="text" id="subtotal_z_52" size="10" maxlength="10"  onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN"  value='<s:property value="performance.subtotal_z_52"/>' >
                      </div></td>
                   <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_d_52" type="text" id="subtotal_d_52" class="bgg" size="10" maxlength="10" value='<s:property value="performance.subtotal_d_52"/>' readonly="readonly">
                      </div></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
                ...
                <td  bgcolor="#FFFFFF"><div align="center">1~5</div></td>
                               <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_z_53" type="text" id="subtotal_z_53" size="10" maxlength="10"   onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN"  value='<s:property value="performance.subtotal_z_53"/>' >
                      </div></td>
                   <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_d_53" type="text" id="subtotal_d_53" class="bgg"  size="10" maxlength="10"value='<s:property value="performance.subtotal_d_53"/>' readonly="readonly">
                      </div></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
                ...
                <td  bgcolor="#FFFFFF"><div align="center">1~3</div></td>
                               <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_z_54" type="text" id="subtotal_z_54"  size="10" maxlength="10" onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN"  value='<s:property value="performance.subtotal_z_54"/>' >
                      </div></td>
                   <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_d_54" type="text" id="subtotal_d_54" class="bgg" size="10" maxlength="10" value='<s:property value="performance.subtotal_d_54"/>' readonly="readonly">
                      </div></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
      ...
      <tr>
          ...
          <td   bgcolor="#FFFFFF"><div align="left"><input name="performance.add_project" type="text" id="add_project"
                ...
                <td  bgcolor="#FFFFFF"><div align="center">1~10</div></td>
                 <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_z_55" type="text" id="subtotal_z_55" size="10" maxlength="10" onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN"  value='<s:property value="performance.subtotal_z_55"/>' >
                      </div></td>
          <td  bgcolor="#FFFFFF"><div align="center">
  ...
  <tr>
                ...
                <td width="7%" bgcolor="#FFFFFF"><div align="center">特别<span class="STYLE2">扣分</span>项</div>
          <div align="center"></div></td>
          <td   bgcolor="#FFFFFF"><div align="left"><input name="performance.sub_project" type="text" id="sub_project"
                ...
                <td  bgcolor="#FFFFFF"><div align="center">-1~-10</div></td>
                 <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_z_56" type="text" id="subtotal_z_56" size="10" maxlength="10" onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN"  value='<s:property value="performance.subtotal_z_56"/>' >
                      </div></td>
          <td  bgcolor="#FFFFFF"><div align="center">
           ...
           <td bgcolor="#FFFFFF"><div align="center">评语</div></td>
           	<td bgcolor="#FFFFFF" colspan="8"><div >
											<textarea cols="133" rows="3" name="performance.remark"
												id="remark"  class="bgg" readonly="readonly"><s:property value="performance.remark"/></textarea>
										</div></td>
     <script type="text/javascript">
