...
-->
	...
	<script type="text/javascript">
		...
		function save(){           
			...
			if(document.getElementById("subtotal_m_1").value==0)
			{
				alert("请给任务类比第一项细则评分");
				return;
			}
			if(document.getElementById("subtotal_m_2").value==0)
			{
				alert("请给任务类第二项细则评分");
				return;
			}			
			if(document.getElementById("subtotal_m_3").value==0)
			{
				alert("请给任务类第三项细则评分");
				return;
			}
		    if(document.getElementById("subtotal_m_4").value==0)
			{
				alert("请给时效类第一项细则评分");
				return;
			}
			if(document.getElementById("subtotal_m_8").value==0)
			{
				alert("请给质量类第一项细则评分");
				return;
			}
			if(document.getElementById("subtotal_m_13").value==0)
			{
				alert("请给过程类第一项细则评分");
				return;
			}
			if(document.getElementById("subtotal_m_14").value==0)
			{
				alert("请给过程类第二项细则评分");
				return;
			}
			if(document.getElementById("subtotal_m_15").value==0)
			{
				alert("请给过程类第三项细则评分");
				return;
			}
			if(document.getElementById("subtotal_m_32").value==0)
			{
				alert("请给其他类第一项细则评分");
				return;
			}
	...
	String.prototype.trim = function()
	{
		...
		function numClear(itemName){
			...
			document.getElementById("performance.subtotal_m").value = 0;
			document.getElementById("performance.subtotal_s").value = 0;
			ret1 = parseFloat(document.getElementById("performance.subtotal_m_1").value) + parseFloat(document.getElementById("performance.subtotal_m_2").value)+ parseFloat(document.getElementById("performance.subtotal_m_3").value) + parseFloat(document.getElementById("performance.subtotal_m_4").value) + parseFloat(document.getElementById("performance.subtotal_m_5").value) + parseFloat(document.getElementById("performance.subtotal_m_6").value) + parseFloat(document.getElementById("performance.subtotal_m_7").value) + parseFloat(document.getElementById("performance.subtotal_m_8").value) + parseFloat(document.getElementById("performance.subtotal_m_9").value) + parseFloat(document.getElementById("performance.subtotal_m_10").value);
			ret2 = parseFloat(document.getElementById("performance.subtotal_m_11").value) + parseFloat(document.getElementById("performance.subtotal_m_12").value)+ parseFloat(document.getElementById("performance.subtotal_m_13").value) + parseFloat(document.getElementById("performance.subtotal_m_14").value) + parseFloat(document.getElementById("performance.subtotal_m_15").value) + parseFloat(document.getElementById("performance.subtotal_m_16").value) + parseFloat(document.getElementById("performance.subtotal_m_17").value) + parseFloat(document.getElementById("performance.subtotal_m_18").value) + parseFloat(document.getElementById("performance.subtotal_m_19").value) + parseFloat(document.getElementById("performance.subtotal_m_20").value);
			ret3 = parseFloat(document.getElementById("performance.subtotal_m_21").value) + parseFloat(document.getElementById("performance.subtotal_m_22").value)+ parseFloat(document.getElementById("performance.subtotal_m_23").value) + parseFloat(document.getElementById("performance.subtotal_m_24").value) + parseFloat(document.getElementById("performance.subtotal_m_25").value) + parseFloat(document.getElementById("performance.subtotal_m_26").value) + parseFloat(document.getElementById("performance.subtotal_m_27").value) + parseFloat(document.getElementById("performance.subtotal_m_28").value) + parseFloat(document.getElementById("performance.subtotal_m_29").value) + parseFloat(document.getElementById("performance.subtotal_m_30").value);
			ret4 = parseFloat(document.getElementById("performance.subtotal_m_31").value) + parseFloat(document.getElementById("performance.subtotal_m_32").value)+ parseFloat(document.getElementById("performance.subtotal_m_33").value) + parseFloat(document.getElementById("performance.subtotal_m_34").value) + parseFloat(document.getElementById("performance.subtotal_m_35").value) + parseFloat(document.getElementById("performance.subtotal_m_36").value) + parseFloat(document.getElementById("performance.subtotal_m_37").value) + parseFloat(document.getElementById("performance.subtotal_m_38").value) + parseFloat(document.getElementById("performance.subtotal_m_39").value) + parseFloat(document.getElementById("performance.subtotal_m_40").value);
			ret5 = parseFloat(document.getElementById("performance.subtotal_m_41").value) + parseFloat(document.getElementById("performance.subtotal_m_42").value)+ parseFloat(document.getElementById("performance.subtotal_m_43").value) + parseFloat(document.getElementById("performance.subtotal_m_44").value) + parseFloat(document.getElementById("performance.subtotal_m_45").value) + parseFloat(document.getElementById("performance.subtotal_m_46").value) + parseFloat(document.getElementById("performance.subtotal_m_47").value) + parseFloat(document.getElementById("performance.subtotal_m_48").value) + parseFloat(document.getElementById("performance.subtotal_m_49").value) + parseFloat(document.getElementById("performance.subtotal_m_50").value)+ parseFloat(document.getElementById("performance.subtotal_m_51").value)+ parseFloat(document.getElementById("performance.subtotal_m_52").value)+ parseFloat(document.getElementById("performance.subtotal_m_53").value)+ parseFloat(document.getElementById("performance.subtotal_m_54").value)+ parseFloat(document.getElementById("performance.subtotal_m_55").value)+ parseFloat(document.getElementById("performance.subtotal_m_56").value);
			document.getElementById("performance.subtotal_m").value = ret1+ ret2 + ret3 + ret4 + ret5;
			if(parseFloat(document.getElementById("performance.subtotal_d").value) != 0)
			{
			...
			{
				document.getElementById("performance.subtotal_s").value = parseFloat(document.getElementById("performance.subtotal_m").value);
			}
		}
	...
	<body id="bodyid" leftmargin="0" topmargin="10">
		<form name="reportInfoForm"
			...
			method="post">
              ...
              <input type="hidden" name="UserUnAudit" id="UserUnAudit" value='<s:property value="UserUnAudit"/>'>
        ...
        <table width="98%" align="center" border="0" cellspacing="1"
              ...
              <tr>
                ...
                <td colspan="2" bgcolor="#FFFFFF"><input name="month_date" type="text" style="border:0" id="month_date" value='<s:property value="performance.month_date"/>' size="10" readonly="readonly">                </td>
                <td width="10%" align="center" bgcolor="#999999"><div align="center"> 考核人 </div></td>
                <td colspan="5"  bgcolor="#FFFFFF"><input name="user_id" type="text" style="border:0" id="user_id" value='<s:property value="performance.user_id"/>' size="10"  maxlength="20" readonly>                </td>
              </tr>
              <tr>
              ...
              <tr>
                <td width="7%" bgcolor="#FFFFFF"><div align="center">1</div></td>
                <td width="7%" rowspan="3"  bgcolor="#FFFFFF"><div align="center">任务（30）</div>
                    <div align="center"></div></td>
                <td   bgcolor="#FFFFFF"><div align="left"> 较易:5~14；  &nbsp;&nbsp;正常:15；  &nbsp;&nbsp;较难:16~20；  &nbsp;&nbsp;很难:21~30 </div></td>
                <td width="10%" bgcolor="#FFFF00"><div align="center">5~30 (正常:15)<font color="#FF0000">*</font></div></td>
...
<td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_d_1" type="text" id="subtotal_d_1"  class="bgg" size="10" maxlength="10" value='<s:property value="performance.subtotal_d_1"/>' readonly="readonly">
                      </div></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_m_1" type="text" id="subtotal_m_1" size="10" maxlength="10" onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="performance.subtotal_m_1"/>'>
                      </div></td>
          ...
          <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_d_2" type="text" id="subtotal_d_2"  class="bgg" size="10" maxlength="10" value='<s:property value="performance.subtotal_d_2"/>' readonly="readonly">
                      </div></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_m_2" type="text" id="subtotal_m_2" size="10" maxlength="10" onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="performance.subtotal_m_2"/>'>
                      </div></td>
                      <td colspan="2"  bgcolor="#FFFFFF"><div align="center">
...
<td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_d_3" type="text" id="subtotal_d_3" class="bgg" size="10" maxlength="10" value='<s:property value="performance.subtotal_d_3"/>' readonly="readonly">
                      </div></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_m_3" type="text" id="subtotal_m_3" size="10" maxlength="10" onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="performance.subtotal_m_3"/>'>
                      </div></td>
                      <td colspan="2"  bgcolor="#FFFFFF"><div align="center">
          ...
          <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_d_4" type="text" id="subtotal_d_4"  class="bgg" size="10" maxlength="10" value='<s:property value="performance.subtotal_d_4"/>' readonly="readonly">
                      </div></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_m_4" type="text" id="subtotal_m_4" size="10" maxlength="10" onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="performance.subtotal_m_4"/>'>
                      </div></td>
                      <td colspan="2"  bgcolor="#FFFFFF"><div align="center">
              ...
              <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">2~8</div></td>
                        ...
                        <input name="performance.subtotal_z_5" type="text" id="subtotal_z_5"  class="bgg" size="10" maxlength="10" value='<s:property value="performance.subtotal_z_5"/>' readonly="readonly">
                                 ...
                                 <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_d_5" type="text" id="subtotal_d_5" class="bgg" size="10" maxlength="10" value='<s:property value="performance.subtotal_d_5"/>' readonly="readonly">
                      </div></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_m_5" type="text" id="subtotal_m_5" size="10" maxlength="10" onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="performance.subtotal_m_5"/>'>
                      </div></td>
                      <td colspan="2"  bgcolor="#FFFFFF"><div align="center">
              ...
              <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">5</div></td>
                        ...
                        <input name="performance.subtotal_z_6" type="text" id="subtotal_z_6"  class="bgg" size="10" maxlength="10" value='<s:property value="performance.subtotal_z_6"/>' readonly="readonly">
                                             ...
                                             <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_d_6" type="text" id="subtotal_d_6" class="bgg" size="10" maxlength="10" value='<s:property value="performance.subtotal_d_6"/>' readonly="readonly">
                      </div></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_m_6" type="text" id="subtotal_m_6" size="10" maxlength="10" onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="performance.subtotal_m_6"/>'>
                      </div></td>
                      <td colspan="2"  bgcolor="#FFFFFF"><div align="center">
              ...
              <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">-5</div></td>
                        ...
                        <input name="performance.subtotal_z_7" type="text" id="subtotal_z_7"  class="bgg" size="10" maxlength="10" value='<s:property value="performance.subtotal_z_7"/>' readonly="readonly">
                                                                    ...
                                                                    <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_d_7" type="text" id="subtotal_d_7" class="bgg" size="10" maxlength="10" value='<s:property value="performance.subtotal_d_7"/>' readonly="readonly">
                      </div></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_m_7" type="text" id="subtotal_m_7" size="10" maxlength="10" onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="performance.subtotal_m_7"/>'>
                      </div></td>
                      <td colspan="2"  bgcolor="#FFFFFF"><div align="center">
              ...
              <tr>
                ...
                <td  rowspan="5"  bgcolor="#FFFFFF"><div align="center">质量（20）</div>
                    <div align="center"></div></td>
          ...
          <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_d_8" type="text" id="subtotal_d_8" class="bgg" size="10" maxlength="10" value='<s:property value="performance.subtotal_d_8"/>' readonly="readonly">
                      </div></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_m_8" type="text" id="subtotal_m_8" size="10" maxlength="10" onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="performance.subtotal_m_8"/>'>
                      </div></td>
                      <td colspan="2"  bgcolor="#FFFFFF"><div align="center">
              ...
              <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">5</div></td>
                        ...
                        <input name="performance.subtotal_z_9" type="text" id="subtotal_z_9"  class="bgg" size="10" maxlength="10" value='<s:property value="performance.subtotal_z_9"/>' readonly="readonly">
                                                                       ...
                                                                       <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_d_9" type="text" id="subtotal_d_9" class="bgg" size="10" maxlength="10" value='<s:property value="performance.subtotal_d_9"/>' readonly="readonly">
                      </div></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_m_9" type="text" id="subtotal_m_9" size="10" maxlength="10" onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="performance.subtotal_m_9"/>'>
                      </div></td>
                      <td colspan="2"  bgcolor="#FFFFFF"><div align="center">
              ...
              <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">-5</div></td>
                        ...
                        <input name="performance.subtotal_z_10" type="text" id="subtotal_z_10"  class="bgg" size="10" maxlength="10" value='<s:property value="performance.subtotal_z_10"/>' readonly="readonly">
                                                                   ...
                                                                   <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_d_10" type="text" id="subtotal_d_10"  class="bgg" size="10" maxlength="10" value='<s:property value="performance.subtotal_d_10"/>' readonly="readonly">
                      </div></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_m_10" type="text" id="subtotal_m_10" size="10" maxlength="10" onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="performance.subtotal_m_10"/>'>
                      </div></td>
                      <td colspan="2"  bgcolor="#FFFFFF"><div align="center">
              ...
              <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">1~10</div></td>
                        ...
                        <input name="performance.subtotal_z_11" type="text" id="subtotal_z_11"  class="bgg" size="10" maxlength="10" value='<s:property value="performance.subtotal_z_11"/>' readonly="readonly">
                                                        ...
                                                        <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_d_11" type="text" id="subtotal_d_11"  class="bgg" size="10" maxlength="10" value='<s:property value="performance.subtotal_d_11"/>' readonly="readonly">
                      </div></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_m_11" type="text" id="subtotal_m_11" size="10" maxlength="10" onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="performance.subtotal_m_11"/>'>
                      </div></td>
                      <td colspan="2"  bgcolor="#FFFFFF"><div align="center">
              ...
              <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">-3</div></td>
                        ...
                        <input name="performance.subtotal_z_12" type="text" id="subtotal_z_12"  class="bgg" size="10" maxlength="10" value='<s:property value="performance.subtotal_z_12"/>' readonly="readonly">
                                                     ...
                                                     <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_d_12" type="text" id="subtotal_d_12"  class="bgg" size="10" maxlength="10" value='<s:property value="performance.subtotal_d_12"/>' readonly="readonly">
                      </div></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_m_12" type="text" id="subtotal_m_12" size="10" maxlength="10" onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="performance.subtotal_m_12"/>'>
                      </div></td>
                      <td colspan="2"  bgcolor="#FFFFFF"><div align="center">
          ...
          <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_d_13" type="text" id="subtotal_d_13" class="bgg" size="10" maxlength="10" value='<s:property value="performance.subtotal_d_13"/>' readonly="readonly">
                      </div></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_m_13" type="text" id="subtotal_m_13" size="10" maxlength="10" onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="performance.subtotal_m_13"/>'>
                      </div></td>
                      <td colspan="2"  bgcolor="#FFFFFF"><div align="center">
...
<td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_d_14" type="text" id="subtotal_d_14" class="bgg" size="10" maxlength="10" value='<s:property value="performance.subtotal_d_14"/>' readonly="readonly">
                      </div></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_m_14" type="text" id="subtotal_m_14" size="10" maxlength="10" onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="performance.subtotal_m_14"/>'>
                      </div></td>
                      <td colspan="2"  bgcolor="#FFFFFF"><div align="center">
          ...
          <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_d_15" type="text" id="subtotal_d_15" class="bgg" size="10" maxlength="10" value='<s:property value="performance.subtotal_d_15"/>' readonly="readonly">
                      </div></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_m_15" type="text" id="subtotal_m_15" size="10" maxlength="10" onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="performance.subtotal_m_15"/>'>
                      </div></td>
                      <td colspan="2"  bgcolor="#FFFFFF"><div align="center">
              ...
              <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">测试管理平台中分值</div></td>
                        ...
                        <input name="performance.subtotal_z_16" type="text" id="subtotal_z_16"  class="bgg" size="10" maxlength="10" value='<s:property value="performance.subtotal_z_16"/>' readonly="readonly">
                                  ...
                                  <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_d_16" type="text" id="subtotal_d_16" class="bgg" size="10" maxlength="10" value='<s:property value="performance.subtotal_d_16"/>' readonly="readonly">
                      </div></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_m_16" type="text" id="subtotal_m_16" size="10" maxlength="10" onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="performance.subtotal_m_16"/>'>
                      </div></td>
                      <td colspan="2"  bgcolor="#FFFFFF"><div align="center">
              ...
              <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">1~5</div></td>
                        ...
                        <input name="performance.subtotal_z_51" type="text" id="subtotal_z_51"  class="bgg" size="10" maxlength="10" value='<s:property value="performance.subtotal_z_51"/>' readonly="readonly">
                                      ...
                                      <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_d_51" type="text" id="subtotal_d_51" class="bgg" size="10" maxlength="10" value='<s:property value="performance.subtotal_d_51"/>' readonly="readonly">
                      </div></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_m_51" type="text" id="subtotal_m_51" size="10" maxlength="10" onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="performance.subtotal_m_51"/>'>
                      </div></td>
                      <td colspan="2"  bgcolor="#FFFFFF"><div align="center">
              ...
              <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">5</div></td>
                        ...
                        <input name="performance.subtotal_z_18" type="text" id="subtotal_z_18"  class="bgg" size="10" maxlength="10" value='<s:property value="performance.subtotal_z_18"/>' readonly="readonly">
                                   ...
                                   <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_d_18" type="text" id="subtotal_d_18" class="bgg" size="10" maxlength="10" value='<s:property value="performance.subtotal_d_18"/>' readonly="readonly">
                      </div></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_m_18" type="text" id="subtotal_m_18" size="10" maxlength="10" onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="performance.subtotal_m_18"/>'>
                      </div></td>
                      <td colspan="2"  bgcolor="#FFFFFF"><div align="center">
              ...
              <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">-5</div></td>
                        ...
                        <input name="performance.subtotal_z_19" type="text" id="subtotal_z_19"  class="bgg" size="10" maxlength="10" value='<s:property value="performance.subtotal_z_19"/>' readonly="readonly">
                                  ...
                                  <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_d_19" type="text" id="subtotal_d_19"  class="bgg" size="10" maxlength="10" value='<s:property value="performance.subtotal_d_19"/>' readonly="readonly">
                      </div></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_m_19" type="text" id="subtotal_m_19" size="10" maxlength="10" onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="performance.subtotal_m_19"/>'>
                      </div></td>
                      <td colspan="2"  bgcolor="#FFFFFF"><div align="center">
              ...
              <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">-10</div></td>
                        ...
                        <input name="performance.subtotal_z_20" type="text" id="subtotal_z_20"  class="bgg" size="10" maxlength="10" value='<s:property value="performance.subtotal_z_20"/>' readonly="readonly">
                                 ...
                                 <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_d_20" type="text" id="subtotal_d_20" class="bgg" size="10" maxlength="10" value='<s:property value="performance.subtotal_d_20"/>' readonly="readonly">
                      </div></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_m_20" type="text" id="subtotal_m_20" size="10" maxlength="10" onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="performance.subtotal_m_20"/>'>
                      </div></td>
                      <td colspan="2"  bgcolor="#FFFFFF"><div align="center">
              ...
              <tr>
                ...
                <td   bgcolor="#FFFFFF"><div align="left">在开发人员不愿意解决的情况下，能及时向直属上司反应问题并协助问题的解决</div></td>
                <td  bgcolor="#FFFFFF"><div align="center">8</div></td>
                                                <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_z_21" type="text" id="subtotal_z_21"  class="bgg" size="10" maxlength="10" value='<s:property value="performance.subtotal_z_21"/>' readonly="readonly">
                                  ...
                                  <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_d_21" type="text" id="subtotal_d_21" class="bgg" size="10" maxlength="10" value='<s:property value="performance.subtotal_d_21"/>' readonly="readonly">
                      </div></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_m_21" type="text" id="subtotal_m_21" size="10" maxlength="10" onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="performance.subtotal_m_21"/>'>
                      </div></td>
                      <td colspan="2"  bgcolor="#FFFFFF"><div align="center">
              ...
              <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">-5</div></td>
                        ...
                        <input name="performance.subtotal_z_22" type="text" id="subtotal_z_22"  class="bgg" size="10" maxlength="10" value='<s:property value="performance.subtotal_z_22"/>' readonly="readonly">
                                   ...
                                   <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_d_22" type="text" id="subtotal_d_22" class="bgg" size="10" maxlength="10" value='<s:property value="performance.subtotal_d_22"/>' readonly="readonly">
                      </div></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_m_22" type="text" id="subtotal_m_22" size="10" maxlength="10" onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="performance.subtotal_m_22"/>'>
                      </div></td>
                      <td colspan="2"  bgcolor="#FFFFFF"><div align="center">
              ...
              <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">-3</div></td>
                        ...
                        <input name="performance.subtotal_z_23" type="text" id="subtotal_z_23"  class="bgg" size="10" maxlength="10" value='<s:property value="performance.subtotal_z_23"/>' readonly="readonly">
                                  ...
                                  <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_d_23" type="text" id="subtotal_d_23" class="bgg" size="10" maxlength="10" value='<s:property value="performance.subtotal_d_23"/>' readonly="readonly">
                      </div></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_m_23" type="text" id="subtotal_m_23" size="10" maxlength="10" onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="performance.subtotal_m_23"/>'>
                      </div></td>
                      <td colspan="2"  bgcolor="#FFFFFF"><div align="center">
              ...
              <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">5~10</div></td>
                        ...
                        <input name="performance.subtotal_z_24" type="text" id="subtotal_z_24"  class="bgg" size="10" maxlength="10" value='<s:property value="performance.subtotal_z_24"/>' readonly="readonly">
                                  ...
                                  <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_d_24" type="text" id="subtotal_d_24" class="bgg" size="10" maxlength="10" value='<s:property value="performance.subtotal_d_24"/>' readonly="readonly">
                      </div></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_m_24" type="text" id="subtotal_m_24" size="10" maxlength="10" onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="performance.subtotal_m_24"/>'>
                      </div></td>
                      <td colspan="2"  bgcolor="#FFFFFF"><div align="center">
              ...
              <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">-5~-10</div></td>
                        ...
                        <input name="performance.subtotal_z_25" type="text" id="subtotal_z_25"  class="bgg" size="10" maxlength="10" value='<s:property value="performance.subtotal_z_25"/>' readonly="readonly">
                                 ...
                                 <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_d_25" type="text" id="subtotal_d_25" class="bgg" size="10" maxlength="10" value='<s:property value="performance.subtotal_d_25"/>' readonly="readonly">
                      </div></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_m_25" type="text" id="subtotal_m_25" size="10" maxlength="10" onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="performance.subtotal_m_25"/>'>
                      </div></td>
                      <td colspan="2"  bgcolor="#FFFFFF"><div align="center">
              ...
              <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">-5</div></td>
                        ...
                        <input name="performance.subtotal_z_26" type="text" id="subtotal_z_26"  class="bgg" size="10" maxlength="10" value='<s:property value="performance.subtotal_z_26"/>' readonly="readonly">
                                 ...
                                 <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_d_26" type="text" id="subtotal_d_26" class="bgg" size="10" maxlength="10" value='<s:property value="performance.subtotal_d_26"/>' readonly="readonly">
                      </div></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_m_26" type="text" id="subtotal_m_26" size="10" maxlength="10" onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="performance.subtotal_m_26"/>'>
                      </div></td>
                      <td colspan="2"  bgcolor="#FFFFFF"><div align="center">
              ...
              <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">2~5</div></td>
                        ...
                        <input name="performance.subtotal_z_27" type="text" id="subtotal_z_27"  class="bgg" size="10" maxlength="10" value='<s:property value="performance.subtotal_z_27"/>' readonly="readonly">
                                  ...
                                  <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_d_27" type="text" id="subtotal_d_27" class="bgg" size="10" maxlength="10" value='<s:property value="performance.subtotal_d_27"/>' readonly="readonly">
                      </div></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_m_27" type="text" id="subtotal_m_27" size="10" maxlength="10" onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="performance.subtotal_m_27"/>'>
                      </div></td>
                      <td colspan="2"  bgcolor="#FFFFFF"><div align="center">
              ...
              <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">-3</div></td>
                        ...
                        <input name="performance.subtotal_z_28" type="text" id="subtotal_z_28"  class="bgg" size="10" maxlength="10" value='<s:property value="performance.subtotal_z_28"/>' readonly="readonly">
                                 ...
                                 <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_d_28" type="text" id="subtotal_d_28" class="bgg" size="10" maxlength="10" value='<s:property value="performance.subtotal_d_28"/>' readonly="readonly">
                      </div></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_m_28" type="text" id="subtotal_m_28" size="10" maxlength="10" onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="performance.subtotal_m_28"/>'>
                      </div></td>
                      <td colspan="2"  bgcolor="#FFFFFF"><div align="center">
              ...
              <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">-5</div></td>
                        ...
                        <input name="performance.subtotal_z_29" type="text" id="subtotal_z_29"  class="bgg" size="10" maxlength="10" value='<s:property value="performance.subtotal_z_29"/>' readonly="readonly">
                                  ...
                                  <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_d_29" type="text" id="subtotal_d_29" class="bgg" size="10" maxlength="10" value='<s:property value="performance.subtotal_d_29"/>' readonly="readonly">
                      </div></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_m_29" type="text" id="subtotal_m_29" size="10" maxlength="10" onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="performance.subtotal_m_29"/>'>
                      </div></td>
                      <td colspan="2"  bgcolor="#FFFFFF"><div align="center">
              ...
              <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">2~5</div></td>
                 ...
                 <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_d_30" type="text" id="subtotal_d_30" class="bgg" size="10" maxlength="10" value='<s:property value="performance.subtotal_d_30"/>' readonly="readonly">
                      </div></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_m_30" type="text" id="subtotal_m_30" size="10" maxlength="10" onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="performance.subtotal_m_30"/>'>
                      </div></td>
                      <td colspan="2"  bgcolor="#FFFFFF"><div align="center">
              ...
              <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">
                   ...
                   <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_d_31" type="text" id="subtotal_d_31" class="bgg" size="10" maxlength="10" value='<s:property value="performance.subtotal_d_31"/>' readonly="readonly">
                      </div></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_m_31" type="text" id="subtotal_m_31" size="10" maxlength="10" onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="performance.subtotal_m_31"/>'>
                      </div></td>
                      <td colspan="2"  bgcolor="#FFFFFF"><div align="center">
          ...
          <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_d_32" type="text" id="subtotal_d_32" class="bgg" size="10" maxlength="10" value='<s:property value="performance.subtotal_d_32"/>' readonly="readonly">
                      </div></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_m_32" type="text" id="subtotal_m_32" size="10" maxlength="10" onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="performance.subtotal_m_32"/>'>
                      </div></td>
                      <td colspan="2"  bgcolor="#FFFFFF"><div align="center">
              ...
              <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">价值分合计/3</div></td>
                  ...
                  <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_d_33" type="text" id="subtotal_d_33" class="bgg" size="10" maxlength="10" value='<s:property value="performance.subtotal_d_33"/>' readonly="readonly">
                      </div></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_m_33" type="text" id="subtotal_m_33" size="10" maxlength="10" onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="performance.subtotal_m_33"/>'>
                      </div></td>
                      <td colspan="2"  bgcolor="#FFFFFF"><div align="center">
              ...
              <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">效果分合计/3</div></td>
                  ...
                  <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_d_34" type="text" id="subtotal_d_34" class="bgg" size="10" maxlength="10" value='<s:property value="performance.subtotal_d_34"/>' readonly="readonly">
                      </div></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_m_34" type="text" id="subtotal_m_34" size="10" maxlength="10" onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="performance.subtotal_m_34"/>'>
                      </div></td>
                      <td colspan="2"  bgcolor="#FFFFFF"><div align="center">
               <input name="performance.remark_34" type="text" id="remark_34" size="44" maxlength="44" value='<s:property value="performance.remark_34"/>'> </div></td> 
</tr>
              <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">-(不写日志天数合计/3)</div></td>
                  ...
                  <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_d_35" type="text" id="subtotal_d_35" class="bgg" size="10" maxlength="10" value='<s:property value="performance.subtotal_d_35"/>' readonly="readonly">
                      </div></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_m_35" type="text" id="subtotal_m_35" size="10" maxlength="10" onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="performance.subtotal_m_35"/>'>
                      </div></td>
                      <td colspan="2"  bgcolor="#FFFFFF"><div align="center">
            ...
            <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">1~3</div></td>
                   ...
                   <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_d_36" type="text" id="subtotal_d_36" class="bgg"  size="10" maxlength="10" value='<s:property value="performance.subtotal_d_36"/>' readonly="readonly">
                      </div></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_m_36" type="text" id="subtotal_m_36" size="10" maxlength="10" onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="performance.subtotal_m_36"/>'>
                      </div></td>
                      <td colspan="2"  bgcolor="#FFFFFF"><div align="center">
              ...
              <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">-1/次</div></td>
                   ...
                   <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_d_37" type="text" id="subtotal_d_37" class="bgg" size="10" maxlength="10" value='<s:property value="performance.subtotal_d_37"/>'readonly="readonly">
                      </div></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_m_37" type="text" id="subtotal_m_37"  size="10" maxlength="10" onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="performance.subtotal_m_37"/>'>
                      </div></td>
                      <td colspan="2"  bgcolor="#FFFFFF"><div align="center">
              ...
              <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">-3</div></td>
                  ...
                  <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_d_38" type="text" id="subtotal_d_38"  class="bgg" size="10" maxlength="10" value='<s:property value="performance.subtotal_d_38"/>' readonly="readonly">
                      </div></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_m_38" type="text" id="subtotal_m_38"   size="10" maxlength="10" onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="performance.subtotal_m_38"/>'>
                      </div></td>
                      <td colspan="2"  bgcolor="#FFFFFF"><div align="center">
              ...
              <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">
                 ...
                 <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_d_39" type="text" id="subtotal_d_39" class="bgg" size="10" maxlength="10" value='<s:property value="performance.subtotal_d_39"/>' readonly="readonly">
                      </div></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_m_39" type="text" id="subtotal_m_39"  size="10" maxlength="10" onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="performance.subtotal_m_39"/>' >
                      </div></td>
                      <td colspan="2"  bgcolor="#FFFFFF"><div align="center">
              ...
              <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">3</div></td>
                 ...
                 <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_d_40" type="text" id="subtotal_d_40" class="bgg" size="10" maxlength="10" value='<s:property value="performance.subtotal_d_40"/>' readonly="readonly">
                      </div></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_m_40" type="text" id="subtotal_m_40"  size="10" maxlength="10" onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="performance.subtotal_m_40"/>' >
                      </div></td>
                      <td colspan="2"  bgcolor="#FFFFFF"><div align="center">
              ...
              <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">-2</div></td>
                   ...
                   <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_d_41" type="text" id="subtotal_d_41" class="bgg" size="10" maxlength="10" value='<s:property value="performance.subtotal_d_41"/>' readonly="readonly">
                      </div></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_m_41" type="text" id="subtotal_m_41"   size="10" maxlength="10" onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="performance.subtotal_m_41"/>' >
                      </div></td>
                      <td colspan="2"  bgcolor="#FFFFFF"><div align="center">
              ...
              <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">-2</div></td>
                   ...
                   <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_d_42" type="text" id="subtotal_d_42" class="bgg" size="10" maxlength="10" value='<s:property value="performance.subtotal_d_42"/>' readonly="readonly">
                      </div></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_m_42" type="text" id="subtotal_m_42"   size="10" maxlength="10" onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="performance.subtotal_m_42"/>' >
                      </div></td>
                      <td colspan="2"  bgcolor="#FFFFFF"><div align="center">
              ...
              <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">-3</div></td>
                   ...
                   <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_d_43" type="text" id="subtotal_d_43" class="bgg" size="10" maxlength="10" value='<s:property value="performance.subtotal_d_43"/>' readonly="readonly">
                      </div></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_m_43" type="text" id="subtotal_m_43"   size="10" maxlength="10" onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="performance.subtotal_m_43"/>' >
                      </div></td>
                      <td colspan="2"  bgcolor="#FFFFFF"><div align="center">
              ...
              <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">-3</div></td>
                   ...
                   <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_d_44" type="text" id="subtotal_d_44" class="bgg" size="10" maxlength="10" value='<s:property value="performance.subtotal_d_44"/>' readonly="readonly">
                      </div></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_m_44" type="text" id="subtotal_m_44"  size="10" maxlength="10" onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="performance.subtotal_m_44"/>' >
                      </div></td>
                      <td colspan="2"  bgcolor="#FFFFFF"><div align="center">
              ...
              <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">0.5~3分/资料</div></td>
                   ...
                   <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_d_45" type="text" id="subtotal_d_45" class="bgg" size="10" maxlength="10" value='<s:property value="performance.subtotal_d_45"/>' readonly="readonly">
                      </div></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_m_45" type="text" id="subtotal_m_45"  size="10" maxlength="10" onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="performance.subtotal_m_45"/>' >
                      </div></td>
                      <td colspan="2"  bgcolor="#FFFFFF"><div align="center">
              ...
              <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">－5～-2分/资料</div></td>
                   ...
                   <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_d_46" type="text" id="subtotal_d_46" class="bgg" size="10" maxlength="10" value='<s:property value="performance.subtotal_d_46"/>' readonly="readonly">
                      </div></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_m_46" type="text" id="subtotal_m_46"  size="10" maxlength="10" onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="performance.subtotal_m_46"/>' >
                      </div></td>
                      <td colspan="2"  bgcolor="#FFFFFF"><div align="center">
              ...
              <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">-3/次</div></td>
                   ...
                   <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_d_47" type="text" id="subtotal_d_47" class="bgg" size="10" maxlength="10" value='<s:property value="performance.subtotal_d_47"/>' readonly="readonly">
                      </div></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_m_47" type="text" id="subtotal_m_47"   size="10" maxlength="10" onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="performance.subtotal_m_47"/>' >
                      </div></td>
                      <td colspan="2"  bgcolor="#FFFFFF"><div align="center">
              ...
              <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">-1~-5</div></td>
                   ...
                   <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_d_48" type="text" id="subtotal_d_48" class="bgg" size="10" maxlength="10" value='<s:property value="performance.subtotal_d_48"/>' readonly="readonly">
                      </div></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_m_48" type="text" id="subtotal_m_48"  size="10" maxlength="10" onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="performance.subtotal_m_48"/>' >
                      </div></td>
                      <td colspan="2"  bgcolor="#FFFFFF"><div align="center">
                ...
                <td  bgcolor="#FFFFFF"><div align="center">1~5</div></td>
                   ...
                   <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_d_49" type="text" id="subtotal_d_49" size="10"  class="bgg" maxlength="10" value='<s:property value="performance.subtotal_d_49"/>' readonly="readonly">
                      </div></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_m_49" type="text" id="subtotal_m_49" size="10"   maxlength="10" onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="performance.subtotal_m_49"/>' >
                      </div></td>
                      <td colspan="2"  bgcolor="#FFFFFF"><div align="center">
                ...
                <td  bgcolor="#FFFFFF"><div align="center">-3</div></td>
                   ...
                   <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_d_50" type="text" id="subtotal_d_50" size="10" class="bgg" maxlength="10" value='<s:property value="performance.subtotal_d_50"/>' readonly="readonly">
                      </div></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_m_50" type="text" id="subtotal_m_50" size="10"  maxlength="10" onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="performance.subtotal_m_50"/>' >
                      </div></td>
                      <td colspan="2"  bgcolor="#FFFFFF"><div align="center">
      ...
      <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">3</div></td>
                   ...
                   <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_d_17" type="text" id="subtotal_d_17" size="10" class="bgg" maxlength="10" value='<s:property value="performance.subtotal_d_17"/>' readonly="readonly">
                      </div></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_m_17" type="text" id="subtotal_m_17" size="10"  maxlength="10" onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="performance.subtotal_m_17"/>' >
                      </div></td>
                      <td colspan="2"  bgcolor="#FFFFFF"><div align="center">
            ...
            <tr>
                ...
                <td  bgcolor="#FFFFFF"><div align="center">1~5</div></td>
                   ...
                   <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_d_52" type="text" id="subtotal_d_52" size="10" class="bgg" maxlength="10" value='<s:property value="performance.subtotal_d_52"/>' readonly="readonly">
                      </div></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_m_52" type="text" id="subtotal_m_52" size="10"  maxlength="10" onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="performance.subtotal_m_52"/>' >
                      </div></td>
                      <td colspan="2"  bgcolor="#FFFFFF"><div align="center">
                ...
                <td  bgcolor="#FFFFFF"><div align="center">1~5</div></td>
                   ...
                   <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_d_53" type="text" id="subtotal_d_53" size="10" class="bgg" maxlength="10" value='<s:property value="performance.subtotal_d_53"/>' readonly="readonly">
                      </div></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_m_53" type="text" id="subtotal_m_53" size="10"  maxlength="10" onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="performance.subtotal_m_53"/>' >
                      </div></td>
                      <td colspan="2"  bgcolor="#FFFFFF"><div align="center">
                ...
                <td  bgcolor="#FFFFFF"><div align="center">1~3</div></td>
                   ...
                   <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_d_54" type="text" id="subtotal_d_54" size="10" class="bgg" maxlength="10" value='<s:property value="performance.subtotal_d_54"/>' readonly="readonly">
                      </div></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_m_54" type="text" id="subtotal_m_54" size="10"  maxlength="10" onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN" value='<s:property value="performance.subtotal_m_54"/>' >
                      </div></td>
                      <td colspan="2"  bgcolor="#FFFFFF"><div align="center">
          ...
          <tr>
                ...
                <td width="7%" bgcolor="#FFFFFF"><div align="center">特别<span class="STYLE1">加分</span>项</div>
            <div align="center"></div></td>
          ...
          <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_d_55" type="text" id="subtotal_d_55" class="bgg" size="10" maxlength="10"   value='<s:property value="performance.subtotal_d_55"/>' readonly="readonly">
                      </div></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_m_55" type="text" id="subtotal_m_55" size="10" maxlength="10" onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN"  value='<s:property value="performance.subtotal_m_55"/>' >
                      </div></td>
                      <td colspan="2"  bgcolor="#FFFFFF"><div align="center">
  ...
  <tr>
                ...
                <td width="7%" bgcolor="#FFFFFF"><div align="center">
                  <div align="center">特别<span class="STYLE2">扣分</span>项</div>
                </div>
      <div align="center"></div></td>
      <td   bgcolor="#FFFFFF"><div align="left"><input name="performance.sub_project" type="text" id="sub_project"
          ...
          <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_d_56" type="text" id="subtotal_d_56" class="bgg" size="10" maxlength="10"  value='<s:property value="performance.subtotal_d_56"/>' readonly="readonly">
                      </div></td>
                      <td  bgcolor="#FFFFFF"><div align="center">
                        <input name="performance.subtotal_m_56" type="text" id="subtotal_m_56"   size="10" maxlength="10" onChange="numVali(this)" onBlur="numVali(this)" onFocus="numClear(this)"  format="NN"  value='<s:property value="performance.subtotal_m_56"/>' >
                      </div></td>
                      <td colspan="2"  bgcolor="#FFFFFF"><div align="center">
...
<td  bgcolor="#CCFFFF"><div align="center">
                     <input name="performance.subtotal_z" type="text" id="subtotal_z" class="bgg" size="10" maxlength="10" value='<s:property value="performance.subtotal_z"/>' readonly="readonly">
                   </div></td>
     <td  bgcolor="#CCFFFF"><div align="center">
                     <input name="performance.subtotal_d" type="text" id="subtotal_d" class="bgg" size="10" maxlength="10" value='<s:property value="performance.subtotal_d"/>' readonly="readonly">
                   </div></td>
                      <td  bgcolor="#CCFFFF"><div align="center">
                        <input name="performance.subtotal_m" type="text" id="subtotal_m"  class="bgg" size="10" maxlength="10"   value='<s:property value="performance.subtotal_m"/>'  format="NNN"  readonly="readonly">
                      </div></td>
          ...
          <tr>
           <td bgcolor="#FFFFFF"><div align="center">评语<font color="#FF0000">*</font></div></td>
           	<td bgcolor="#FFFFFF" colspan="9"><div >
										...
										document.getElementById("remark_39").value = document.getElementById("UserUnAudit").value;
										</script>
           </tr>
          </table>
