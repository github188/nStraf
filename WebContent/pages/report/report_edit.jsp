 ...
 <head></head>
	...
	<script type="text/javascript">
		...
		function addAgain(){
			...
			iTaskIndex++;
			var taskDivPPtr = document.getElementsByTagName("fieldset")[0];
			var taskDivPtr = taskDivPPtr.childNodes[tableTaskIndex].nextSibling;
				...
				if(taskDivPtr!=null)
				{
					if(taskDivPtr.id.indexOf("task")>=0)
					{
						if(taskDivPtr!=null && taskDivPtr.getElementsByTagName("input")[0].checked){
							if(taskDivPPtr.childNodes.length==tableTaskIndex+10)
							{
								//alert("必须至少一项任务");
...
<body id="bodyid"  leftmargin="0" topmargin="10" >
	<form name="reportInfoForm" action="<%=request.getContextPath() %>/pages/day/reportinfo!update.action"   method="post">
		...
		<tr>
            ...
            <s:iterator value="dayReports" id="report"> 
				<table width="80%" align="center" border="1" cellspacing="0" id="task1">
                    <tr>
                        ...
                        <table width="80%" align="center" border="1" cellspacing="0" >
                                <tr>
                                  <td colspan="2" rowspan="2"><div align="center">项目名称<font color="#FF0000">*</font></div></td>
                                  <td rowspan="2" width="20%"><div align="center">完成%</div></td>
                                  <td rowspan="2" width="20%"><div align="center">状态</div></td>
                              ...
                              <tr>
                                  <td width="40%"><div align="center">交付件</div></td>
                                  <td colspan="3"><div align="center"><input name="attachment" type="text" id="attachment" size="40" value='<s:property value="attachment"/>'>
                                  </div></td>
                                  <td colspan="2"><div align="center">偏差原因</div></td>
                                  <td colspan="5"><div align="center"><input name="taskReason" type="text" id="taskReason" size="40" value='<s:property value="taskReason"/>'></div></td>
                              </tr>
                              <tr>
                                  <td><div align="center">任务描述<font color="#FF0000">*</font></div></td>
                                  <td colspan="11"><div align="center"><textarea name="taskDesc" type="text" id="taskDesc" rows="2" cols="80" onBlur="checkHdl(this)" ><s:property value="taskDesc"/></textarea>
                                  </div></td>
                              </tr>
                          </table>
                      </td>
                ...
                <!--<script type="text/javascript">
					...
					var szStatus = document.all.stat.value;
					var szPrjName = document.all.stat1.value;
					// 当天工时小计时间
