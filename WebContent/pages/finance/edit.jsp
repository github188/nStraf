		...
		<table width="80%" align="center" cellPadding="0" cellSpacing="0">
            <tr>
                ...
                <fieldset class="jui_fieldset" width="100%">
                    <legend><s:text name="部门经费" /></legend>
              <table width="74%" align="center" border="0" cellspacing="1" cellpadding="1" >
    <br/>
                        <tr>
                          <td align="center" width="7%" bgcolor="#999999"><div align="center" >日期<font color="#FF0000">*</font></div></td>
                          <td width="28%" bgcolor="#FFFFFF">
                          <input name="finance.activityDate" type="text" id="activityDate" size="22" class="MyInput" value='<s:date name="finance.activityDate" format="yyyy-MM-dd"/>'  /> </td>
                            
                          <td width="6%" align="center" bgcolor="#999999"><div align="center" >支出</div></td>
                          <td width="20%" bgcolor="#FFFFFF"><input name="finance.pay" type="text" id="raise_man2"  value="<s:property value='finance.pay'/>" size="10" maxlength="10"></td>  
                          
                          <td width="11%" align="center" bgcolor="#999999"><div align="center" >收入</div></td>
                          <td width="18%" bgcolor="#FFFFFF"><input name="finance.income" type="text" id="raise_man" maxlength="10" size="10"  value="<s:property value='finance.income'/>"></td> 
                </tr> 
                      
                      <tr>
                        <td align="center" bgcolor="#999999"><div align="center">项目/活动<font color="#FF0000">*</font></div></td>
                        <td colspan="3" bgcolor="#FFFFFF"><input name="finance.activity" type="text" id="activity" size="60" maxlength="60" value="<s:property value='finance.activity'/>">
                        </td> 
                        <td width="11%" align="center" bgcolor="#999999"><div align="center" >经手人<font color="#FF0000">*</font></div></td>
                        <td bgcolor="#FFFFFF"><input name="finance.responsible" type="text" id="responsible" maxlength="23" size="10"  value='<s:property value='finance.responsible'/>'></td>
                    </tr>
                      
                      <tr>
                      		<td align="center" bgcolor="#999999"><div align="center">详情描述</div></td>
                            <td colspan="5" bgcolor="#FFFFFF"><div >
                              <textarea cols="70" rows="5" name="finance.desc" id="desc"><s:property value='finance.desc'/></textarea>
                            </div>                        </td> 
               		  </tr>
                    </table>
                </fieldset>
