	...
	<script type="text/javascript">
		...
		function closeModal(){
			...
			for(var ind=0; ind<iTaskIndex; ind++){
				...
				if(finishRate.value!= "0%" && finishRate.value.trim()!= "100%" && delayReason.value.trim()=="" && audit.value=='1')
				{
						alert("请填写延迟原因");
						return;
				}	
		...
		function addAgain(){
			var iFuskTotal = document.getElementsByName("taskDesc").length;       //获取当前的新增记录数
			var curCount = 1;
...
<td>
	<fieldset class="jui_fieldset" width="100%">
      ...
      <table width="90%" align="center">
               ...
               <td bgcolor="#FFFFFF"><input name="weekReport.groupName" type="text" id="groupName" maxlength="100" size="22" value='<s:property value="weekReport.groupName"/>' readonly style="background-color:#FFFFFF; border-right-style:none; border-bottom-style:none; border-left-style:none; border-top-style:none; color:#336699; padding-top:2"></td>  
                 ...
                 <tr>
                   ...
                   <td width="20%" bgcolor="#FFFFFF"><div align="left">
                     <input name="weekReport.startDate" type="text" id="start" size="22" class="MyInput" isSel="true" isDate="true" onFocus="ShowDate(this)" dofun="ShowDate(this)" value='<s:date name="weekReport.startDate" format="yyyy-MM-dd"/>' >
                   </div></td> 
                            <td></td>
              				 <td></td>
                   <td align="center" bgcolor="#A5A5A5" width="10%"><font color="#000000">结束日期：</font></td>
                   <td width="20%" bgcolor="#FFFFFF"><input name="weekReport.endDate" type="text" id="end" size="22" class="MyInput" isSel="true" isDate="true" onFocus="ShowDate(this)" dofun="ShowDate(this)" value='<s:date name="weekReport.endDate" format="yyyy-MM-dd"/>' style="background-color:#FFFFFF; border-right-style:none; border-bottom-style:none; border-left-style:none; border-top-style:none; color:#000000"></td> 
		...
		<td width="18%" nowrap="nowrap" bgcolor="#A5A5A5"><div align="center"><font color="#000000">延迟原因</font>/<font color="#000000">建议</font></div>
           ...
           <s:iterator value="records" id="record" status="st"> 
              <tr id='task<s:property value="#st.index"/>'>
                ...
                <td nowrap bgcolor="#FFFFFF" align="left"><input name="taskDesc" id="taskDesc"size="70" maxlength="70" value='<s:property value="taskDesc"/>'/></td>
                     <td nowrap bgcolor="#FFFFFF"><div align="center">
                       ...
                       <td nowrap bgcolor="#FFFFFF"><div align="center"> <input name="responsible" type="text" id="responsible"  size="8" maxlength="100" value='<s:property value="responsible"/>'/></div></td>
                       <td nowrap bgcolor="#FFFFFF"><div align="center">
