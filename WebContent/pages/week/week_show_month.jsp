            ...
            <tr>
                ...
                <fieldset class="jui_fieldset" width="100%" style="margin-left:10px">
                    ...
                    <tr>
                        ...
                        <td bgcolor="#FFFFFF"><input name="monthDay" type="text" id="monthDay" maxlength="100" size="22" value='<s:date name="weekReport.monthDay" format="yyyy-MM"/>' readonly style="background-color:#FFFFFF; border-right-style:none; border-bottom-style:none; border-left-style:none; border-top-style:none; color:#336699"></td>
                        <td bgcolor="#FFFFFF" align="right"><div style="padding-top:2">组别：<font color="#336699"><s:property value="weekReport.groupName"/></font></div></td>  
                    </tr>
                </table>
                <s:iterator value="weekReports" id="report" var="report" status="st"> <!--修改为迭代器的id和value-->
                    ...
                    <br/>
                        ...
                        <tr>
                            ...
                            <td width="20%" bgcolor="#FFFFFF"><font color="#000000"><s:date name="weekReport.startDate" format="yyyy-MM-dd"/></font></td> 
                            <td align="center" bgcolor="#A5A5A5" width="10%"><font color="#000000">结束日期：</font></td>
                            <td width="20%" bgcolor="#FFFFFF"><font color="#000000"><s:date name="weekReport.endDate" format="yyyy-MM-dd"/></font></td> 
                            <td align="center" bgcolor="#A5A5A5"><div align="center"><font color="#000000">完成情况：</font></div></td>
                            <td bgcolor="#FFFFFF" > 
                            <input name="weekReport.finishInfo" type="text" id="finishInfo" size="22" value='<s:property value="weekReport.finishInfoString"/>' readonly style="background-color:#FFFFFF; border-right-style:none; border-bottom-style:none; border-left-style:none; border-top-style:none; color:#000000">	
                            </td> 
                      </tr>
                      <tr>
                      	<td align="center" bgcolor="#A5A5A5"><font color="#000000">任务概述：</font></td>
                        <td bgcolor="#FFFFFF" colspan="5" ><textarea name="taskDesc" type="text" id="taskInfo" rows="15" cols="80" readonly style= "BORDER-BOTTOM:0px solid; BORDER-LEFT:0px solid; BORDER-RIGHT:0px solid;BORDER-TOP:0px solid;scrollbar-shadow-color:white; overflow-x:hidden;overflow-y:hidden " ><s:property value="weekReport.taskDesc"/></textarea></td>
                      </tr>
                      <tr>
                      	<td align="center" bgcolor="#A5A5A5"><font color="#000000">经验/建议/问题：</font></td>
                        <td bgcolor="#FFFFFF" colspan="5" ><textarea name="note" type="text" id="note" rows="8" cols="80" readonly style= "BORDER-BOTTOM:0px solid; BORDER-LEFT:0px solid; BORDER-RIGHT:0px solid;BORDER-TOP:0px solid;scrollbar-shadow-color:white; overflow-x:hidden;overflow-y:hidden " ><s:property value="weekReport.note"/></textarea></td>
                      </tr>
