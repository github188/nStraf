...
<link href="../../css/css_v2.css" type=text/css rel=stylesheet>
	...
	function refu2(){
		   if(!confirm('您确认重新获取周报内容吗？'))
		   {
			...
			//alert(content1);
			var contentTmpA=content.split("（三）");
		//	alert(contentTmpA[0]);
		    var contentTmpB=content.split("二、主持");
			//alert(contentTmpB[0]);
			var comtentTmphead = contentTmpA[0];
			var comtentTmphafter = "二、主持" + contentTmpB[1];
			document.getElementById("content").value = comtentTmphead + document.getElementById("contenttmpjsp").value + comtentTmphafter;
	    //	document.getElementById("content").value = ocument.getElementById("contenttmpjsp").value;
...
<body id="bodyid">
	<form name="reportInfoForm" action="<%=request.getContextPath() %>/pages/meeting/meetinginfo!updateByWriter.action"   method="post">
...
<label>
    ...
    <td width="90">
<label>
        <input name="meeting.addr" type="text" id="addr" size="17"  value="<s:property value='meeting.addr'/>"/>
    </label>    </td>
...
<label>
  ...
  <tr>
    ...
    <td colspan="7">
         <input name="meeting.auditStatus" type="text" class="bgg" id="auditStatus" size="20"  value="<s:property value='meeting.auditStatus'/>" readonly/></td>
  </tr>
   <tr>
    <td bgcolor="#999999"><div align="right">审核反馈</div></td>
    <td colspan="7"> <textarea name="suggest" id="suggest" cols="109" rows="7" ></textarea>   	</td>
  </tr>
 </tr>
    <tr>
    <td bgcolor="#999999"><div align="right">审核记录</div></td>
    <td colspan="7"> <textarea name="meeting.reauditPersonsuggest" class="bgg" id="reauditPersonsuggest" cols="109" rows="7" readonly><s:property value='meeting.reauditPersonsuggest'/></textarea>   	</td>
  </tr>
</table>
...
<table width="80%" cellpadding="0" cellspacing="0" align="center"> 
		<tr>
			<td align="center"> 
                ...
                <input type="button" name="refu" value="刷新周报" class="MyButton"  onclick="refu2();" image="../../images/share/refu.gif"> 
				</td> 
  		</tr>  
 	</table> 
    </form>
