...
<html>
	...
	<body id="bodyid" leftmargin="0" topmargin="10">
			...
			<table width="95%" align="center" cellPadding="0" cellSpacing="0">
				<tr>
			      ...
			      <br/>
                                  ...
                                  <tr bgcolor="#FFFFFF" >
					  <td bgcolor="#999999" width="6%" rowspan="4" align="center" ><div align="center">基本信息<font color="#FF0000">
					  </font></div> </td>
					  ...
					  <td  width="7%" ><input name="sysInfo.birthdate" type="text" id="birthdate"  class="MyInput" issel="true" isdate="true" size="12"
											maxlength="12" onFocus="ShowDate(this)" dofun="ShowDate(this)" value='<s:date name="sysInfo.birthdate" format="yyyy-MM-dd"/>'/>
                                            <input type="radio" name="identity" value="公历" />公历 
                    						  <input type="radio" name="identity" value="农历" />农历</td>
                                              <script language="javascript">
                                                  ...
                                                  for(i=0;i<identity.length;i++){ 
       	                                          if(identity[i].value == calendertype.value ) 
      	                                          {
													  ...
													  // document.getElementById("identity").value = calendertype.value;
													   
      	                                          } 
                                                 }    
                                                </script>
					  <td width="4%" bgcolor="#999999" align="right">民族<font color="#FF0000">*</font></td>
					  <td width="7%" ><input name="sysInfo.national" type="text" id="national" size="16"  maxlength="16" value='<s:property value="sysInfo.national"/>'></td>
					  </tr>
					  ...
					  <td><input name="sysInfo.birthplace" type="text" id="birthplace" size="16"
											maxlength="16"
									 value='<s:property value="sysInfo.birthplace"/>'></td>
					  ...
					  <td ><input   name="sysInfo.startworddtae" type="text" id="startworddtae"  class="MyInput" issel="true" isdate="true" size="12"
											maxlength="12" onFocus="ShowDate(this)" dofun="ShowDate(this)" value='<s:date name="sysInfo.startworddtae" format="yyyy-MM-dd"/>'></td>
					  ...
					  <td ><input   name="sysInfo.graduatedate" type="text" id="graduatedate" size="12"
											maxlength="12"  class="MyInput" issel="true" isdate="true" onFocus="ShowDate(this)" dofun="ShowDate(this)" value='<s:date name="sysInfo.graduatedate" format="yyyy-MM-dd"/>'></td>
					  ...
					  <td ><input name="sysInfo.workingdate" type="text" id="workingdate" size="12"
											maxlength="12" class="MyInput" issel="true" isdate="true" onFocus="ShowDate(this)" dofun="ShowDate(this)" value='<s:date name="sysInfo.workingdate" format="yyyy-MM-dd"/>'></td>
			    ...
			    <input type='hidden' id="st" name="st" value="<s:property value='sysInfo.groupname'/>"/>
                                  <s:if test="sysInfo.groupname!=null&&!sysInfo.groupname.equals('')">
											<script language="javascript">
					  ...
					  <td><input name="sysInfo.leavedate" type="text" id="leavedate" size="12"
											maxlength="12"  class="MyInput" isSel="true" isDate="true" onFocus="ShowDate(this)" dofun="ShowDate(this)"
					  ...
					  <td><input name="sysInfo.relation" type="text" id="relation" size="16"
											maxlength="16" value='<s:property value="sysInfo.relation"/>'></td>
                     ...
                     <input name="stat" type="hidden" id="stat"  value='<s:property value="sysInfo.education"/>' />
              		  <input name="stat1" type="hidden" id="stat1"  value='<s:property value="sysInfo.politicalstatus"/>' />
					<input name="stat2" type="hidden" id="stat2"  value='<s:property value="sysInfo.englishskill"/>' />
                    <input name="stat3" type="hidden" id="stat3" value='<s:property value="sysInfo.technicaltitle"/>' />
                    <input name="stat4" type="hidden" id="stat4"  value='<s:property value="sysInfo.hukoukind"/>' />
					<input name="stat5" type="hidden" id="stat5"  value='<s:property value="sysInfo.marrystatus"/>' />
					<input name="stat6" type="hidden" id="stat6"  value='<s:property value="sysInfo.groupname"/>' />
                    <input name="stat7" type="hidden" id="stat7"  value='<s:property value="sysInfo.workstation"/>' />
                    <input name="stat8" type="hidden" id="stat8"  value='<s:property value="sysInfo.status"/>' />
							</table>
					  </fieldset>
					</td>
				</tr>
		...
		var education = document.getElementsByName("stat")[0].value;
		education = decodeURI(education);
		document.getElementsByName("education")[0].value = (education.trim() == "" ? "中专" : education.trim());
		
		var szPoliticalstatus = document.getElementsByName("stat1")[0].value;
		...
		var szEnglishskill = document.getElementsByName("stat2")[0].value;
		...
		var szTechnicaltitle = document.getElementsByName("stat3")[0].value;		
		szTechnicaltitle=decodeURI(szTechnicaltitle);
		document.getElementsByName("technicaltitle")[0].value = (szTechnicaltitle.trim() == "" ? "无" : szTechnicaltitle.trim());
		
		var szHukoukind = document.getElementsByName("stat4")[0].value;		
		szHukoukind=decodeURI(szHukoukind);
		document.getElementsByName("hukoukind")[0].value = (szHukoukind.trim() == "" ? "农村" : szHukoukind.trim());
		
		var szMarrystatus = document.getElementsByName("stat5")[0].value;		
		szMarrystatus=decodeURI(szMarrystatus);
		document.getElementsByName("marrystatus")[0].value = (szMarrystatus.trim() == "" ? "未婚" : szMarrystatus.trim());
		
		var szGroupname = document.getElementsByName("stat6")[0].value;		
		szGroupname=decodeURI(szGroupname);
		document.getElementsByName("groupname")[0].value = (szGroupname.trim() == "" ? "质量管理组" : szGroupname.trim());
		
		var szWorkstation = document.getElementsByName("stat7")[0].value;		
		szWorkstation=decodeURI(szWorkstation);
		document.getElementsByName("workstation")[0].value = (szWorkstation.trim() == "" ? "助理软件测试工程师" : szWorkstation.trim());

		var szStatus = document.getElementsByName("stat8")[0].value;		
