			...
			<table width="95%" align="center" cellPadding="0" cellSpacing="0">
				<tr>
			      ...
			      <br/>
					  ...
					  <td  width="7%" >
					    <input name="sysInfo.birthdate" type="text" id="birthdate"  class="MyInput" issel="true" isdate="true" size="12" maxlength="12" onFocus="ShowDate(this)" dofun="ShowDate(this)"/>											  
