...
<script type="text/javascript"> 
		...
		function setHTML(entry,entryInfo){
			...
			html += '<td align="center">' +entryInfo["education"] + '</td>';
	...
	function add(){
    	OpenModal('/pages/sysinfo/sysinfoinfo!add.action','1000,500,tmlInfo.addTmlTitle,tmlInfo');
		query();
	}
...
<tr> 
      ...
      <td nowrap width="4%" class="oracolumncenterheader"><div align="center">学历</div></td>
