...
<body id="bodyid">
<form name="holsForm0" action="<%=request.getContextPath() %>/pages/loglistener/loglistener!save.action?listener=0"   method="post">
<div id="groupnameDiv">
<table width="400"  class="input_table">
<tr>
	<td class="input_tablehead">新增日志监控</td>
</tr>
<tr>
    <td class="input_label2"><div align="right">新增类型
     <font color="#FF0000">*</font></div></div></td>
    <td bgcolor="#ffffff" style="font-size:15px;padding:3px;">
   	<input type="radio" name="orgType" value="project" checked/>添加项目 &nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="orgType" value="dept" />添加部门
    </td>
</tr>
<tr id="projectList">
