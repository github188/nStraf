	  ...
	  <tr>
	    <td valign="top" height="23" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
	      <tr>
            ...
            <div class="tabNav">
	          <ul id="ulTab">
	          	 <li> <a href="javascript:void(0);" id="task" onClick="goto(this,'<%=request.getContextPath() %>/pages/EmployeeInformation/EmployeeInformationinfo!add.action','actmainFrame')"><span class="TabbedPanelsTab">基本信息</span></a></li>
	             <li style="display:none;" id="tab1"> <a href="javascript:void(0);" id="order" onClick="goto(this,'<%=request.getContextPath() %>/pages/atm/atminfo!addDeviceConfig.action','actmainFrame')"><span class="TabbedPanelsTab">在职信息</span></a></li>
	             <li style="display:none;" id="tab2"> <a href="javascript:void(0);" id="order" onClick="goto(this,'<%=request.getContextPath() %>/pages/atm/atminfo!addMediaVersion.action','actmainFrame')"><span class="TabbedPanelsTab">其它信息</span></a></li>
