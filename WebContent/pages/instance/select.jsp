...
<body id="menu">
 ...
 <s:iterator value="#request.usrGroups" status="status">
	  ...
	  <s:iterator value="#request.grpUser[code]">
	   <a href="javascript:void(0)"><input name="<s:property value="grpcode"/>" type="checkbox" value="<s:property value="userid"/>:<s:property value="username"/>"><s:property value="username"/></a>
	   </s:iterator>
	  </ul>
  </s:iterator>
 </span> -->
