...
<body>
	<s:form action="/pages/contact/contactAction!importData.action" method="post" enctype="multipart/form-data">
      <br>
      <table border="0" width="100%" cellspacing="0" cellpadding="0">
      	<tr>
      		<td class="ta_01" align="center"  colspan="4">
				<font face="宋体" size="2"><strong>Excel文件数据导入,请按导出格式为模板进行导入</strong></font>
			</td>
		</tr>
		<tr>
