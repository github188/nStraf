...
<body id="bodyid" leftmargin="0" topmargin="10">
	<form name="reportInfoForm"
		action="<%=request.getContextPath()%>/pages/course/courseinfo!update.action"
		method="post">
					...
					<table width="95%" class="input_table">
						...
						<tr>
							...
							<td bgcolor="#FFFFFF" nowrap="nowrap" width="25%"><input
								...
								maxlength="50" value="<s:property value='course.courseName'/>">
							</td>
							<td width="8%" class="input_label2"><div align="center">
									分类<font color="#FF0000">*</font>
								</div></td>
							<td width="16%" bgcolor="#FFFFFF" align="center"><s:select
									list="{'理论','方法','工具','业务','标准','技术','制度','流程'}"
									name="course.category" theme="simple" cssStyle="width:90px;"
									headerKey="" headerValue="----" id="category"
									value="course.category"></s:select></td>
							<td width="11%" class="input_label2">
						...
						<tr>
							...
							<td bgcolor="#FFFFFF"><input name="course.resourceName"
								type="text" id="resourceName" size="24" maxlength="35"
								value='<s:property value="course.resourceName"/>'></td>
							<td width="8%" class="input_label2"><div align="center">
									链接地址<font color="#FF0000">*</font>
								</div></td>
							<td colspan="3" bgcolor="#FFFFFF"><input name="course.path"
								type="text" id="path" size="57" maxlength="200"
								value='<s:property value="course.path"/>'>
						...
						<tr>
							...
							<td colspan="5" bgcolor="#FFFFFF"><textarea
									name="course.summary" cols="90" rows="5"><s:property
										value="course.summary" /></textarea></td>
						</tr>
					</table>
				</td>
			</tr>
