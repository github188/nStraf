...
<body id="bodyid" leftmargin="0" topmargin="10">
	<form name="reportInfoForm"
		action="<%=request.getContextPath()%>/pages/TestRecord/TestRecordinfo!save.action"
		method="post">
						...
						<table width="95%" align="center" border="0" cellspacing="1"
							...
							<tr>
								...
								<td bgcolor="#FFFFFF" colspan="5"><input
									name="question.serialNo" type="text" id="no" size="100"
									maxlength="100" value='<s:property value="question.serialNo"/>'></td>
							</tr>
							<tr>
								<td align="center" width="8%" bgcolor="#999999"><div
							...
							<tr>
								...
								<td bgcolor="#FFFFFF" nowrap="nowrap"><select
									name="question.findMan" id="findMan" style="width: 150px">
										...
										<option value="陈天水" selected>陈天水</option>
							...
							<tr>
								...
								<td bgcolor="#FFFFFF" width="23%"><select name="question.finishRate" style='width:150px'>
								...
								<td bgcolor="#FFFFFF" width="23%">
									<select
										name="question.deployStatus" id="deployStatus" style="width: 150px">
											<option value="">---- 请选择 ----</option>
											<option value="未部署" selected>未部署</option>
