...
<form action="/pages/rule/blackRegulation!show.action"   method="post">
		...
		<legend><s:text name="rule.title.info" /></legend>
		  <s:iterator value="blackRegulation" id="blackRegulation">
		  	<table width="100%" align="center" class="popnewdialog1">
				<tr>
					<td><s:text name="rule.list.regulation" /><s:text name="label.colon" /></td>
          			<td><s:property value="regulation"/></td>
          			
          			<td><s:text name="rule.list.moneyType" /><s:text name="label.colon" /></td>
          			<td><tm:dataDir beanName="blackRegulation" property="moneyType" path="ruleMgr.moneyType" /></td>
          		</tr> 
				<tr>
					<td><s:text name="rule.list.denomination" /><s:text name="label.colon" /></td>
          			<td>
          				<tm:dataDir beanName="blackRegulation" property="moneyDenomination" path="ruleMgr.moneyDenomination" />
          			</td>
