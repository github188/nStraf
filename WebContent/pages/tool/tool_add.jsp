...
<body id="bodyid"  leftmargin="0" topmargin="10" >
	<form name="reportInfoForm" action="<%=request.getContextPath() %>/pages/tool/toolinfo!save.action"   method="post">
                ...
                <fieldset class="jui_fieldset" width="100%">
                    ...
                    <br/>
                        <tr>
                          ...
                          <td bgcolor="#FFFFFF"><input name="tool.toolName" type="text" id="toolName" size="30" maxlength="30" value=''>&nbsp;</td> 
                          <td align="center" width="20%" bgcolor="#999999"><div align="center">版本：&nbsp;</div></td>  
                          <td bgcolor="#FFFFFF"><input name="tool.versionNO" type="text" id="version" size="30" maxlength="30" value=''>&nbsp;</td> 
                      </tr> 
                      <tr>
                      ...
                      <tr>
                            ...
                            <td colspan="3" bgcolor="#FFFFFF"><input name="tool.source" type="text" id="provider" size="82" maxlength="80" value=''>&nbsp;</td> 
                      </tr>
                        <tr>
                            <td align="center" bgcolor="#999999"><div align="center">地址：<font color="#FF0000">*</font></div></td>
                            <td colspan="3" bgcolor="#FFFFFF"><input name="tool.visitURL" type="text" id="visitURL" size="82" maxlength="255" value=''>&nbsp;</td> 
                      </tr>
                        <tr>
                            <td align="center" bgcolor="#999999"><div align="center">用途：&nbsp;&nbsp;</div></td>
                            <td colspan="3" bgcolor="#FFFFFF"><textarea name="tool.toolDesc" type="text" id="toolDesc" cols="61" rows="4" value=''></textarea></td> 
                      </tr>
                    </table>
                </fieldset>
                </td> 
