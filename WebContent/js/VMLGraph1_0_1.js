...
_p.addData = function(sName,sValue,sHref,sTooltipText){
 ...
 if(sTooltipText == null || sTooltipText == "undefined")
  oData.TooltipText="the value is:"+ sValue;
 else
...
function VerticalChart(){
 Graph.call(this);
 this.Margin  = new Array(500,100,500,200);
 this.AxisX  = new Axis();
 this.AxisY  = new Axis();
};
...
_p.drawLineY = function(oContainer){
 ...
 for(var i=0; i<=dcs; i++){
  ...
  newShape= document.createElement("<v:shape style='position:absolute;left:"+ eval(x-360) +";top:"+ eval(py-50) +";WIDTH:400px;HEIGHT:150px;z-index:8' coordsize='21600,21600' fillcolor='white'></v:shape>");
