...
<%@ page import=" cn.grgbanking.framework.webapp.WebConstants,
                   cn.grgbanking.framework.util.ErrorObject" %>
...
<table width="424"  height="258" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr> 
    <td>
        ...
        <tr> 
          <td bgcolor="C6D7FF" height="8"><img src="<%=currentPath%>/images/Spacer.gif" width="1" height="1"></td>
				 ...
				 <logic:present name="<%=WebConstants.ERROR_MESSAGE%>">
                     ...
                     <font color="#669966">
					     <bean:write name="<%=WebConstants.ERROR_MESSAGE%>"/>
	         		 </font>
                     </td>
                     </tr>
				 </logic:present>
            ...
            <tr>
               <td bgcolor="EFF3FF" >
                    ...
                    <bean:write name="<%=WebConstants.ERROR_OBJECT%>" property="errorCode"/>
                    </font>
                </td>
            </tr>
            <tr>
               <td bgcolor="EFF3FF" >
                    ...
                    <bean:write name="<%=WebConstants.ERROR_OBJECT%>" property="errorMsg"/>
                    </font>
               </td>
            </tr>
            <tr>
               <td bgcolor="EFF3FF" >
                  ...
                  [请求]: <font color="#339900">
                    <bean:write name="<%=WebConstants.ERROR_OBJECT%>" property="requestURL"/>
                  </font>
               </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <div id = "detail"  style="height:120;visibility:hidden;overflow:scroll">
                   <bean:write name="<%=WebConstants.ERROR_OBJECT%>" property="errorStack"/>
               </div>
               </td>
            </tr>
        </logic:present>
			...
			<logic:present name="<%=WebConstants.LINK_URL%>">
				 <a href="<%=request.getAttribute(WebConstants.LINK_URL).toString()%>">
				   <logic:present name="<%=WebConstants.LINK_NAME%>">
				   		<bean:write name="<%=WebConstants.LINK_NAME%>"/>
				   </logic:present>
